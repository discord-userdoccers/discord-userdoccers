...
Please use our new Discord GameSDK. Read the documentation and get it [here](/docs/game-sdk/sdk-starter-guide/).
...
Deprecated in favor of [Discord GameSDK ActivityManager.UpdateActivity()](/docs/game-sdk/activities/update-activity)
...
Deprecated in favor of [Discord GameSDK ActivityManager.OnActivityJoin](/docs/game-sdk/activities/on-activity-join) and [Discord GameSDK ActivityManager.OnActivityJoinRequest](/docs/game-sdk/activities/on-activity-join-request)
...
Deprecated in favor of [Discord GameSDK ActivityManager.OnActivitySpectate](/docs/game-sdk/activities/on-activity-spectate)
