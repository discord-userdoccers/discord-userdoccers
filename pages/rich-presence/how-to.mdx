...
Please use our new Discord GameSDK. Read the documentation and get it [here](/game-sdk/sdk-starter-guide/).
...
Deprecated in favor of [Discord GameSDK ActivityManager.UpdateActivity()](/game-sdk/activities/update-activity)
...
Deprecated in favor of [Discord GameSDK ActivityManager.OnActivityJoin](/game-sdk/activities/on-activity-join) and [Discord GameSDK ActivityManager.OnActivityJoinRequest](/game-sdk/activities/on-activity-join-request)
...
Deprecated in favor of [Discord GameSDK ActivityManager.OnActivitySpectate](/game-sdk/activities/on-activity-spectate)
