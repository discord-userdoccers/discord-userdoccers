...
To log out, the client must use the [Logout](#logout) endpoint with the user's authentication token. This is used to invalidate the token and prevent further push notiginications from being sent to the client.
