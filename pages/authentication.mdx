...
Then, the client must [verify the phone number](/topics/phone-verification#verify-phone) using the received code before completing the registration using the [Register Account](#register-account) endpoint as usual.
