...
| type?               | one of [application command type](#application-command-types)                | the type of command, defaults `1` if not set                                                          | all         |
...
| ----------- | ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------- |
| type        | one of [application command option type](#application-command-option-type)                 | the type of option                                                                                 |
...
| options?    | array of [application command option](#application-command-option-structure)               | if the option is a subcommand or subcommand group type, this nested options will be the parameters |
...
| ATTACHMENT        | 11    | [attachment](/resources/message#attachment-object) object |
