...
| embedded_activity_config? ^1^ | partial [embedded activity configuration](#embedded-activity-configuration-object) object        | The embedded activity configuration for the application             |

^1^ Embedded activity config objects will only contain the `supported_platforms` field.
