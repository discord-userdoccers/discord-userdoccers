...
| user? ^2^                            | partial [user](/resources/user#partial-user-object) object              | The invoking user                                                                                                 |
...
| app_permissions                      | string                                                                  | The permission bitwise value of permissions the application has in the source location of the interaction         |
...
| entitlements                         | array[[entitlement](/resources/entitlements/entitlement-object) object] | The entitlements for the invoking user                                                                            |
...
^2^ `member` is sent only when the interaction is triggered in a guild, and `user` is sent only when triggered in a DM/group channel.

^3^ The value of [`GUILD_INSTALL`](/resources/application#application-integration-type) key may be `0` if the interaction was not triggered in a guild.
...
| application_command? | [application command](/interactions/application-commands#application-command-object) object                                 | The application command being called                                                               |
| target_id? ^3^       | snowflake                                                                                                                   | The ID of the user or message targeted by a context menu                                           |
| attachments? ^4^     | array[partial [attachment](#attachment-object) object]                                                                      | Partial attachment objects with `filename` and `description` (max 25)                              |
...
| component_type | integer                                   | The [type of the component](/resources/component#component-type) |

###### Sendable Message Component Interaction Data Structure

| Field               | Type                              | Description                                                      |
| ------------------- | --------------------------------- | ---------------------------------------------------------------- |
| component_type? ^1^ | integer                           | The [type of the component](/resources/component#component-type) |
| custom_id           | string                            | The developer-defined identifier for the component               |
| type? ^1^           | integer                           | The [type of the component](/resources/component#component-type) |
...
^2^ Only applicable for [`STRING_SELECT`/`USER_SELECT`/`ROLE_SELECT`/`MENTIONABLE_SELECT`/`CHANNEL_SELECT` components](/resources/component#component-type).
...
| components | array[[component](/resources/component#component-object) object] | The submitted values                          |
...
| custom_id  | string                                                           | The developer-defined identifier of the modal      |
| components | array[[component](/resources/component#component-object) object] | The values to submit                               |
...
| Field         | Type                                                                          | Description           |
| ------------- | ----------------------------------------------------------------------------- | --------------------- |
| users?        | map[snowflake, partial [user](/resources/user#partial-user-object) object]    | The resolved users    |
...
Depending on the interaction type, not all callback types may be available. See `Target Interaction Types` column for interaction types that allow usage of specific callback type.

| Name                                    | Value | Description                                                                                           | Data                                                                                               | Target Interaction Types                                                                      |
| --------------------------------------- | ----- | ----------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
...
^2^ Only available if the application has [`IFRAME_MODAL`](/resources/application#application-flags) flag.
...
| embeds?           | array[[embed](#embed-object) object]                                      | Embedded `rich` content (max 6000 characters, max 10)                                                                                                   |
...
| flags?            | integer                                                                   | The [message's flags](/resources/message#message-flags) (only `SUPPRESS_EMBEDS`, `EPHEMERAL`, `SUPPRESS_NOTIFICATIONS`, and `VOICE_MESSAGE` can be set) |
...
| Field   | Type                                                                                                                              | Description                        |
| ------- | --------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- |
| choices | array[[application command option choice](/resources/interactions/application-commands#application-command-option-choice) object] | The autocompleted choices (max 25) |
...
| components ^1^ | array[[component](/resources/component#component-object) object] | The modal components (1-5)                                          |
...
| custom_id   | string  | The developer-defined identifier for the iframe modal (max 100 characters) |
...
| Value                                   | Description                                                                            |
| --------------------------------------- | -------------------------------------------------------------------------------------- |
| discovery                               | The application command was called from Application Directory                          |
| suggestion                              | The application command was suggested as a replacement of text commands                |
| mention                                 | The application command was called from a mention                                      |
| paste                                   | The application command was pasted                                                     |
| recall                                  | Unknown                                                                                |
| popular_commands                        | Unknown                                                                                |
| mj_chat_bar                             | The application command was called from Midjourney command promotion                   |
| query                                   | Unknown                                                                                |
| slash_ui                                | Unknown                                                                                |
| app_launcher                            | The application command was called from "App Launcher" button in chat bar              |
...
| image_recs_menu                         | The application command was called by clicking app from "Edit Image With Apps" menu    |
| image_recs_submenu                      | The application command was called by clicking app from "Edit Image With Apps" submenu |
...
| app_dms_entry_point_command_button      | The application command was called by clicking "Play" button in chat bar               |
