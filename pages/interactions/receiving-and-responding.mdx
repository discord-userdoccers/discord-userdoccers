...
^1^ To create [`SOCIAL_LAYER_SKU_PURCHASE_ELIGIBILITY`](#interaction-type) interactions, a [Create Social Layer SKU Purchase Eligibility Interaction](/resources/store#create-social-layer-sku-purchase-eligibility-interaction) endpoint is used instead.
