...
Create a response to an interaction from the Gateway. Accepts an [interaction response](#interaction-response-object) object. Returns a 204 empty response or an object below depending on `with_response` parameter.
...
| Field          | Type    | Description                                                                |
| -------------- | ------- | -------------------------------------------------------------------------- |
| with_response? | boolean | Whether to include interaction callback result as response (default false) |
...
| response_message_loading?   | boolean   | Whether the response message has [`LOADING`](/resources/message#message-flags) flag   |
| response_message_ephemeral? | boolean   | Whether the response message has [`EPHEMERAL`](/resources/message#message-flags) flag |
