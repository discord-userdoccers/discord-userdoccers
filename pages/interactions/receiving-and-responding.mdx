...
| 13    | SOCIAL_LAYER_SKU_PURCHASE_ELIGIBILITY   | Respond to an interaction with purchase eligibility for a social layer SKU                            | [interaction callback social layer SKU purchase eligibility data](#interaction-callback-social-layer-sku-purchase-eligibility-data) object | `SOCIAL_LAYER_SKU_PURCHASE_ELIGIBILITY`                                                       |
