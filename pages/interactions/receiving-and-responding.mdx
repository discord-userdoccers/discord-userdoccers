...
| mj_chat_bar                             | The application command was executed from Midjourney command promotion                   |
| query                                   | Unknown                                                                                  |
| slash_ui                                | Unknown                                                                                  |
| app_launcher                            | The application command was executed from "App Launcher" button in chat bar              |
...
| image_recs_menu                         | The application command was executed by clicking app from "Edit Image With Apps" menu    |
| image_recs_submenu                      | The application command was executed by clicking app from "Edit Image With Apps" submenu |
...
| app_dms_entry_point_command_button      | The application command was executed by clicking "Play" button in chat bar               |
