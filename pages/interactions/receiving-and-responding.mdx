...
| 2     | APPLICATION_COMMAND              | User uses an application command                                      |
| 3     | MESSAGE_COMPONENT                | User triggers a message component                                     |
| 4     | APPLICATION_COMMAND_AUTOCOMPLETE | User is requesting an application command option to be auto-completed |
| 5     | MODAL_SUBMIT                     | User submits a modal                                                  |
...
| options? ^1^ ^2^ | array[partial [application command option](/interactions/application-commands#application-command-option-structure) object] | The options with their values                                                                      |
| guild_id?        | snowflake                                                                                                                   | The ID of the guild that the command is registered to                                              |
| target_id? ^3^   | snowflake                                                                                                                   | The ID of the user or message targeted by a context menu command                                   |
...
^2^ Options will have only `type`, `name`, `value`, and optionally `focused` fields.
...
| Field                | Type                                                                                                                        | Description                                                                                        |
| -------------------- | --------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| version              | snowflake                                                                                                                   | The autoincrementing version identifier updated during substantial record changes                  |
| id                   | snowflake                                                                                                                   | The ID of the application command                                                                  |
| name                 | string                                                                                                                      | The name of the application command                                                                |
| type                 | integer                                                                                                                     | The [type of the application command](/interactions/application-commands#application-command-type) |
| options? ^1^ ^2^     | array[partial [application command option](/interactions/application-commands#application-command-option-structure) object] | The options with their values                                                                      |
