...
| type           | [interaction type](#interaction-object-interaction-type)           | the type of interaction                                        |
| data?\*        | [interaction data](#interaction-object-interaction-data-structure) | the command data payload                                       |
...
| resolved?       | [resolved data](#interaction-object-resolved-data-structure)                                                                                                                | converted users + roles + channels                                                                                                                                          | Application Command                                                                                                                      |
...
| Field | Type                                                                                          | Description                  |
| ----- | --------------------------------------------------------------------------------------------- | ---------------------------- |
| type  | [interaction callback type](#interaction-response-object-interaction-callback-type)           | the type of response         |
| data? | [interaction callback data](#interaction-response-object-interaction-callback-data-structure) | an optional response message |
