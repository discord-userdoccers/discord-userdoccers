...
| Field   | Type                                                                                                                    | Description                        |
| ------- | ----------------------------------------------------------------------------------------------------------------------- | ---------------------------------- |
| choices | array[[application command option choice](/interactions/application-commands#application-command-option-choice) object] | The autocompleted choices (max 25) |
