...
| type           | [interaction type](/interactions/receiving-and-responding/interaction-object-interaction-type)           | the type of interaction                                        |
| data?\*        | [interaction data](/interactions/receiving-and-responding/interaction-object-interaction-data-structure) | the command data payload                                       |
...
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| id              | snowflake                                                                                                                                                                   | the [`ID`](/interactions/application-commands/application-command-object-application-command-structure) of the invoked command                                              | Application Command                                                                                                                      |
| name            | string                                                                                                                                                                      | the [`name`](/interactions/application-commands/application-command-object-application-command-structure) of the invoked command                                            | Application Command                                                                                                                      |
| type            | integer                                                                                                                                                                     | the [`type`](/interactions/application-commands/application-command-object-application-command-structure) of the invoked command                                            | Application Command                                                                                                                      |
| resolved?       | [resolved data](/interactions/receiving-and-responding/interaction-object-resolved-data-structure)                                                                          | converted users + roles + channels                                                                                                                                          | Application Command                                                                                                                      |
| options?        | array of [application command interaction data option](/interactions/application-commands/application-command-object-application-command-interaction-data-option-structure) | the params + values from the user                                                                                                                                           | Application Command                                                                                                                      |
...
| values?         | array of [select option values](/interactions/message-components/select-menu-object-select-option-structure)                                                                | the values the user selected                                                                                                                                                | Component (Select)                                                                                                                       |
...
This means responses to [Message Components](/interactions/message-components/) do not include this property, instead including a [message reference](/resources/channel/message-reference-object-message-reference-structure) object as components _always_ exist on preexisting messages.
...
| id   | snowflake                                                                                      | id of the interaction                                                                                                              |
| type | [interaction type](/interactions/receiving-and-responding/interaction-object-interaction-type) | the type of interaction                                                                                                            |
| name | string                                                                                         | the name of the [application command](/interactions/application-commands/application-command-object-application-command-structure) |
...
2. Your endpoint must be set up to properly handle signature headers--more on that in [Security and Authorization](/interactions/receiving-and-responding/security-and-authorization)
...
- [Slash Commands](/interactions/application-commands/slash-commands-example-interaction)
- [User Commands](/interactions/application-commands/user-commands-example-interaction)
- [Message Commands](/interactions/application-commands/message-commands-example-interaction)
- [Message Components](/interactions/message-components/component-interaction-object-sample-component-interaction)
- [Select Menu Message Components](/interactions/message-components/select-menu-object-select-menu-interaction)

An explanation of all the fields can be found in our [data models](/interactions/receiving-and-responding/data-models-and-types).
...
| Field | Type                                                                                                                                | Description                  |
| ----- | ----------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- |
| type  | [interaction callback type](/interactions/receiving-and-responding/interaction-response-object-interaction-callback-type)           | the type of response         |
| data? | [interaction callback data](/interactions/receiving-and-responding/interaction-response-object-interaction-callback-data-structure) | an optional response message |
...
| flags?            | integer                                                        | [interaction callback data flags](/interactions/receiving-and-responding/interaction-response-object-interaction-callback-data-flags) |
...
Check out our [Community Resources](/topics/community_resources/interactions) for libraries to help you with security in your language of choice
...
Using your favorite security library, you **must validate the request each time you receive an [interaction](/interactions/receiving-and-responding/interaction-object)**. If the signature fails validation, respond with a `401` error code. Here's a couple code examples:
...
We highly recommend checking out our [Community Resources](/topics/community_resources/interactions) and the two libraries found there. They not only provide typing for Interactions data models, but also include decorators for API frameworks like Flask and Express to make validation easy.
...
Create a response to an Interaction from the gateway. Takes an [interaction response](/interactions/receiving-and-responding/interaction-response-object).
