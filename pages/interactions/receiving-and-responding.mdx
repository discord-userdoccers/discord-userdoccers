...
| 6     | SOCIAL_LAYER_SKU_PURCHASE_ELIGIBILITY | User is checking purchase eligibility for a social layer SKU          | [social layer SKU purchase eligibility](#social-layer-sku-purchase-eligibility-data-structure) object | —                                                                                        |
...
| 13    | SOCIAL_LAYER_SKU_PURCHASE_ELIGIBILITY   | Respnod to an interaction with purchase eligibility for a social layer SKU                            | [interaction callback social layer SKU purchase eligibility data](#interaction-callback-social-layer-sku-purchase-eligibility-data) object | `SOCIAL_LAYER_SKU_PURCHASE_ELIGIBILITY`                                                       |
