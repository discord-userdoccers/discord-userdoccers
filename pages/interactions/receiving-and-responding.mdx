...
| 6     | SOCIAL_LAYER_SKU_PURCHASE_ELIGIBILITY | User is checking purchase eligibility for a social layer SKU          | [social layer SKU purchase eligibility](#social-layer-sku-purchase-eligibility-data-structure) | —                                                                                        |
...
| 13    | SOCIAL_LAYER_SKU_PURCHASE_ELIGIBILITY   | Respnod to an interaction with purchase eligibility for a social layer SKU                            | [interaction callback social layer SKU purchase eligibility data](#interaction-callback-social-layer-sku-purchase-eligibility-data) | `SOCIAL_LAYER_SKU_PURCHASE_ELIGIBILITY`                                                       |
...
| Field               | Type          | Description                                                                                               |
| ------------------- | ------------- | --------------------------------------------------------------------------------------------------------- |
| type ^1^            | integer       | The [type of interaction to create](#interaction-type) (except `SOCIAL_LAYER_SKU_PURCHASE_ELIGIBILITY`)   |
...
^1^ To create [`SOCIAL_LAYER_SKU_PURCHASE_ELIGIBILITY`](#interaction-type) interactions, the [Create Social Layer SKU Purchase Eligibility Interaction](/resources/store#create-social-layer-sku-purchase-eligibility-interaction) endpoint is used instead.
