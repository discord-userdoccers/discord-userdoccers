...
^2^ Channels will also have `permissions` field.
...
| components | array[[component](/resources/components#component-object) object] | Components of the type [action row](/resources/component#action-row), or [label](/resources/component#label) (1-5) |
