...
| data? ^1^                          | [interaction data](#interaction-data-object)                            | The interaction data                                                                                              |
...
| message? ^3^                       | [message](/resources/message#message-object) object                     | The message the components are attached to                                                                        |
