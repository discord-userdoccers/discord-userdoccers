...
All options have names, and an option can either be a parameter, in which case `value` will be set, or it can denote a subcommand or group, in which case it will contain another array of `options`.
...
^1^ For [`ATTACHMENT` options](#application-command-option-type), `value` will be the attachment ID.
...
| type       | integer                                                                             | The [type](#component-type) of the component       | All                                                                                                                |
...
your app will **no longer receive Interactions over the Gateway**. If you want to receive them over the Gateway again, simply delete your URL.
...
| payload_json? ^2^   | string        | JSON-encoded body of non-file params                                                             |
...
| section_name?       | string        | The [name of the section](#interaction-creation-section-name) the interaction is being sent from |
...
| Value                                   | Description                                                                              |
| --------------------------------------- | ---------------------------------------------------------------------------------------- |
| discovery                               | The application command was executed from a message content suggestion                   |
...
| paste                                   | The application command was pasted in chat                                               |
| recall                                  | The application command was executed by attempting to edit a previous command invocation |
| popular_commands                        | The application command was executed from an application's popular commands list         |
| mj_chat_bar                             | The application command was executed from a Midjourney command promotion                 |
| query                                   | The application command was executed from a message content query suggestion             |
...
| app_launcher_home                       | The application command was executed from the App Launcher home                          |
| app_launcher_home_search                | The application command was executed from the App Launcher search                        |
| app_launcher_list_view_all              | The application command was executed from the App Launcher list view                     |
| app_launcher_application_view           | The application command was executed from the App Launcher application view              |
| app_launcher_application_view_frecent   | The application command was executed from the App Launcher application frecents section  |
| app_launcher_application_view_more_menu | The application command was executed from the App Launcher view more menu                |
| app_launcher_slash_search               | The application command was executed from the App Launcher command search                |
| app_launcher_frecents_view_all          | The application command was executed from the App Launcher frecents section              |
...
| activity_instance_embed                 | The application command was executed from an activity instance embed                     |
| activity_bookmark_embed                 | The application command was executed from an activity bookmark embed                     |
| activities_mini_shelf                   | The application command was executed from the activities mini shelf                      |
| vc_tile_activity_suggestion             | The application command was executed from the activity suggestions in a voice channel    |
