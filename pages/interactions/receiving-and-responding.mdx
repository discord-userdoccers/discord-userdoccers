...
| IFRAME_MODAL ^2^                     | 11    | respond to an interaction with a popup modal containing an iframe                                             |
...
| iframe_path | string                                  | path to the iframe of the popup modal                            |
| modal_size  | [iframe modal size](#iframe-modal-size) | the size of the popup modal                                      |
