...
| ------------ | ---------------------------------------------------------------------- | ------------------------------------------------------------------------- | -------------------------------------------------- |
| type         | integer                                                                | [component type](#component-object-component-types)                       | all types                                          |
...
| style?       | integer                                                                | one of [button styles](#button-object-button-styles)                      | [Buttons](#buttons)                                |
...
| options      | array of [select options](#select-menu-object-select-option-structure) | the choices in the select, max 25                                         | [Select Menus](#select-menus)                      |
...
| style      | integer                                        | one of [button styles](#button-object-button-styles)              |
...
| custom_id    | string                                                                 | a developer-defined identifier for the button, max 100 characters         |
| options      | array of [select options](#select-menu-object-select-option-structure) | the choices in the select, max 25                                         |
