...
Components are a new field on the [message object](/resources/channel/message-object), so you can use them whether you're sending messages or responding to a [slash command](/interactions/application-commands/) or other interaction.

The top-level `components` field is an array of [Action Row](/interactions/message-components/action-rows) components.
...
| ------------ | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| type         | integer                                                                                                | [component type](/interactions/message-components/component-object-component-types)  | all types                                                                                                          |
| custom_id?   | string                                                                                                 | a developer-defined identifier for the component, max 100 characters                 | [Buttons](/interactions/message-components/buttons), [Select Menus](/interactions/message-components/select-menus) |
| disabled?    | boolean                                                                                                | whether the component is disabled, default `false`                                   | [Buttons](/interactions/message-components/buttons), [Select Menus](/interactions/message-components/select-menus) |
| style?       | integer                                                                                                | one of [button styles](/interactions/message-components/button-object-button-styles) | [Buttons](/interactions/message-components/buttons)                                                                |
| label?       | string                                                                                                 | text that appears on the button, max 80 characters                                   | [Buttons](/interactions/message-components/buttons)                                                                |
| emoji?       | partial [emoji](/resources/emoji/emoji-object)                                                         | `name`, `id`, and `animated`                                                         | [Buttons](/interactions/message-components/buttons)                                                                |
| url?         | string                                                                                                 | a url for link-style buttons                                                         | [Buttons](/interactions/message-components/buttons)                                                                |
| options      | array of [select options](/interactions/message-components/select-menu-object-select-option-structure) | the choices in the select, max 25                                                    | [Select Menus](/interactions/message-components/select-menus)                                                      |
| placeholder? | string                                                                                                 | custom placeholder text if nothing is selected, max 100 characters                   | [Select Menus](/interactions/message-components/select-menus)                                                      |
| min_values?  | integer                                                                                                | the minimum number of items that must be chosen; default 1, min 0, max 25            | [Select Menus](/interactions/message-components/select-menus)                                                      |
| max_values?  | integer                                                                                                | the maximum number of items that can be chosen; default 1, max 25                    | [Select Menus](/interactions/message-components/select-menus)                                                      |
| components?  | array of [components](/interactions/message-components/component-object)                               | a list of child components                                                           | [Action Rows](/interactions/message-components/action-rows)                                                        |
...
| style      | integer                                        | one of [button styles](/interactions/message-components/button-object-button-styles) |
...
| custom_id    | string                                                                                                 | a developer-defined identifier for the button, max 100 characters         |
| options      | array of [select options](/interactions/message-components/select-menu-object-select-option-structure) | the choices in the select, max 25                                         |
