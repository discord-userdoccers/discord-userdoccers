...
Discord offers a canary API for testing changes before they are pushed to the regular API. The canary API is not guaranteed to be stable, and is available at `https://canary.discord.com/api`.
