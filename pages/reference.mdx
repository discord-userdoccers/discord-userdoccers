...
| Store Asset                      | /app-assets/[{application_id}](/resources/application#application-object)/store/[{asset_id}](/resources/application#store-asset-object).png                                                                                                  | PNG, JPEG, WebP           |
