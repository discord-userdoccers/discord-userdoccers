...
Client properties contain tracking information about the client that is used for analytics and A/B testing purposes. These properties are sent in the Gateway [Identify](/topics/gateway-events#identify) payload and included with every HTTP request using the `X-Super-Properties` header as a base-64 encoded JSON object.
...
| ----------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| os                                              | string   | The [operating system of the client](#operating-system-type)                                                                                                 |
| os_version                                      | string   | The operating system version (or SDK version for Android)                                                                                                    |
| os_sdk_version? **(deprecated)**                | string   | The Android operating system SDK version                                                                                                                     |
| os_arch?                                        | string   | The [architecture of the operating system](#operating-system-architecture)                                                                                   |
| app_arch?                                       | string   | The [architecture of the desktop application](/topics/client-distribution#desktop-architecture-type)                                                         |
| browser                                         | string   | The [browser the client is using](#browser-type)                                                                                                             |
| browser_user_agent ^1^                          | string   | The user-agent of the client's browser, may be blank on mobile clients                                                                                       |
| browser_version                                 | string   | The version of the client's browser, may be blank on mobile clients                                                                                          |
| client_build_number                             | integer  | The build number of the client                                                                                                                               |
...
^1^ If specified, this value should match the `User-Agent` header sent by the client.
...
| unknown       | Unknown release channel |
