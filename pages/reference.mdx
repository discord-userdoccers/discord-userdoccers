...
1. Using a bot token gained by [registering a bot](/topics/oauth2/registering-applications), for more information on bots see [bots vs user accounts](/topics/oauth2/bot-vs-user-accounts).
...
<Image
  src="/docs/images/snowflake.png"
  alt="Graphical representation of how a Snowflake is constructed"
  quality={100}
  width={1986}
  height={1036}
/>
...
| Application Asset      | app-assets/[application_id](/resources/application/application-object)/[asset_id](/topics/gateway/activity-object-activity-assets).png                                                                                                             | PNG, JPEG, WebP      |
| Achievement Icon       | app-assets/[application_id](/resources/application/application-object)/achievements/[achievement_id](/game-sdk/achievements/data-models-user-achievement-struct)/icons/[icon_hash](/game-sdk/achievements/data-models-user-achievement-struct).png | PNG, JPEG, WebP      |
