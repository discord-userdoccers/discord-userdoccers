...
| Quest Asset ^5^                  | /assets/quests/[{quest_id}](/resources/quests#quest-object)/[{asset_name}](/resources/quests#quest-assets-structure).png, /assets/quests/[{quest_id}](/resources/quests#quest-object)/[{theme}](/resources/user-settings#theme)/[{asset_name}](/resources/quests#quest-assets-structure).png | PNG, JPEG, GIF, SVG, WebM |
