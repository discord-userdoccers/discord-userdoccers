...
| User Archived Avatar             | /avatars/[{user_id}](/resources/user#user-object)/archived/[{avatar_id}](/resources/user#avatars-structure)/[{user_avatar}](/resources/user#avatars-structure).png                                                                                                                   | PNG, JPEG, WebP, GIF                                 |
