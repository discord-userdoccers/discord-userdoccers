...
\* This is the API version used by the latest Discord client.
...
In the case of endpoints that support animated images, the hash will begin with `a_` if it is available in APNG or GIF format. (example: `a_1269e74af4df7417b13759eae50c83dc`)
...
| User Avatar Decoration           | /avatars/[user_id](/resources/user#user-object)/avatar-decorations/[user_avatar_decoration](/resources/user#user-object).png                                                                                                | PNG                       |
...
| Guild Template Icon              | /template/[template_code](/resources/guild-template#guild-template-structure)/icons/[template_icon](/resources/guild-template#guild-template-structure).png                                                                 | PNG, JPEG, WebP           |
