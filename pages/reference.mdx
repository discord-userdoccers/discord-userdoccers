...
| User Guild Avatar                | /guilds/[guild_id](/resources/guild#guild-object)/users/[user_id](/resources/user#user-object)/[user_avatar](/resources/user#user_object).png \*                                                                            | PNG, JPEG, WebP, GIF      |
| User Guild Banner                | /guilds/[guild_id](/resources/guild#guild-object)/users/[user_id](/resources/user#user-object)/[user_banner](/resources/user#user_object).png \*                                                                            | PNG, JPEG, WebP, GIF      |
