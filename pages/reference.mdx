...
| client_heartbeat_session_id?                    | ?string  | A client-generated UUID representing the current persisted analytics heartbeat, regenerated every 30 minutes on resends                                                         |
