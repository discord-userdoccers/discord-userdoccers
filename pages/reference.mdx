...
| window_manager?                                 | string   | The Linux window manager (output of `lsb_release -ds`)                                                                                                                                 |
| distro?                                         | string   | The Linux distribution (`env.XDG_CURRENT_DESKTOP ?? "unknown" + "," + env.GDMSESSION ?? "unknown"`)                                                                                    |
...
| Clan Badge                       | /clan-badges/[{guild_id}](/resources/guild#guild-object)/[{badge_hash}](/resources/user#user-clan-structure).png                                                                                                                                                                            | PNG ^6^                   |
| Clan Banner                      | /clan-banners/[{guild_id}](/resources/guild#guild-object)/[{banner_hash}](/resources/clan#clan-structure).png                                                                                                                                                                               | PNG ^6^                   |
...
^6^ Clan assets are not uploadable.
