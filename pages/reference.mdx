...
| Application Directory Collection | /application-directory/collection-items/[\{application_id\}](/resources/application#application-object)/[\{image_hash\}](/resources/application-directory#application-directory-collection-item-structure).png                                     | PNG, WEBP                 |
