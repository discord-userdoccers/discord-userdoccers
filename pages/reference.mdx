...
Creates attachment URLs to upload the intended attachments directly to Discord's GCP storage bucket. Returns an array of [cloud attachment](#cloud-attachment-structure) objects. See [Uploading to Google Cloud](#uploading-to-google-cloud) for more information.

###### JSON Params

| Field | Type                                                                              | Description                                                               |
| ----- | --------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| files | array[[upload attachment](/resources/message#upload-attachment-structure) object] | The target files to create a URL for, containing the name and size (1-10) |
