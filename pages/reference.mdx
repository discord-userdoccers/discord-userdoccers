...
| Application Directory Collection Item | /application-directory/collection-items/[{application.id}](/resources/application#application-object)/[{image_hash}](#application-directory-collection-item-structure).png                                                                   | PNG, WEBP                 |
