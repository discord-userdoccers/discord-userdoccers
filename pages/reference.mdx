...
1. Using a bot token gained by [registering a bot](/topics/oauth2#registering-applications), for more information on bots see [bots vs user accounts](/topics/oauth2#registering-applications)./topics/oauth2#registering-applications)
