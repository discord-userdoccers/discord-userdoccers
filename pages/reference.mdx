...
Some API and Gateway versions are now non-functioning, and are labeled as discontinued in the table below for posterity. Trying to use these versions will fail and return a 404 bad request.
          ...
          "_errors": [
            {
              ...
              "message": "Value device must be ('desktop', 'android', 'ios')."
            }
          ]
        },
        "type": {
          "_errors": [
            {
              "code": "BASE_TYPE_CHOICES",
              "message": "Value type must be (0, 1, 2, 3, 4, 5)."
            }
          ]
        }
      }
