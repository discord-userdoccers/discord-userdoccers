...
Discord utilizes the [ISO8601 format](https://www.loc.gov/standards/datetime/iso-tc154-wg5_n0038_iso_wd_8601-1_2016-02-16.pdf) for most dates / times returned in the API. This format is referred to as type `ISO8601` within tables in this documentation.
...
| Quest Asset ^5^                  | /assets/quests/[{quest_id}](/resources/quests#quest-object)/[{asset_name}](/resources/quests#quest-assets-structure).png, /assets/quests/[{quest_id}](/resources/quests#quest-object)/[{theme}](/resources/user-settings#legacy-client-theme)/[{asset_name}](/resources/quests#quest-assets-structure).png | PNG, JPEG, GIF, SVG, WebM |
...
^5^ The [theme](/resources/user-settings#legacy-client-theme) path is only used for fetching the [`game_tile` and `logotype` assets](/resources/quests#quest-assets-structure).
