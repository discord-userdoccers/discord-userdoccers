...
Client properties contain information about the current client and device. Some endpoints require them to be passed as a base64 encoded `X-Super-Properties` header to function properly. They are also required to [Identify](/topics/gateway-events#identify).

| Field                     | Type                                                            | Description                                                                                        |
| ------------------------- | --------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| os ^1^                    | [operating system](#operating-system)                           | The current operating system                                                                       |
| browser ^1^               | [browser](#browser)                                             | The current browser or client                                                                      |
| device ^1^                | string                                                          | The current mobile device model, empty on desktop                                                  |
| release_channel           | [release channel](#release-channel)                             | The current client release channel                                                                 |
| client_build_number       | number                                                          | The current client build number                                                                    |
| native_build_number?      | number                                                          | Only available on Windows                                                                          |
| client_event_source       | ?literal "OVERLAY"                                              |                                                                                                    |
| client_version?           | string                                                          | The current mobile client version                                                                  |
| os_version                | string                                                          | The current operating system version                                                               |
| os_arch?                  | [operating system architecture](#operating-system-architecture) | The current operating system architecture                                                          |
| device_vendor_id          | string                                                          | Only available on mobile clients                                                                   |
| system_locale             | string                                                          | The current system language                                                                        |
| browser_user_agent ^1^    | string                                                          | The current User-Agent                                                                             |
| browser_version ^1^       | string                                                          | The current browser version                                                                        |
| window_manager?           | string                                                          | Linux only. Output of `lsb_release -ds`                                                            |
| distro?                   | string                                                          | Linux only. `(env.XDG_CURRENT_DESKTOP \|\| "unknown") + "," + (env.GDMSESSION \|\| "unknown")`     |
| referrer?                 | string                                                          |                                                                                                    |
| referrer_current?         | string                                                          | The current HTTP Referer                                                                           |
| referring_domain?         | string                                                          |                                                                                                    |
| referring_domain_current? | string                                                          | The current HTTP Referer domain                                                                    |
| search_engine?            | [search engine](#search-engine)                                 | Search engine matched from the HTTP Referer                                                        |
| mp_keyword?               | string                                                          | Value of the `q` or `p` (for yahoo) parameter for the search engine which lead to the discord page |
| utm_campaign?             | string                                                          |                                                                                                    |
...
| Android Mobile    | Unknown browser on Android |
| BlackBerry        |                            |
| Chrome            | Chrome browser on desktop  |
| Chrome iOS        | Chrome browser on iOS      |
| Discord Client    | Desktop client             |
| Discord Android   | Android client             |
| Discord iOS       | iOS client                 |
| Discord Embedded  | Xbox client                |
| Edge              | Edge browser               |
| Facebook Mobile   |                            |
| Firefox           | Firefox browser            |
| Internet Explorer | Internet Explorer browser  |
| Konqueror         | Konqueror browser          |
| Mobile Safari     | Safari browser on iOS      |
| Mozilla           | Unknown browser            |
| Opera             | Opera browser              |
...
{/* TODO: Figure out iOS stable & TestFlight */}
