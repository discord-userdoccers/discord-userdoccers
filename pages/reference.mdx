...
| ------------------------- | --------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| os ^1^                    | [operating system](#operating-system)                           |                                                                                                    |
| browser ^1^               | [browser](#browser)                                             |                                                                                                    |
| device ^1^                | string                                                          | Mobile device model. Empty on desktop.                                                             |
| release_channel           | [release channel](#release-channel)                             |                                                                                                    |
| client_build_number       | number                                                          |                                                                                                    |
| native_build_number?      | number                                                          | Only available on Windows.                                                                         |
| client_event_source       | ?literal "OVERLAY"                                              |                                                                                                    |
| client_version?           | string                                                          | Only available on mobile clients.                                                                  |
| os_version                | string                                                          |                                                                                                    |
| os_arch?                  | [operating system architecture](#operating-system-architecture) |                                                                                                    |
| device_vendor_id          | string                                                          | Only available on mobile clients.                                                                  |
| system_locale             | string                                                          |                                                                                                    |
| browser_user_agent ^1^    | string                                                          |                                                                                                    |
| browser_version ^1^       | string                                                          |                                                                                                    |
