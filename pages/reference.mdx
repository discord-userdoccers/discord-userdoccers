...
1. Using a user or bot token gained by [logging into an account](/authentication/login) or [registering a bot](https://discord.com/developers/applications?new_application=true). For more information on users and bots, see [bots vs user accounts](/topics/oauth2#bot-vs-user-accounts).
