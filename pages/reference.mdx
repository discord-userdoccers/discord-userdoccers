...
| browser ^1^                                     | string   | The [browser the client is using](#browser-type)                                                                                                             |
...
^1^ These properties are used to gate experimental features and may be required for certain endpoints. See the [experiments documentation](/topics/experiments) for more information.
