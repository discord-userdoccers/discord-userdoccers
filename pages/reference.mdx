...
| Clan Badge                       | /clan-badges/[{guild_id}](/resources/guild#guild-object)/[{badge_hash}](/resources/user#user-clan-structure).png                                                                                                                                                                            | PNG                       |
| Clan Banner                      | /clan-banners/[{guild_id}](/resources/guild#guild-object)/[{banner_hash}](/resources/clan#clan-structure).png                                                                                                                                                                               | PNG                       |
