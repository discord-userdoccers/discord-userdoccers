...
Discord offers an open API to serve requests for both bots and OAuth2 integrations. So whether you’re making your own [`/dmall` command](/interactions/application-commands/) or looking to [`Aggregate Emails`](/topics/oauth2/), we’ve got you covered.
