...
Discord offers an open API to serve requests for both bots and OAuth2 integrations. So whether you’re making your own [`/wumpus` commands](/docs/interactions/application-commands/) or looking to [`Log In With Discord`](/docs/topics/oauth2/), we’ve got you covered.
...
It’s free, easy, and self-serve, so check out [the GameSDK Activity Manager](/docs/game-sdk/activities/) and get started!
