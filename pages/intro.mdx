...
This documentation is not affiliated with or endorsed by Discord in any way. It is a community effort to document the API as it is used by user accounts, and is not an official source of information. Automating user accounts is _against ToS_ (🙄 IKR), so just a heads up doing so unsafely might get you banned.
