...
| user           | [User](/docs/game-sdk/user/data-models-user-struct)                                                                      | the user for the ticket                                  |
| entitlements   | list of partial [Entitlements](/docs/game-sdk/store/data-models-entitlement-struct) structs that contain just the SKU id | the list of the user's entitlements for this application |
...
- the list of the user's [entitlements](/docs/game-sdk/store/data-models-entitlement-struct) for the application id
