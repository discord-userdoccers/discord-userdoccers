...
Before calling this function, you'll need to wait for the [OnCurrentUserUpdate](/game-sdk/users/on-current-user-update) callback to fire after instantiating the User manager.
...
Get the [PremiumType](/game-sdk/user/data-models-premiumtype-enum) for the currently connected user.
...
See whether or not the current user has a certain [UserFlag](/game-sdk/user/data-models-userflag-enum) on their account.
...
| name | type                                                 | description                             |
| ---- | ---------------------------------------------------- | --------------------------------------- |
| flag | [UserFlag](/game-sdk/user/data-models-userflag-enum) | the flag to check on the user's account |
