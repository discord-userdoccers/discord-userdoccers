...
Sets a new voice input mode for the user. Refer to [Shortcut Keys](/game-sdk/discord_voice/data-models-shortcut-keys) for a table of valid values for shortcuts.
