...
| 66     | GUILD_BOOST_UPSELL                            | A local-only ephemeral message asking the user to be the first to boost a guild                                       | Special embed rendered from `boosting_prompt`                                                                                                                                                     | true      |
