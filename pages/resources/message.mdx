...
| embed_type?              | array[string]    | Filter messages by [embed type](#message-embed-type)                     |
...
| attachment_filename? ^3^ | array[string]    | Filter messages by attachment filename                                   |
...
These do not correspond 1:1 to actual [embed types](#embed-object-type) and are used to filter messages that meet a rough criteria.
