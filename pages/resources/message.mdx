...
| duration_secs?         | float     | Duration of the audio file (currently for voice messages)                               |
| waveform?              | string    | Base64 encoded bytearray representing a sampled waveform (currently for voice messages) |
| flags?                 | integer   | The [attachment's flags](#attachment-flags)                                             |
...
| Value   | Name                    | Description                                                       |
| ------- | ----------------------- | ----------------------------------------------------------------- |
| 1 << 0  | IS_CLIP                 | This attachment is a clipped recording of a stream                |
| 1 << 1  | IS_THUMBNAIL            | This attachment is a thumbnail                                    |
| 1 << 2  | IS_REMIX                | This attachment has been edited using the remix feature on mobile |
