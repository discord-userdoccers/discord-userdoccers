...
| resolved?                     | [resolved data](/interactions/receiving-and-responding#resolved-data-structure) object             | The resolved data for the select menu component's interaction                                                                             |
...
| Field          | Type          | Description                                                   |
| -------------- | ------------- | ------------------------------------------------------------- |
| colors         | array[string] | The hex-encoded colors associated with the theme (1-5 colors) |
| gradient_angle | integer       | The angle of the gradient                                     |
| base_mix       | integer       | The base mix value                                            |
...
| attachment_filename?  | string           | Filter messages by attachment filename (max 1024 characters)                                     |
