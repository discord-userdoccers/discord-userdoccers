...
| 63     | EMOJI_ADDED                                   | A message sent when a user adds an emoji to a guild                                                                   | "{author} added a new emoji, {content} **:{emoji.name}:**"                                                                                                                                  | true      |
...
| video                                    | Video embed                                                                               |
| age_verification_system_notification ^1^ | Age verification system message embed                                                     |
...
| attachment_filename? ^3^ | string           | Filter messages by attachment filename (max 1024 characters)                                     |
