...
The author of the message is the user who created the poll.

These messages have a special [embed](/resources/channel#embed-object) structure which contains information about the poll results.
