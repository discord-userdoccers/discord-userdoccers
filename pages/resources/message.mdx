...
| 51     | IN_GAME_MESSAGE_NUX                           | A message sent when a user receives an in-game message NUX                                                            | "{author} messaged you from {application.name}. In-game chat may not include rich messaging features such as images, polls, or apps. [Learn More]({helpdeskArticle})"                       | true      |
