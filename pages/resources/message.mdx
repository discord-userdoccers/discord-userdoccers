...
| embed **(deprecated)** | [embed](#embed-object) object                                                           | embedded `rich` content, deprecated in favor of `embeds`                                          | one of content, file, embed(s), sticker_ids |
...
| embed **(deprecated)** | [embed](#embed-object) object                                                   | embedded `rich` content, deprecated in favor of `embeds`                                          |
