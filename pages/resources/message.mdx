...
| placeholder? ^1^         | string  | A low-resolution [thumbhash](https://github.com/evanw/thumbhash) of the video, to display before it is loaded |
...
| Field      | Type                                           | Description                            |
| ---------- | ---------------------------------------------- | -------------------------------------- |
| used_by    | snowflake                                      | The ID of the user who used the potion |
| type       | integer                                        | The [type of the potion](#potion-type) |
| emoji      | partial [emoji](/resources/emoji#emoji-object) | The emoji associated with the potion   |
