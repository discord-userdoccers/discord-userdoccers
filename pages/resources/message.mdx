...
Represents a rich presence invite in a message.
...
Represents a reference to an originating (replied to) message.
...
{/* todo: document how clip file metadata works */}

| Field                      | Type                                                                    | Description                                                                                                                                  |
| -------------------------- | ----------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| id                         | snowflake                                                               | The attachment ID                                                                                                                            |
| filename                   | string                                                                  | The name of file attached                                                                                                                    |
| uploaded_filename? ^2^ ^5^ | string                                                                  | The name of the file pre-uploaded to Discord's GCP bucket                                                                                    |
...
| is_clip? ^3^ ^4^           | boolean                                                                 | Whether the file being uploaded is a [clipped recording of a stream](https://support.discord.com/hc/en-us/articles/16861982215703-Clips)     |
...
| clip_created_at?           | ISO8601 timestamp                                                       | When the clip was created                                                                                                                    |
| clip_participant_ids? ^4^  | array[snowflake]                                                        | The IDs of the participants in the clip (max 100)                                                                                            |
| clip_participants? ^4^     | array[partial [user](/resources/user#user-object) object]               | The participants in the clip (max 100)                                                                                                       |
| title?                     | string                                                                  | The title of the clip                                                                                                                        |
| application_id? ^4^        | snowflake                                                               | The ID of the application the clip was taken in                                                                                              |
| application? ^4^           | partial [application](/resources/application#application-object) object | The application the clip was taken in                                                                                                        |
...
^4^ The `clip_participant_ids` and `application_id` fields are send-only. You will receive the `clip_participants` and `application` fields back when retrieving the [message](#message-object).

^5^ When sending a pre-uploaded file and setting `is_clip` to `true`, the file's clip metadata must be the same as when it was uploaded.
...
| is_clip?              | boolean           | Whether the file being uploaded is a [clipped recording of a stream](https://support.discord.com/hc/en-us/articles/16861982215703-Clips) |
| clip_created_at?      | ISO8601 timestamp | When the clip was created                                                                                                                |
| clip_participant_ids? | array[snowflake]  | The IDs of the participants in the clip (max 100)                                                                                        |
| title?                | string            | The title of the clip                                                                                                                    |
| application_id?       | snowflake         | The application ID the clip was taken from                                                                                               |
