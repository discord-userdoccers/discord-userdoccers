...
| lobby_id? ^6^                 | snowflake                                                                                          | The ID of the lobby the message was sent in                                                                                               |
...
| application_id?               | snowflake                                                                                          | The ID of the application; only sent for interaction responses and messages created through social layer SDK                              |
...
^6^ If the message was sent in lobby and lobby has no channel linked, this will equal to ID of the lobby.

### Partial Message Object

This structure is a subset of [message](#message-object) object above, with the following fields:
...
^1^ If the message was sent in lobby and lobby has no channel linked, this will equal to ID of the lobby.
