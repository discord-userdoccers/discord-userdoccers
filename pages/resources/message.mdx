...
| sounboard_sounds?             | array[[soundboard sound](/resources/soundboard/#soundboard-sound-object) object]                         | The message's soundboard sounds                                                                                                           |
...
| max_id? ^1^           | snowflake        | Get messages before this message ID                                      |
| min_id? ^1^           | snowflake        | Get messages after this message ID                                       |
...
| channel_id? ^2^       | array[snowflake] | Filter messages by these channels                                        |
...
^1^ Only one of `max_id` or `min_id` may be specified. Specifying both will lead to no results.

^2^ Not applicable when using the `GET /channels/{channel.id}/messages/search` endpoint.
