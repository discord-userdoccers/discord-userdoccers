...
This endpoint functions identically to the [Create Message](/reference#create-message) endpoint, but is used for DM channels in an OAuth2 context. Check there for more information.
