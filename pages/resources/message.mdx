...
| application?            | [integration application](/resources/integration#integration-application-object) object            | The application of the message's activity                                                                                                 |
...
| 40     | GUILD_DEADCHAT_REVIVE_PROMPT                 | A message sent when no one sends a message in the current channel for 1 hour | "{author} reported a false alarm in {guild}."                                                                                                                                           | false     |     |
| 42     | GUILD_GAMING_STATS_PROMPT                    |                                                                              | "{content}"                                                                                                                                                                             | false     |
