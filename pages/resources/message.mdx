...
| Field                    | Type    | Description                                                                                                   |
| ------------------------ | ------- | ------------------------------------------------------------------------------------------------------------- |
| url                      | string  | Source URL of thumbnail (only supports http(s) and attachments) (max 2048 characters)                         |
| proxy_url? ^1^           | string  | A proxied URL of the thumbnail                                                                                |
| height? ^1^              | integer | Height of thumbnail                                                                                           |
| width? ^1^               | integer | Width of thumbnail                                                                                            |
| flags? ^1^               | integer | The [thumbnail's attachment flags](#attachment-flags)                                                         |
...
This endpoint functions identically to the [Create Message](#create-message) endpoint, but is used for DM channels in an OAuth2 context. Check there for more information.
