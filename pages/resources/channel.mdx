...
| type                           | integer                                                               | the [type of channel](/resources/channel/channel-object-channel-types)                                                                                                          |
...
| permission_overwrites?         | array of [overwrite](/resources/channel/overwrite-object) objects     | explicit permission overwrites for members and roles                                                                                                                            |
...
| video_quality_mode?            | integer                                                               | the camera [video quality mode](/resources/channel/channel-object-video-quality-modes) of the voice channel, 1 when not present                                                 |
...
| thread_metadata?               | a [thread metadata](/resources/channel/thread-metadata-object) object | thread-specific fields not needed by other channels                                                                                                                             |
| member?                        | a [thread member](/resources/channel/thread-member-object) object     | thread member object for the current user, if they have joined the thread, only included on certain API endpoints                                                               |
...
| mention_channels?\*\*\*\*     | array of [channel mention](/resources/channel/channel-mention-object) objects                                                         | channels specifically mentioned in this message                                                                                            |
| attachments                   | array of [attachment](/resources/channel/attachment-object) objects                                                                   | any attached files                                                                                                                         |
| embeds                        | array of [embed](/resources/channel/embed-object) objects                                                                             | any embedded content                                                                                                                       |
| reactions?                    | array of [reaction](/resources/channel/reaction-object) objects                                                                       | reactions to the message                                                                                                                   |
...
| type                          | integer                                                                                                                               | [type of message](/resources/channel/message-object-message-types)                                                                         |
| activity?                     | [message activity](/resources/channel/message-object-message-activity-structure) object                                               | sent with Rich Presence-related chat embeds                                                                                                |
...
| message_reference?            | [message reference](/resources/channel/message-reference-object-message-reference-structure) object                                   | data showing the source of a crosspost, channel follow add, pin, or reply message                                                          |
| flags?                        | integer                                                                                                                               | [message flags](/resources/channel/message-object-message-flags) combined as a [bitfield](https://en.wikipedia.org/wiki/Bit_field)         |
| referenced_message?\*\*\*\*\* | ?[message object](/resources/channel/message-object)                                                                                  | the message associated with the message_reference                                                                                          |
| interaction?                  | [message interaction object](/interactions/receiving-and-responding/message-interaction-object-message-interaction-structure)         | sent if the message is a response to an [Interaction](/interactions/receiving-and-responding/)                                             |
...
| Field     | Type    | Description                                                                                                   |
| --------- | ------- | ------------------------------------------------------------------------------------------------------------- |
| type      | integer | [type of message activity](/resources/channel/message-object-message-activity-types)                          |
| party_id? | string  | party_id from a [Rich Presence event](/rich-presence/how-to/updating-presence-update-presence-payload-fields) |
...
| type?        | string                                                                                | [type of embed](/resources/channel/embed-object-embed-types) (always "rich" for webhook embeds) |
| description? | string                                                                                | description of embed                                                                            |
| url?         | string                                                                                | url of embed                                                                                    |
| timestamp?   | ISO8601 timestamp                                                                     | timestamp of embed content                                                                      |
| color?       | integer                                                                               | color code of the embed                                                                         |
| footer?      | [embed footer](/resources/channel/embed-object-embed-footer-structure) object         | footer information                                                                              |
| image?       | [embed image](/resources/channel/embed-object-embed-image-structure) object           | image information                                                                               |
| thumbnail?   | [embed thumbnail](/resources/channel/embed-object-embed-thumbnail-structure) object   | thumbnail information                                                                           |
| video?       | [embed video](/resources/channel/embed-object-embed-video-structure) object           | video information                                                                               |
| provider?    | [embed provider](/resources/channel/embed-object-embed-provider-structure) object     | provider information                                                                            |
| author?      | [embed author](/resources/channel/embed-object-embed-author-structure) object         | author information                                                                              |
| fields?      | array of [embed field](/resources/channel/embed-object-embed-field-structure) objects | fields information                                                                              |
...
| Field        | Type                           | Description                                                                                                                      |
| ------------ | ------------------------------ | -------------------------------------------------------------------------------------------------------------------------------- |
| parse        | array of allowed mention types | An array of [allowed mention types](/resources/channel/allowed-mentions-object-allowed-mention-types) to parse from the content. |
...
| fields                                                                | Up to 25 [field](/resources/channel/embed-object-embed-field-structure) objects |
| [field.name](/resources/channel/embed-object-embed-field-structure)   | 256 characters                                                                  |
| [field.value](/resources/channel/embed-object-embed-field-structure)  | 1024 characters                                                                 |
| [footer.text](/resources/channel/embed-object-embed-footer-structure) | 2048 characters                                                                 |
| [author.name](/resources/channel/embed-object-embed-author-structure) | 256 characters                                                                  |
...
Get a channel by ID. Returns a [channel](/resources/channel/channel-object) object. If the channel is a thread, a [thread member](/resources/channel/thread-member-object) object is included in the returned result.

<RouteHeader method="PATCH" url="/channels/{channel.id}">
  Modify Channel
</RouteHeader>

Update a channel's settings. Returns a [channel](/resources/channel/channel-object) on success, and a 400 BAD REQUEST on invalid parameters. All JSON parameters are optional.
...
| permission_overwrites         | ?array of [overwrite](/resources/channel/overwrite-object) objects | channel or category-specific permissions                                                                                                                                        | All                      |
...
| video_quality_mode            | ?integer                                                           | the camera [video quality mode](/resources/channel/channel-object-video-quality-modes) of the voice channel                                                                     | Voice                    |
...
\* The 3 day and 7 day archive durations require the server to be boosted. The [guild features](/resources/guild/guild-object-guild-features) will indicate if a server is able to use those settings.

<RouteHeader method="DELETE" url="/channels/{channel.id}">
...
Returns the messages for a channel. If operating on a guild channel, this endpoint requires the `VIEW_CHANNEL` permission to be present on the current user. If the current user is missing the 'READ_MESSAGE_HISTORY' permission in the channel then this will return no messages (since they cannot read the message history). Returns an array of [message](/resources/channel/message-object) objects on success.
...
Returns a specific message in the channel. If operating on a guild channel, this endpoint requires the 'READ_MESSAGE_HISTORY' permission to be present on the current user. Returns a [message](/resources/channel/message-object) object on success.
...
Post a message to a guild text or DM channel. Returns a [message](/resources/channel/message-object) object. Fires a [Message Create](/topics/gateway/message-create) Gateway event. See [message formatting](/reference/message-formatting) for more information on how to properly format messages.
...
You may create a message as a reply to another message. To do so, include a [`message_reference`](/resources/channel/message-reference-object-message-reference-structure) with a `message_id`. The `channel_id` and `guild_id` in the `message_reference` are optional, but will be validated if provided.
...
| embeds               | array of [embed](/resources/channel/embed-object) objects                                    | embedded `rich` content (up to 6000 characters)                                                   | one of content, file, embed(s), sticker_ids |
| embed _(deprecated)_ | [embed](/resources/channel/embed-object) object                                              | embedded `rich` content, deprecated in favor of `embeds`                                          | one of content, file, embed(s), sticker_ids |
...
| message_reference    | [message reference](/resources/channel/message-reference-object-message-reference-structure) | include to make your message a reply                                                              | false                                       |
...
Returns a [message](/resources/channel/message-object) object.
...
Returns a [message](/resources/channel/message-object) object. Fires a [Message Update](/topics/gateway/message-update) Gateway event.
...
| embeds               | array of [embed](/resources/channel/embed-object) objects                       | embedded `rich` content (up to 6000 characters)                                                                                    |
| embed _(deprecated)_ | [embed](/resources/channel/embed-object) object                                 | embedded `rich` content, deprecated in favor of `embeds`                                                                           |
| flags                | integer                                                                         | edit the [flags](/resources/channel/message-object-message-flags) of a message (only `SUPPRESS_EMBEDS` can currently be set/unset) |
...
<RouteHeader method="DELETE" url="/channels/{channel.id}/messages/{message.id}">
  Delete Message
</RouteHeader>
...
<RouteHeader method="POST" url="/channels/{channel.id}/messages/bulk-delete">
...
<RouteHeader method="PUT" url="/channels/{channel.id}/permissions/{overwrite.id}">
...
<RouteHeader method="POST" url="/channels/{channel.id}/invites">
...
<RouteHeader method="DELETE" url="/channels/{channel.id}/permissions/{overwrite.id}">
...
Follow a News Channel to send messages to a target channel. Requires the `MANAGE_WEBHOOKS` permission in the target channel. Returns a [followed channel](/resources/channel/followed-channel-object) object.
...
Returns all pinned messages in the channel as an array of [message](/resources/channel/message-object) objects.

<RouteHeader method="PUT" url="/channels/{channel.id}/pins/{message.id}">
  Pin Message
</RouteHeader>
...
<RouteHeader method="DELETE" url="/channels/{channel.id}/pins/{message.id}">
  Unpin Message
</RouteHeader>
...
<RouteHeader method="POST" url="/channels/{channel.id}/messages/{message.id}/threads">
  Start Thread with Message
</RouteHeader>

Creates a new thread from an existing message. Returns a [channel](/resources/channel/channel-object) on success, and a 400 BAD REQUEST on invalid parameters. Fires a [Thread Create](/topics/gateway/thread-create) Gateway event.
...
<RouteHeader method="POST" url="/channels/{channel.id}/threads">
  Start Thread without Message
</RouteHeader>

Creates a new thread that is not connected to an existing message. The created thread defaults to a `GUILD_PRIVATE_THREAD`\*. Returns a [channel](/resources/channel/channel-object) on success, and a 400 BAD REQUEST on invalid parameters. Fires a [Thread Create](/topics/gateway/thread-create) Gateway event.
...
| name                      | string  | 1-100 character channel name                                                                                        |
| auto_archive_duration\*\* | integer | duration in minutes to automatically archive the thread after recent activity, can be set to: 60, 1440, 4320, 10080 |
| type?\*\*\*               | integer | the [type of thread](/resources/channel/channel-object-channel-types) to create                                     |
...
\* Creating a private thread requires the server to be boosted. The [guild features](/resources/guild/guild-object-guild-features) will indicate if that is possible for the guild.

\*\* The 3 day and 7 day archive durations require the server to be boosted. The [guild features](/resources/guild/guild-object-guild-features) will indicate if that is possible for the guild.
...
Returns array of [thread members](/resources/channel/thread-member-object) objects that are members of the thread.
...
Returns archived threads in the channel that are public. When called on a `GUILD_TEXT` channel, returns threads of [type](/resources/channel/channel-object-channel-types) `GUILD_PUBLIC_THREAD`. When called on a `GUILD_NEWS` channel returns threads of [type](/resources/channel/channel-object-channel-types) `GUILD_NEWS_THREAD`. Threads are ordered by `archive_timestamp`, in descending order. Requires the `READ_MESSAGE_HISTORY` permission.
...
| Field    | Type                                                                       | Description                                                                                  |
| -------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| threads  | array of [channel](/resources/channel/channel-object) objects              | the public, archived threads                                                                 |
| members  | array of [thread members](/resources/channel/thread-member-object) objects | a thread member object for each returned thread the current user has joined                  |
| has_more | boolean                                                                    | whether there are potentially additional threads that could be returned on a subsequent call |
...
Returns archived threads in the channel that are of [type](/resources/channel/channel-object-channel-types) `GUILD_PRIVATE_THREAD`. Threads are ordered by `archive_timestamp`, in descending order. Requires both the `READ_MESSAGE_HISTORY` and `MANAGE_THREADS` permissions.
...
| Field    | Type                                                                       | Description                                                                                  |
| -------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| threads  | array of [channel](/resources/channel/channel-object) objects              | the private, archived threads                                                                |
| members  | array of [thread members](/resources/channel/thread-member-object) objects | a thread member object for each returned thread the current user has joined                  |
| has_more | boolean                                                                    | whether there are potentially additional threads that could be returned on a subsequent call |
...
Returns archived threads in the channel that are of [type](/resources/channel/channel-object-channel-types) `GUILD_PRIVATE_THREAD`, and the user has joined. Threads are ordered by their `id`, in descending order. Requires the `READ_MESSAGE_HISTORY` permission.
...
| Field    | Type                                                                       | Description                                                                                  |
| -------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| threads  | array of [channel](/resources/channel/channel-object) objects              | the private, archived threads the current user has joined                                    |
| members  | array of [thread members](/resources/channel/thread-member-object) objects | a thread member object for each returned thread the current user has joined                  |
| has_more | boolean                                                                    | whether there are potentially additional threads that could be returned on a subsequent call |
