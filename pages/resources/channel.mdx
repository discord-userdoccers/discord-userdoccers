...
| default_reaction_emoji?             | ?[partial emoji](#partial-emoji-object) object                     | The emoji to show in the add reaction button on a thread in a thread-only channel                                                                                                            |
...
| icon_emoji?                         | ?[partial emoji](#partial-emoji-object) object                     | The emoji to show next to the channel name in channels list                                                                                                                                  |
...
An object that represents a partial emoji.

###### Partial Emoji Structure
...
| default_reaction_emoji?             | ?[partial emoji](#partial-emoji-object) object                      | The emoji to show in the add reaction button on a thread in a thread-only channel                                                                                                    | Forum, Media                           |
