...
| video_quality_mode?            | integer                                              | the camera [video quality mode](#channel-object-video-quality-modes) of the voice channel, 1 when not present                                                                   |
...
| type                          | integer                                                                                                                       | [type of message](#message-object-message-types)                                                                                           |
| activity?                     | [message activity](#message-object-message-activity-structure) object                                                         | sent with Rich Presence-related chat embeds                                                                                                |
...
| message_reference?            | [message reference](#message-reference-object-message-reference-structure) object                                             | data showing the source of a crosspost, channel follow add, pin, or reply message                                                          |
| flags?                        | integer                                                                                                                       | [message flags](#message-object-message-flags) combined as a [bitfield](https://en.wikipedia.org/wiki/Bit_field)                           |
...
| thread?                       | [channel](#channel) object                                                                                                    | the thread that was started from this message, includes [thread member](#thread-member-object) object                                      |
...
| Field     | Type    | Description                                                                                                   |
| --------- | ------- | ------------------------------------------------------------------------------------------------------------- |
| type      | integer | [type of message activity](#message-object-message-activity-types)                                            |
...
| type?        | string                                                              | [type of embed](#embed-object-embed-types) (always "rich" for webhook embeds) |
| description? | string                                                              | description of embed                                                          |
| url?         | string                                                              | url of embed                                                                  |
| timestamp?   | ISO8601 timestamp                                                   | timestamp of embed content                                                    |
| color?       | integer                                                             | color code of the embed                                                       |
| footer?      | [embed footer](#embed-object-embed-footer-structure) object         | footer information                                                            |
| image?       | [embed image](#embed-object-embed-image-structure) object           | image information                                                             |
| thumbnail?   | [embed thumbnail](#embed-object-embed-thumbnail-structure) object   | thumbnail information                                                         |
| video?       | [embed video](#embed-object-embed-video-structure) object           | video information                                                             |
| provider?    | [embed provider](#embed-object-embed-provider-structure) object     | provider information                                                          |
| author?      | [embed author](#embed-object-embed-author-structure) object         | author information                                                            |
| fields?      | array of [embed field](#embed-object-embed-field-structure) objects | fields information                                                            |
...
| Field        | Type                           | Description                                                                                                    |
| ------------ | ------------------------------ | -------------------------------------------------------------------------------------------------------------- |
| parse        | array of allowed mention types | An array of [allowed mention types](#allowed-mentions-object-allowed-mention-types) to parse from the content. |
...
| fields                                              | Up to 25 [field](#embed-object-embed-field-structure) objects |
| [field.name](#embed-object-embed-field-structure)   | 256 characters                                                |
| [field.value](#embed-object-embed-field-structure)  | 1024 characters                                               |
| [footer.text](#embed-object-embed-footer-structure) | 2048 characters                                               |
| [author.name](#embed-object-embed-author-structure) | 256 characters                                                |
...
<RouteHeader method="PATCH" url="/channels/{channel.id}" supportsXAuditLogHeader>
  Modify Channel
</RouteHeader>
...
| type                          | integer                                          | the [type of channel](#channel-object-channel-types); only conversion between text and news is supported and only in guilds with the "NEWS" feature                             | Text, News               |
...
| video_quality_mode            | ?integer                                         | the camera [video quality mode](#channel-object-video-quality-modes) of the voice channel                                                                                       | Voice                    |
...
<RouteHeader method="DELETE" url="/channels/{channel.id}" supportsXAuditLogHeader>
...
You may create a message as a reply to another message. To do so, include a [`message_reference`](#message-reference-object-message-reference-structure) with a `message_id`. The `channel_id` and `guild_id` in the `message_reference` are optional, but will be validated if provided.
...
| message_reference    | [message reference](#message-reference-object-message-reference-structure)              | include to make your message a reply                                                              | false                                       |
...
| flags                | integer                                                                         | edit the [flags](#message-object-message-flags) of a message (only `SUPPRESS_EMBEDS` can currently be set/unset) |
...
<RouteHeader method="DELETE" url="/channels/{channel.id}/messages/{message.id}" supportsXAuditLogHeader>
  Delete Message
</RouteHeader>
...
<RouteHeader method="POST" url="/channels/{channel.id}/messages/bulk-delete" supportsXAuditLogHeader>
...
<RouteHeader method="POST" url="/channels/{channel.id}/invites" supportsXAuditLogHeader>
...
<RouteHeader method="PUT" url="/channels/{channel.id}/pins/{message.id}" supportsXAuditLogHeader>
  Pin Message
</RouteHeader>
...
<RouteHeader method="DELETE" url="/channels/{channel.id}/pins/{message.id}" supportsXAuditLogHeader>
  Unpin Message
</RouteHeader>
...
<RouteHeader method="POST" url="/channels/{channel.id}/threads" supportsXAuditLogHeader>
...
| name                      | string  | 1-100 character channel name                                                                                        |
| auto_archive_duration\*\* | integer | duration in minutes to automatically archive the thread after recent activity, can be set to: 60, 1440, 4320, 10080 |
| type?\*\*\*               | integer | the [type of thread](#channel-object-channel-types) to create                                                       |
...
Returns archived threads in the channel that are public. When called on a `GUILD_TEXT` channel, returns threads of [type](#channel-object-channel-types) `GUILD_PUBLIC_THREAD`. When called on a `GUILD_NEWS` channel returns threads of [type](#channel-object-channel-types) `GUILD_NEWS_THREAD`. Threads are ordered by `archive_timestamp`, in descending order. Requires the `READ_MESSAGE_HISTORY` permission.
...
Returns archived threads in the channel that are of [type](#channel-object-channel-types) `GUILD_PRIVATE_THREAD`. Threads are ordered by `archive_timestamp`, in descending order. Requires both the `READ_MESSAGE_HISTORY` and `MANAGE_THREADS` permissions.
...
Returns archived threads in the channel that are of [type](#channel-object-channel-types) `GUILD_PRIVATE_THREAD`, and the user has joined. Threads are ordered by their `id`, in descending order. Requires the `READ_MESSAGE_HISTORY` permission.
