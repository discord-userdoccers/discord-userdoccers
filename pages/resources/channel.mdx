...
| default_forum_layout?               | integer                                                            | The default [layout](#forum-layout) of a thread-only channel                                                                                                                                 |
...
^1^ Only present when the channel is received from an [invite](/topics/invites#invite-object) with `with_counts` set to `true`.

^2^ Not present when the channel is received from an [invite](/topics/invites#invite-object), as it can be inferred from the `guild` field.
...
| default_sort_order?                 | ?integer                                                            | The default [sort order](#forum-sort-order) of a thread-only channel's threads                                                                                                       | Forum, Media                           |
