...
| 1 << 7  | GUILD_RESOURCE_CHANNEL                     | This guild channel is used as a read-only resource for Server Onboarding and is not shown in the channel list |
...
| 1 << 11 | SUMMARIES_DISABLED                         | This guild channel has disabled channel summaries                                                             |
| 1 << 12 | APPLICATION_SHELF_CONSENT                  | This group DM's recipients consented to the application shelf                                                 |
| 1 << 12 | ROLE_SUBSCRIPTION_TEMPLATE_PREVIEW_CHANNEL | This server subscription tier for this guild channel has not been published yet                               |
...
| embeds?\*\*                 | array[[embed](/resources/message#embed-object) object]                               | Embedded `rich` content (max 10, 6000 characters)                                                                                          |
...
| attachments?\*              | array[partial [attachment](/resources/message#attachment-object) object]             | Partial attachment objects with `filename` and `description` (max 10)                                                                      |
