...
If the entity you are searching is not yet indexed, the endpoint will return a 200 OK response. Unexpectedly, the response body will not contain any search results, and will look similar to an error response:
