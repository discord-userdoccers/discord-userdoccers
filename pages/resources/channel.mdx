...
^8^ For ephemeral DM channels, the ID of the channel always will equal to ID of the other recipient.
  ...
  "recipients": [
    {
      ...
      "clan": {
        "badge": "6cdb13f9bdba1234e711a7c24dce1f51",
        "identity_enabled": true,
        "identity_guild_id": "1241115476021481582",
        "tag": "BUG"
      },
      "discriminator": "0",
      "global_name": "Dolfies",
    ...
    },
    {
      ...
      "clan": {
        "badge": "226a800b1b7782e556dd190804332720",
        "identity_enabled": true,
        "identity_guild_id": "1270810315558228078",
        "tag": "wawa"
      },
      "discriminator": "0",
      "global_name": "Dziurwa💕",
...
| linked_by      | snowflake         | The ID of the user who linked lobby  |
...
Unlinks lobby from the channel. Requires the `MANAGE_CHANNELS` permission. Returns a [channel](#channel-object) object on success. Fires a [Lobby Update](/topics/gateway-events#lobby-update) and [Channel Update](/topics/gateway-events#channel-update) Gateway event.
