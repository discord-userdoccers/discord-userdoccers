...
Returns an HTTP 200 OK status with a JSON response when the channel has a rate limit that the user is currently within.
...
| Field                       | Type   | Description                                                                                     |  
| --------------------------- | ------ | ----------------------------------------------------------------------------------------------- |  
| message_send_cooldown_ms    | number | The remaining cooldown time (in milliseconds) before the user can send another message.         |  
| thread_create_cooldown_ms   | number | The remaining cooldown time (in milliseconds) before the user can create a new thread.          |  
