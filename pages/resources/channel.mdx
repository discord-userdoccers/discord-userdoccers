...
<RouteHeader method="POST" url="/users/@me/channels" supportsOAuth2="gdm.join" risky>
...
After creating a new DM, the first message sent will also be considered as a [risky](/reference#risky-request) request.
