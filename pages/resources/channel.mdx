...
Returns a [DM channel](#channel-object) on success. Fires [Channel Update](/topics/gateway-events#channel-update), Message ACK, [Channel Delete](/topics/gateway-events#channel-delete), and has a chance to send [DM Settings Upsell Show](/topics/gateway-events#dm-settings-upsell-show) Gateway event.
