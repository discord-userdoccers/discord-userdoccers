...
| 1 << 7  | IS_GUILD_RESOURCE_CHANNEL  | This guild channel is used as a read-only resource for Server Onboarding and is not shown in the channel list |
...
| 1 << 10 | IS_MEDIA_CHANNEL        | This forum channel is a media channel                                                                         |
