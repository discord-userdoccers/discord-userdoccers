...
Replaces a tag in the forum channel. Requires the `MANAGE_CHANNELS` permission. Returns a [channel](#channel-object) object on success. Fires a [Channel Update](/topics/gateway#channel-update) Gateway event.
