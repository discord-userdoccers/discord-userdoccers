...
| ~~1 << 10~~ | ~~IS_MEDIA_CHANNEL~~ ^1^                      | ~~This forum channel is a media channel~~                                                                                                                       |
...
| 1 << 16     | IS_JOIN_REQUEST_INTERVIEW_CHANNEL             | This group DM is used for [guild join request interviews](https://support.discord.com/hc/en-us/articles/23187611406999-Guilds-FAQ#h_01HXW2MCD0BT70FB9SRV1YRPBV) |
...
Updates the current user's thread settings. User must be a member of the thread. Returns a [thread member](#thread-member-object) on success, or a 204 empty response when nothing changed. Fires a [Thread Member Update](/topics/gateway-events#thread-member-update) Gateway event.
