...
| parent_id? ^2^                      | ?snowflake                                                   | The ID of the parent category/channel for the guild channel/thread                                                                                                                          |
...
| available_tags? ^1^                 | array[partial [tag](#forum-tag-object) object]       | The tags that can be used in a forum channel (max 20)                                                                                                                                | Forum                                                       |
...
^1^ Only the `name` field is required (`id` may be passed to denote an existing tag).
...
^2^ This field is required (and only available) when creating a thread in a forum channel.
