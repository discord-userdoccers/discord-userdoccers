...
| available_tags?\*                   | array[[tag](#forum-tag-object) object]               | The tags that can be used in a forum channel (max 20)                                                                                                                                | Forum                                                       |
...
| members  | array of [thread member](#thread-member-object) objects | A thread member object for each returned thread the current user has joined                  |
...
Creates a new thread that is not connected to an existing message. Returns a [channel](#channel-object) (with an optional extra [`message`](/resources/message#message-object) key) on success. Fires a [Thread Create](#channel-object) Gateway event.
...
| embeds?           | array of [embed](/resources/message#embed-object) objects                                    | Embedded `rich` content (max 6000 characters)                                                        |
| allowed_mentions? | [allowed mention object](/resources/message#allowed-mentions-object)                         | Allowed mentions for the message                                                                     |
...
| sticker_ids?      | array of snowflakes                                                                          | IDs of up to 3 [stickers](/resources/sticker#sticker-object) to send in the message                  |
| files[n]?\*       | file contents                                                                                | Contents of the file being sent                                                                      |
| payload_json?\*   | string                                                                                       | JSON-encoded body of non-file params                                                                 |
| attachments?\*    | array of partial [attachment](/resources/message#attachment-object) objects                  | Attachment objects with `filename` and `description`                                                 |
| flags?            | integer                                                                                      | [Message flags](/resources/message#message-object-message-flags) (only `SUPPRESS_EMBEDS` can be set) |
