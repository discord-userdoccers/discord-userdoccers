...
Returns a [DM channel](#channel-object) on success.

<Alert type="warn">

All consent statuses other than `ACCEPTED` are employee-only.
...
| Field          | Type    | Description                           |
| -------------- | ------- | ------------------------------------- |
| consent_status | integer | The [consent status](#consent-status) |
