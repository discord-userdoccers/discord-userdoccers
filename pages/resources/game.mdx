...
| Field                   | Type    | Description |
| ----------------------- | ------- | ----------- |
| rating?                 | float   | Unknown     |
| rating_count?           | integer | Unknown     |
| recent_rating?          | float   | Unknown     |
| recent_rating_count?    | integer | Unknown     |
| localized_rating?       | float   | Unknown     |
| localized_rating_count? | integer | Unknown     |
