...
<RouteHeader method="GET" url="/applications/{application.id}/entitlements/{entitlement.id}" supportsOAuth2="applications.entitlements">
...
<RouteHeader method="POST" url="/applications/{application.id}/entitlements/{entitlement.id}/consume" supportsOAuth2="applications.entitlements">
...
<RouteHeader method="DELETE" url="/applications/{application.id}/entitlements/{entitlement.id}" supportsOAuth2="applications.entitlements">
