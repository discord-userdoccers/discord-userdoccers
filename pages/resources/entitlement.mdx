...
| branches?           | list[snowflake]           | The IDs of the application branches granted                                    |
...
| fulfillment_status? | integer                   | The [fulfillment status](#entitlement-fulfillment-status) of the entitlement   |
...
| subscription_plan?  | partial subscription plan | The subscription plan granted                                                  |
...
| 13    | GUILD_POWERUP               | Entitlement is for a guild powerup                                |
...
| entitlement_branches? | list[snowflake]                                    | The IDs of the application branches granted by the gift code |
...
<RouteHeader method="GET" url="/entitlements/gift-codes/{gift_code.code}">
  Get Gift Code
</RouteHeader>
...
| Field                 | Type      | Description                                  |
| --------------------- | --------- | -------------------------------------------- |
| sku_ids?              | array     | The IDs of the SKUs to filter by             |
