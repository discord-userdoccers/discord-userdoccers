...
Creates a new stage instance associated to a stage channel. Returns a [stage instance](#DOCS_RESOURCES_STAGE_INSTANCE/stage-instance-object) object. Fires a [Stage Instance Create](/topics/gateway-events#stage-instance-create) Gateway event.
