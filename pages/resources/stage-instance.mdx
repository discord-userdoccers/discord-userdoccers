...
| privacy_level         | integer   | The [privacy level](#stage-instance-object-privacy-level) of the Stage instance |
...
| topic          | string    | The topic of the Stage instance (1-120 characters)                                                   |
| privacy_level? | integer   | The [privacy level](#stage-instance-object-privacy-level) of the Stage instance (default GUILD_ONLY) |
...
<RouteHeader method="PATCH" url="/stage-instances/{channel.id}" supportsXAuditLogHeader>
...
<RouteHeader method="DELETE" url="/stage-instances/{channel.id}" supportsXAuditLogHeader>
