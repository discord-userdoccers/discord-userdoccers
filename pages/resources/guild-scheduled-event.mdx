...
| by_n_weekday    | ?array[[recurrence rule - n_weekday](#guild-scheduled-event-recurrence-rule-nweekday-structure) object] | Specific days within a specific week (1-5) to recur on                                                                                            |
