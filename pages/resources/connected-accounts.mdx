...
| Field                           | Type                                                                  | Description                                                           |
| ------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- |
| friend_list_entries             | array[[contact sync payload](#contact-sync-payload-structure) object] | Phone numbers to find accounts of                                     |
| background                      | boolean                                                               | Request is a background sync, will not return suggestions             |
| allowed_in_suggestions          | integer                                                               | [Contact sync suggestions setting](#contact-sync-suggestions-setting) |
| include_mutual_friends_count    | boolean                                                               | Show the mutual friend count of contacts                              |
| add_reverse_friend_suggestions? | boolean                                                               | Show users that have contact synced you                               |

###### Contact Sync Payload Structure

| Field     | Type   | Description                         |
| --------- | ------ | ----------------------------------- |
| friend_id | string | Phone number to find an account for |

###### Contact Sync Suggestions Setting

| Value | Name                     |
| ----- | ------------------------ |
| 1     | MUTUAL_CONTACT_INFO_ONLY |
| 2     | ANYONE_WITH_CONTACT_INFO |

###### Response Body

| Field              | Type                                                                                 | Description                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------- |
| bulk_add_token     | ?string                                                                              | Token to be used for [bulk add relationships](/resources/relationships#bulk-add-relationships) |
