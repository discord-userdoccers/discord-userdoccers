...
| approximate_presence_count? ^1^ | integer                                                                                    | Approximate count of online members                                                                                          |
| approximate_member_count? ^1^   | integer                                                                                    | Approximate count of total members                                                                                           |
...
^1^ Only returned from the [Get Invite](#get-invite) endpoint when `with_counts` is `true`.
