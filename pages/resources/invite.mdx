...
| expires_at?                   | ?ISO8601 timestamp                                                                         | The expiration date of this invite; if present and `null`, the invite never expires                                          |
...
| vanity_url_code             | ?string                                         | The vanity code for the guild                                                       |
...
| nsfw\*                      | boolean                                         | Whether or not the guild is considered NSFW                                         |
...
\* This field is deprecated and will be removed in a future API version. Use `nsfw_level` instead.
...
| icon?       | ?string                                                   | The DM's [icon hash](/reference#image-formatting)              |
