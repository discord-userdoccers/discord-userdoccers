...
| Field        | Type      | Description                        |
| ------------ | --------- | ---------------------------------- |
| id           | snowflake | The ID fo the premium group invite |
| subscription | snowflake | The ID of the subscription         |
| primary_user | snowflake | The ID of the primary user         |
...
Returns information about premium group membership of the current user.
...
| member_type         | integer           | The [type](/resources/user#premium-subscription-group-role) of member     |
| subscription_status | integer           | The [status](/resources/subscription#subscription-status) of subscription |
...
Returns a list of [premium group invite](#premium-group-invite-object) objects for the premium group.

<RouteHeader method="GET" url="/users/@me/premium-group/invites/{user.id}">
  Get Premium Group Invite
</RouteHeader>

Returns a [premium group invite](#premium-group-invite-object) object for the given user ID.
