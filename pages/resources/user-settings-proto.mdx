...
| Value  | Name         | Description                                  |
| ------ | ------------ | -------------------------------------------- |
| 1 << 0 | JOIN_GUILD   | The user has joined a guild in the hub       |
| 1 << 1 | INVITE_USER  | The user has sent an invite for the hub      |
| 1 << 2 | CONTACT_SYNC | The user has accepted the contact sync modal |

###### Guild Onboarding Progress Flags

| Value  | Name           | Description                                   |
| ------ | -------------- | --------------------------------------------- |
| 1 << 0 | NOTICE_SHOWN   | The user has been shown the onboarding notice |
| 1 << 1 | NOTICE_CLEARED | The user has cleared the onboarding notice    |

###### Custom Call Sound Structure

| Field    | Type    | Description                               |
| -------- | ------- | ----------------------------------------- |
| sound_id | fixed64 | The ID of the custom call sounboard sound |
