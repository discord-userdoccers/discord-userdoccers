...
| show_mention_suggestions?             | BoolValue                                                                  | Whether to show mention suggestions in chat (default true)                                                                                   |
...
| game_activity_notifications                  | [game activity notification type](#game-activity-notification-type) enum           | Game activity notification settings                                                                |
...
| game_activity_exclude_steam_notifications?   | BoolValue                                                                          | Whether to exclude Steam from game activity notifications                                          |
...
| enable_user_resurrection_notifications?      | BoolValue                                                                          | Whether to enable notifications for users becoming active again after a long hiatus (default true) |
...
| enable_server_trending_notifications?        | BoolValue                                                                          | Whether to enable server trending notifications (default true)                                     |
...
| enable_gdm_all_reaction_notifications?       | BoolValue                                                                          | Whether to enable all reaction notifications in group DMs (default `reaction_notifications`)       |
...
<RouteHeader method="GET" url="/users/@me/settings-proto/{user_settings_proto_type}">
...
<RouteHeader method="PATCH" url="/users/@me/settings-proto/{user_settings_proto_type}">
