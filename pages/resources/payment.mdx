...
<RouteHeader method="POST" url="/users/@me/billing/invoice">
  Create Payment Invoice PDF
</RouteHeader>

Creates a PDF invoice for the given payment ID. Returns a base64-encoded PDF string.

###### JSON Params

| Field                     | Type                                                                    | Description                                               |
| ------------------------- | ----------------------------------------------------------------------- | --------------------------------------------------------- |
| payment_id                | snowflake                                                               | The ID of the payment to create an invoice for            |
| billing_address_override? | ?[billing address](/resources/billing#billing-address-structure) object | The billing address override to render on the PDF invoice |
