...
It is mandatory that all purchase requests include this token in the `purchase_token` field of the request body, and the tokens expire after 60 days and must be regenerated.
