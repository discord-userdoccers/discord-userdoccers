...
| application_role_connections? | array[[application role connection](/resources/application#application-role-connection-object)] | The user's application role connections for the role specified                                                         |
