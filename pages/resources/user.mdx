...
\* Not included when fetching a user's connections via OAuth2.
...
| Field                         | Type                                                                      | Description                                                                 |
| ----------------------------- | ------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| user                          | partial [user](#user-object) object                                       | The user object with an extra `bio` key                                     |
| user_profile\*                | [profile metadata](#profile-metadata-object) object                       | The user's profile metadata                                                 |
| guild_member?\*               | [guild member](#guild-member-object) object                               | The guild member in the guild specified, with extra `banner` and `bio` keys |
...
Returns a list of [subreddits](#subreddit-object) the connected account moderates. Only available for Reddit connections.
