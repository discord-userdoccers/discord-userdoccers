...
| 1 << 33 | HIGH_GLOBAL_RATE_LIMIT       | User has a raised global ratelimit                                                          | No     |
| 1 << 34 | DELETED                      | User's account is deleted                                                                   | No     |
| 1 << 35 | DISABLED_SUSPICIOUS_ACTIVITY | User's account is disabled for suspicious activity                                          | No     |
| 1 << 36 | SELF_DELETED                 | User deleted their own account                                                              | No     |
| 1 << 37 | PREMIUM_DISCRIMINATOR        | User has a Nitro custom discriminator (obsolete)                                            | No     |
| 1 << 38 | USED_DESKTOP_CLIENT          | User has used the desktop client                                                            | No     |
| 1 << 39 | USED_WEB_CLIENT              | User has used the web client                                                                | No     |
| 1 << 40 | USED_MOBILE_CLIENT           | User has used the mobile client                                                             | No     |
| 1 << 41 | DISABLED                     | User's account is disabled                                                                  | No     |
| 1 << 43 | VERIFIED_EMAIL               | User has a verified email                                                                   | No     |
