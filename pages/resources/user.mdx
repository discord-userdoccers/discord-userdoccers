...
| wishlist_settings? ^1^        | map[snowflake, [wishlist settings](#wishlist-settings-structure) object]                               | A mapping of wishlist IDs to their settings                                   |
