...
| targeted_content | array[unknown]                                         | An unknown array, unused in the client.                                          |
...
| rewards_config                      | Reward Config Object  | Unknown object containing potential Discord rewards?                                     |
...
| colors                              | Quest Gradient Object | An object that contains a primary and secondary hexadecimal color, unused in the client. |
| in_game_quest_config                | ?Unknown              | An object that could hold data that the game could read from.                            |
| assets                              | Quest Assets Object   | Object that holds the quest's assets                                                     |
| video_assets                        | Quest Assets Object   | Object that holds the quest's video assets                                               |
...
| 3     | Switch         | The code can be redeemed on Nintendo Switch |
| 4     | PC             | The code can be redeemed on PC              |

### Quest Messages Object

Represents quest metadata such as quest/reward name, instructions and the game's title and publisher.
...
| reward_name_with_article                   | string        | idk (●'◡'●)                                                             |
...
| dismissed_quest_content   | Unknown Object    | Unused object                                                                                                                   |
...
| hero           | string | The quest's "Hero image", aka, fancy background                                                             |
| quest_bar_hero | string | The "Hero image" used in the quest popup that appears when launching the quest's before accepting the quest |
| game_tile      | string | The game's icon                                                                                             |
| logotype       | string | The game's logotype, aka, it's full logo                                                                    |
...
<RouteHeader method="POST" url="/quests/:questId/enroll">
  Enroll Into A Quest
</RouteHeader>
