...
| flags?        | integer   | the [flags](/resources/user/user-object-user-flags) on a user's account                         | identify              |
| premium_type? | integer   | the [type of Nitro subscription](/resources/user/user-object-premium-types) on a user's account | identify              |
| public_flags? | integer   | the public [flags](/resources/user/user-object-user-flags) on a user's account                  | identify              |
...
| visibility    | integer | [visibility](/resources/user/connection-object-visibility-types) of this connection |
...
Returns the [user](/resources/user/user-object) object of the requester's account. For OAuth2, this requires the `identify` scope, which will return the object _without_ an email, and optionally the `email` scope, which returns the object _with_ an email.

<RouteHeader method="GET" url="/users/{user.id}">
  Get User
</RouteHeader>

Returns a [user](/resources/user/user-object) object for a given user ID.

<RouteHeader method="PATCH" url="/users/@me">
  Modify Current User
</RouteHeader>

Modify the requester's user account settings. Returns a [user](/resources/user/user-object) object on success.
...
Returns a list of [connection](/resources/user/connection-object) objects. Requires the `connections` OAuth2 scope.
