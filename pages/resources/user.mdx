...
Returns a list of suggested application IDs for the current user's profile game widgets.

###### Response Body

| Field          | Type             | Description                        |
| -------------- | ---------------- | ---------------------------------- |
| suggsted_games | array[snowflake] | The suggested game application IDs |
