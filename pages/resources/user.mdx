...
Returns user's identities for certain partner applications.
...
| playtime_hours?                  | float                                                                          | Duration in hours how long the user was playing the game |
...
| user_id? ^1^                     | string                                                                         | The ID of in-game account                                |
...
^1^ Only applicable for "Wuthering Waves" application.
