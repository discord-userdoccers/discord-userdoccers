...
A user's legacy `username#discriminator` will still be usable to [send friend requests](#send-friend-request), and will be available as a [profile badge](#profile-badge-structure) for migrated users.
