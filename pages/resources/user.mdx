...
| widgets ^1^                   | array[[game widget](#game-widget-object) object]                                                              | The user's game widgets                                                       |
...
| Field   | Type                                                         | Description                                            |
| ------- | ------------------------------------------------------------ | ------------------------------------------------------ |
| widgets | array[partial [game widget](#game-widget-object) object] ^1^ |  The user's game widgets (max 1 of each [game widget type](#game-widget-type)) |
