...
<RouteHeader method="GET" url="/users/@me/notification-settings/muted-games">
  Get User Game Notification Settings
</RouteHeader>

Returns a mapping of game application IDs to booleans representing whether the game is muted.

<RouteHeader method="PATCH" url="/users/@me/notification-settings/muted-games/{application.id}">
  Modify User Game Notification Settings
</RouteHeader>

Modifies the notification settings for the given game application ID. Returns the updated mapping of game application IDs to booleans representing whether the game is muted.

###### JSON Params

| Field | Type    | Description               |
| ----- | ------- | ------------------------- |
| muted | boolean | Whether the game is muted |
