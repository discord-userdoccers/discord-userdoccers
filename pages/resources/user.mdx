...
| has_bounced_email?\*   | boolean   | Whether the user's email has failed to deliver and is no longer valid                   |
...
| 1 << 15 | UNDERAGE_DELETED           | User is scheduled for deletion for being under the minimum required age                     | No     |
...
| badges                        | array[[badge](#badge-object)]                                             | The user's profile badges                                                                                              |
...
| guild_badges                  | array[[badge](#badge-object)]                                             | The guild member's guild-specific profile badges                                                                       |
...
| Field            | Type    | Description                                               |
| ---------------- | ------- | --------------------------------------------------------- |
| with_implicit?\* | boolean | Whether to include implicit relationships (default false) |

\* Only usable with OAuth2 requests. On non-OAuth2 requests, only user-created relationships will be returned.
