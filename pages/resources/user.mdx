...
| 1 << 11 | INTERNAL_APPLICATION         | User has a pending partner or bot verification application                                  | No^1^  |
...
| 1 << 37 | PREMIUM_DISCRIMINATOR        | User has a Nitro custom discriminator (obsolete)                                            | No^1^  |
...
^1^ Not exposed to the API, can only be found in data dumps
