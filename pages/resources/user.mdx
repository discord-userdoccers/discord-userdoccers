...
| avatar_description?       | ?string                            | The user's avatar description usually in format "{filename}, added {date}" (max 1024 characters)                                                                          |
...
Returns the user's recent avatars. Only 2 avatars will be returned for users without a Nitro subscription, otherwise 6 recent avatars will be returned.

###### Response Body

| Field   | Type                                        | Description                     |
| ------- | ------------------------------------------- | ------------------------------- |
| avatars | array[[avatars](#avatars-structure) object] | The recent avatars for the user |

###### Avatars Structure

| Field        | Type    | Description                                |
| ------------ | ------- | ------------------------------------------ |
| id           | string  | The avatar IDs                             |
| storage_hash | string  | The hash of the avatar                     |
| description  | ?string | The description when the file was uploaded |
