...
| authenticator_types? ^3^ | array[integer]                                               | The [types of multi-factor authentication](#authenticator-type) the user has enabled                            |
...
| premium_type? ^3^       | integer                                                      | The [type of premium (Nitro) subscription](#premium-type) on a user's account                                   |
| public_flags?           | integer                                                      | The public [flags](#user-flags) on a user's account                                                             |
...
MFA cannot be disabled for for administrators of guilds with published creator monetization listings.
...
<RouteHeader method="POST" url="/users/@me/mfa/sms/enable">
  Enable SMS MFA
</RouteHeader>
...
<RouteHeader method="POST" url="/users/@me/mfa/sms/disable">
  Disable SMS MFA
</RouteHeader>
