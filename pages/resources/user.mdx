...
| collectibles?                   | array[[profile collectible](#profile-collectible-structure) object] | The user's equipped profile collectibles                                                                  |
...
###### Profile Collectible Structure

| Field       | Type               | Description                                                                 |
| ----------- | ------------------ | --------------------------------------------------------------------------- |
| sku_id      | snowflake          | The SKU ID of the profile collectible                                       |
| type        | integer            | The [type of collectible](/resources/collectibles#collectible-product-type) |
| expires_at? | ?ISO8601 timestamp | When the current profile collectible expires                                |
...
| collectibles_sku_ids?           | array[snowflake]                   | The SKU IDs of the profile collectibles to equip; omitted equipped profile collectibles are removed                                     |
