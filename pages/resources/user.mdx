...
| linked_users ^1^ ^3^          | array[[linked user](/resources/family-center#linked-user-structure) object] | The linked users connected to the account via [Family Center](/resources/family-center)                         |
