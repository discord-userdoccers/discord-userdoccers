...
| Field                      | Type                                                     | Description                                                          |
| -------------------------- | -------------------------------------------------------- | -------------------------------------------------------------------- |
| badge_id                   | integer                                                  | The ID of the badge                                                  |
| name                       | string                                                   | The name of the badge                                                |
| description?               | string                                                   | The description of the badge                                         |
| info_label?                | string                                                   | The info label of the badge                                          |
| rarity                     | [badge rarity](#user-badge-rarity)                       | The rarity of the badge                                              |
| simple_icon_url            | string                                                   | A link representing the badge's simple icon                          |
| complex_icon_static_url?   | string                                                   | A link representing the static version of the badge's complex icon   |
| complex_icon_animated_url? | string                                                   | A link representing the animated version of the badge's complex icon |
| is_earnable                | boolean                                                  | Whether the badge is earnable                                        |
| owned                      | boolean                                                  | Whether the user has the badge                                       |
| obtained_at?               | ISO8601 timestamp                                        | Timestamp of when the badge was obtained                             |
| current_tier?              | string                                                   | The current tier of the badge                                        |
| tier_obtained_at?          | map[string, ISO8601 timestamp]                           | Map of tier IDs and when they were obtained                          |
| tiers?                     | array[[badge tier](#user-badge-tier-structure)]          | List of badge tiers                                                  |
| progress?                  | ?array[[badge progress](#user-badge-progress-structure)] | Tier progress for the badge                                          |
...
###### User Badge Tier Structure

| Field                      | Type                                                                    | Description                                                         |
| -------------------------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------- |
| key                        | string                                                                  | The ID of the tier                                                  |
| name                       | string                                                                  | The name of the tier                                                |
| rarity                     | [badge rarity](#user-badge-rarity)                                      | The rarity of the tier                                              |
| simple_icon_url            | string                                                                  | A link representing the tier's simple icon                          |
| complex_icon_static_url?   | string                                                                  | A link representing the static version of the tier's complex icon   |
| complex_icon_animated_url? | string                                                                  | A link representing the animated version of the tier's complex icon |
| requirements               | array[[badge tier requirement](#user-badge-tier-requirement-structure)] | A list of the tier's requirements                                   |

###### User Badge Tier Requirement Structure

| Field         | Type    | Description                      |
| ------------- | ------- | -------------------------------- |
| progress_type | integer | Unknown                          |
| threshold     | integer | The requirement's threshold      |
| unit          | string  | The requirement's threshold unit |

###### User Badge Progress Structure

| Field         | Type    | Description                            |
| ------------- | ------- | -------------------------------------- |
| progress_type | integer | Unknown                                |
| current       | integer | The badge's current progress           |
| threshold     | integer | The threshold of the badge's next tier |
| unit          | string  | The badge's progress unit              |
| window        | integer | Unknown                                |
...
<RouteHeader method="POST" url="/users/@me/meaningfully-online">
...
Returns a list of a user's [badges](#user-badge-structure). When fetching your own badges, this returns all badges, including ones you don't own.
