...
| Field       | Type                                                             | Description                                    |
| ----------- | ---------------------------------------------------------------- | ---------------------------------------------- |
| entitlement | ?[entitlement](/resources/entitlement#entitlement-object) object | The entitlement to which the potions belong to |
...
<RouteHeader method="POST" url="/users/@me/identity/verification">
  Verify User Identity
</RouteHeader>

Returns the status and errors of the user verification and a redirect link to Stripe identity verification.

<Alert type="warn">

This endpoint is deprecated. Applications must now belong to a team to be verified. As such it is replaced by [Verify Team Identity](/resources/team#verify-team-identity).
...
| status       | number    | The current [status of the identity verification](/resources/team#verification-status) |
| last_error   | number    | The [error code of the last verification attempt](/resources/team#verification-error)  |
| redirect_url | string    | The Stripe identity verification URL to redirect the user to                           |

<RouteHeader method="GET" url="/users/@me/identity/verification">
  Get User Verification Status
</RouteHeader>

Returns the status and errors of the user identity verification, without a Stripe identity verification link.
May only be used after initiating a [user identity verification](#verify-user-identity).

<Alert type="warn">

This endpoint is deprecated. Applications must now belong to a team to be verified. As such it is replaced by [Get Team Verification Status](/resources/team#get-team-verification-status).
