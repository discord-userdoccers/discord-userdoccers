...
All parameters to this endpoint are optional as the intended flow is to first use it to generate a `ticket` and `challenge` that can then be used to create the authenticator.
