...
Removes multiple relationships. Returns a 204 empty response on success. Optionally fires multiple [Relationship Remove](/topics/gateway-events#relationship-remove) Gateway events.
