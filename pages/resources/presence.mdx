...
| state?               | ?string                                                      | The user's current party status (max 128 characters)                                  |
...
For OAuth2 requests, this endpoint is locked to the Samsung Game Launcher application ID (`591317049637339146`).
...
| Field          | Type                                       | Description                                                      |
| -------------- | ------------------------------------------ | ---------------------------------------------------------------- |
| activities ^1^ | array[[activity](#activity-object) object] | An array containing the activity to set for the headless session |
