...
| user?           | partial [user](/resources/user#user-object) object          | the user this webhook was created by (not returned when getting a webhook with its token)                |
...
Modifies a webhook. Requires the `MANAGE_WEBHOOKS` permission. Returns the updated [webhook](#webhook-object) object on success.
...
| attachments\*\*  | array of partial [attachment](/resources/message#attachment-object) objects     | attachment objects with filename and description | false                        |
...
| payload_json\*\* | string                                                                          | JSON encoded body of non-file params (multipart/form-data only) |
| attachments\*\*  | array of partial [attachment](/resources/message#attachment-object) objects     | attached files to keep and possible descriptions for new files  |
