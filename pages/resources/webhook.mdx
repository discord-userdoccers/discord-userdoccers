...
| type            | integer                                                     | the [type](#webhook-object-webhook-types) of the webhook                                                 |
...
Create a new webhook. Requires the `MANAGE_WEBHOOKS` permission. Returns a [webhook](#webhook-object) object on success. Webhook names follow our naming restrictions that can be found in our [Usernames and Nicknames](//resources/user#usernames-and-nicknamest) documentation, with the following additional stipulations:
