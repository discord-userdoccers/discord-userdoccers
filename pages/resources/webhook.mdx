...
| type            | integer                                                     | the [type](/resources/webhook/webhook-object-webhook-types) of the webhook                               |
...
Create a new webhook. Requires the `MANAGE_WEBHOOKS` permission. Returns a [webhook](/resources/webhook/webhook-object) object on success. Webhook names follow our naming restrictions that can be found in our [Usernames and Nicknames](/resources/user/usernames-and-nicknames) documentation, with the following additional stipulations:
...
Returns a list of channel [webhook](/resources/webhook/webhook-object) objects. Requires the `MANAGE_WEBHOOKS` permission.

<RouteHeader method="GET" url="/guilds/{guild.id}/webhooks">
  Get Guild Webhooks
</RouteHeader>

Returns a list of guild [webhook](/resources/webhook/webhook-object) objects. Requires the `MANAGE_WEBHOOKS` permission.

<RouteHeader method="GET" url="/webhooks/{webhook.id}">
  Get Webhook
</RouteHeader>

Returns the new [webhook](/resources/webhook/webhook-object) object for the given id.
...
Modify a webhook. Requires the `MANAGE_WEBHOOKS` permission. Returns the updated [webhook](/resources/webhook/webhook-object) object on success.
...
<RouteHeader method="GET" url="/webhooks/{webhook.id}/{webhook.token}/messages/{message.id}">
  Get Webhook Message
</RouteHeader>
...
<RouteHeader method="PATCH" url="/webhooks/{webhook.id}/{webhook.token}/messages/{message.id}">
...
<RouteHeader method="DELETE" url="/webhooks/{webhook.id}/{webhook.token}/messages/{message.id}">
