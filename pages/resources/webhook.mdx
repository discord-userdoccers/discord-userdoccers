...
| source_guild? ^2^   | [webhook guild](#webhook-guild-structure) object     | The guild of the channel that this webhook is following (returned for `CHANNEL_FOLLOWER` webhooks) |
