...
| source_guild? ^2^   | partial [guild](/resources/guild#guild-object) object       | The guild of the channel that this webhook is following (returned for `CHANNEL_FOLLOWER` webhooks) |
| source_channel? ^2^ | partial [channel](/resources/channel#channel-object) object | The channel that this webhook is following (returned for `CHANNEL_FOLLOWER` webhooks)              |
