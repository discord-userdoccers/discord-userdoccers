...
| INTEGRATION_CREATE                          | 80    | App was added to guild                                    | [Integration](/resources/integration#integration-object)                                                      |
| INTEGRATION_UPDATE                          | 81    | App was updated (as an example, its scopes were updated)  | [Integration](/resources/integration#integration-object)                                                      |
| INTEGRATION_DELETE                          | 82    | App was removed from guild                                | [Integration](/resources/integration#integration-object)                                                      |
...
| APPLICATION_COMMAND_PERMISSION_UPDATE       | 121   | Permissions were updated for a command                    | [Command Permission](/interactions/application-commands#application-command-permissions-object) ^1^           |
