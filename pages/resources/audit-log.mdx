...
| INVITE_CREATE                               | 40    | Guild invite was created                                  | [Invite](/resources/invite#invite-object) ^1^                                                                                                 |
| INVITE_UPDATE                               | 41    | Guild invite was updated                                  | [Invite](/resources/invite#invite-object) ^1^                                                                                                 |
| INVITE_DELETE                               | 42    | Guild invite was deleted                                  | [Invite](/resources/invite#invite-object) ^1^                                                                                                 |
...
| [Invite](/resources/invite#invite-object)                                                          | Additional `channel_id` key (instead of object's `channel.id`) |                                                                                                                                                                                                                                                             |
