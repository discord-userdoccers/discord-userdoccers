...
| audit_log_entries | array of [audit log entry](/resources/audit-log/audit-log-entry-object) objects | list of audit log entries                |
...
| changes?    | array of [audit log change](/resources/audit-log/audit-log-change-object) objects                  | changes made to the target_id                         |
| user_id     | ?snowflake                                                                                         | the user who made the changes                         |
| id          | snowflake                                                                                          | id of the entry                                       |
| action_type | [audit log event](/resources/audit-log/audit-log-entry-object-audit-log-events)                    | type of action that occurred                          |
| options?    | [optional audit entry info](/resources/audit-log/audit-log-entry-object-optional-audit-entry-info) | additional info for certain action types              |
...
| Field      | Type                                                                       | Description                                                                                       |
| ---------- | -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| new_value? | [mixed](/resources/audit-log/audit-log-change-object-audit-log-change-key) | new value of the key                                                                              |
| old_value? | [mixed](/resources/audit-log/audit-log-change-object-audit-log-change-key) | old value of the key                                                                              |
| key        | string                                                                     | name of audit log [change key](/resources/audit-log/audit-log-change-object-audit-log-change-key) |
...
| topic                         | [channel](/resources/channel/channel-object) or [stage instance](/resources/stage_instance/stage-instance-object) | string                                                                          | text channel topic or stage instance topic changed                                                                                                 |
...
| privacy_level                 | [stage instance](/resources/stage_instance/stage-instance-object)                                                 | integer ([privacy level](/resources/stage_instance/privacy-level))              | privacy level of the stage instance changed                                                                                                        |
...
Returns an [audit log](/resources/audit-log/audit-log-object) object for the guild. Requires the 'VIEW_AUDIT_LOG' permission.
...
| action_type | integer   | the type of [audit log event](/resources/audit-log/audit-log-entry-object-audit-log-events) |
