...
| GUILD_PROFILE_UPDATE                        | 211     | Guild profile was updated                                 | [Guild Profile](/resources/guild#guild-profile-object) ^1^                                                      |
...
| [Guild Profile](/resources/guild#guild-profile-object)                                                         | Additional `server_tag` key (instead of object's `tag`)                                                                                           |                                                                                                                                                                                                                                                             |
