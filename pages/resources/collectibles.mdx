...
| name_localizations?    | ?map[string, string]                                                                       | The localized names of the collectible product                                                               |
...
| summary_localizations? | ?map[string, string]                                                                       | The localized descriptions of the collectible product                                                        |
...
^1^ Only included when `variant_return_style` is set to `VARIANTS_GROUP`, otherwise each variant will be returned as a separate product.
...
| --------------- | ------------------------------------------------------------------------------- | --------------------------------------------------- |
| categories      | array[[collectible category](#collectible-category-structure) object]           | The list of collectible categories                  |
| shop_blocks     | array[[shop block](#shop-block-object) object]                                  | The list of shop blocks                             |
| user_discounts? | array[[collectible user discount](#collectible-user-discount-structure) object] | The list of user discounts the user is eligible for |
...
<RouteHeader method="GET" url="/user-profile-effects" unauthenticated>
