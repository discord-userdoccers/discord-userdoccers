...
| layers               | array[[profile frame layer](#profile-frame-layer-structure) object] | The layers of the profile frame                      |
| inner_width?         | integer                                                             | The inner width used to position the profile frame   |
...
| Field       | Type    | Description                                                   |
| ----------- | ------- | ------------------------------------------------------------- |
| id          | string  | The ID of the profile frame layer asset                       |
| type        | string  | The [profile frame layer type](#profile-frame-layer-type)     |
| order       | string  | The [profile frame layer order](#profile-frame-layer-order)   |
| anchor?     | string  | The [profile frame layer anchor](#profile-frame-layer-anchor) |
| responsive? | boolean | Whether the profile frame layer is responsive                 |

###### Profile Frame Layer Type

| Value  | Description    |
| ------ | -------------- |
| staple | A staple layer |
| rail   | A rail layer   |
| border | A border layer |

###### Profile Frame Layer Order

| Value | Description                               |
| ----- | ----------------------------------------- |
| front | Rendered in front of the profile contents |
| back  | Rendered behind the profile contents      |

###### Profile Frame Layer Anchor
...
### Collectibles Shop Tab Layout Object

###### Collectibles Shop Tab Layout Structure

| Field     | Type   | Description                     |
| --------- | ------ | ------------------------------- |
| layout_id | string | The ID of the shop tab's layout |
...
<RouteHeader method="GET" url="/collectibles-shop-tab-layouts/{tab}">
  Get Collectibles Shop Tab Layout
</RouteHeader>

Returns the [shop tab layout](#collectibles-shop-tab-layout-object) for the given [shop tab](#collectibles-shop-home-tab).
