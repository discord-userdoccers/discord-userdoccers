...
Verifies an Application and allows it to scale past 100 servers.

<Alert type="note">

Requires no request body and responds with 204 No Content, unless the application is ineligible to be verified or the user is not the owner of the team in which case 400 Bad Request with an error code is returned.
