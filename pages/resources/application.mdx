...
| event_webhooks_types?                        | array[string]                                                                                                         | The enabled [event webhook types](#event-webhooks-type) to send to the event webhooks endpoint (min 1)                                                                                                                           |
...
| 1 << 7      | GAME_PROFILE_DISABLED                  | This application has its game profile page disabled                                                                                                        | Yes     |
| 1 << 8      | PUBLIC_OAUTH2_CLIENT                   | This application's OAuth2 credentials are public                                                                                                           | Yes     |
