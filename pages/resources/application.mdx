...
<RouteHeader method="GET" url="/applications/{application.id}/verification">
...
This endpoint is deprecated. Applications now verify using the [automated verification process](#automatically-verify-application).

</Alert>

<RouteHeader method="POST" url="/applications/{application.id}/verification">
...
This endpoint was removed. Applications now verify using the [automated verification process](#automatically-verify-application).
...
Verifies an application and allows it to scale past 100 servers. Returns an empty 204 response on success.
The application must meet the verification criteria.
