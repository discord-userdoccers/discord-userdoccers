...
| 2 | SOCIAL_SDK_APP_DELETION_ERROR | Unknown |
...
Enables social SDK features for the given application, applying the [`SOCIAL_LAYER_INTEGRATION_LIMITED` application
flag](#application-flags). Returns a 204 empty response on success.
