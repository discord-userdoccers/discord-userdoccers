...
### Application OAuth Asset Object

###### Application OAuth Asset Structure
...
###### Example Application OAuth Asset
...
| metadata   | [application asset v2 metadata](#application-asset-metadata-object) object | The metadata for the asset                                   |
...
<RouteHeader method="POST" url="/oauth2/applications/{application.id}/assets">
  Create OAuth Application Asset
</RouteHeader>
...
<RouteHeader method="DELETE" url="/oauth2/applications/{application.id}/assets/{oauth_application_asset.id}">
  Delete OAuth Application Asset
</RouteHeader>
...
<RouteHeader method="GET" url="/applications/{application.id}/assets" supportsBot>
  Get Application Assets
</RouteHeader>

Returns a list of [application assets](#application-asset-object) for the given application ID.

<RouteHeader method="POST" url="/applications/{application.id}/assets/upload" supportsBot>
  Upload Application Asset
</RouteHeader>
Creates attachment URLs to upload the intended attachments directly to Discord's GCP storage bucket. Returns an array of
[cloud attachment](/resources/message#cloud-attachment-structure) objects. See [Uploading to Google
Cloud](/reference#uploading-to-google-cloud) for more information.
...
<RouteHeader method="POST" url="/applications/{application.id}/assets" supportsBot>
...
<RouteHeader method="PATCH" url="/applications/{application.id}/{application_asset.key}" supportsBot>
  Update Application Asset
</RouteHeader>

Updates an application asset. Returns the updated [application asset](#application-asset-object) on success.
...
<RouteHeader method="DELETE" url="/applications/{application.id}/{application_asset.key}" supportsBot>
  Delete Application Asset
</RouteHeader>

Deletes an application asset. Returns a 204 empty response on success.
