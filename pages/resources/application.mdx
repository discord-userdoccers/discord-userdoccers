...
^2^ Only present when fetched from the [Get Guild Applications](#get-guild-applications) endpoint. You must own the application or be a member of the owning team to receive this information.
...
| 1 << 7  | SAFE_SHORT_DESCRIPTION      | This application's directory short description is safe for work                                                                                                           |
| 1 << 8  | SAFE_ROLE_CONNECTIONS       | This application's role connections metadata is safe for work                                                                                                             |
| 1 << 9  | USER_IS_TEAM_OWNER          | The user is the owner of the team that owns the application                                                                                                               |
| 1 << 10 | NOT_QUARANTINED             | This application is not quarantined                                                                                                                                       |
| 1 << 11 | USER_LOCALE_SUPPORTED       | The user's locale is supported by monetization                                                                                                                            |
| 1 << 12 | USER_AGE_SUPPORTED          | The user is old enough to use monetization                                                                                                                                |
...
| 1 << 18 | ELIGIBLE                    | This application has met all the above criteria and is eligible for monetization                                                                                          |
...
| -------------- | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| name           | string                             | The name of the application                                                                                                                                                              |
| type?          | integer                            | The [type of the application](/resources/application#application-type) (only `CREATOR_MONETIZATION` is supported)                                                                        |
...
Returns the [application proxy config](#application-proxy-config-object) object for the given application ID. User must be the owner of the application or member of the current team.
