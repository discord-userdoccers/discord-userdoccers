...
| monetization_state                           | integer                                                                 | The current [creator monetization state](#monetization-state) of the application                                                                                                     |
| monetization_eligibility_flags               | integer                                                                 | The current [creator monetization eligibility flags](#monetization-eligibility-flags) for the application                                                                            |
