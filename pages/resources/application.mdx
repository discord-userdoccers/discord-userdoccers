...
| application_id    | snowflake                                                   | The ID of the application                      |
| claim_status      | string                                                      | The [status of game claim](#game-claim-status) |
...
| Value                                             | Name                                        | Description                                             |
| ------------------------------------------------- | ------------------------------------------- | ------------------------------------------------------- |
| not_started                                       | NOT_STARTED                                 | Game claim is not started                               |
| ready_to_process                                  | READY_TO_PROCESS                            | Game claim is ready to process                          |
| fetching_official_guild                           | FETCHING_OFFICIAL_GUILD                     | Official guild is being fetched                         |
| has_fetched_official_guild                        | HAS_FETCHED_OFFICIAL_GUILD                  | Official guild is fetched                               |
| awaiting_verification_code                        | AWAITING_VERIFICATION_CODE                  | Awaiting verification code                              |
| verification_passed                               | VERIFICATION_PASSED                         | Verification was passed                                 |
| claim_approved                                    | CLAIM_APPROVED                              | Game claim was approved                                 |
| claim_rejected                                    | CLAIM_REJECTED                              | Game claim was rejected                                 |
| claim_revoked                                     | CLAIM_REVOKED                               | Game claim was revoked                                  |
| failed_no_game                                    | FAILED_NO_GAME                              | The game was found                                      |
| failed_no_application                             | FAILED_NO_APPLICATION                       | The application was found                               |
| failed_no_team                                    | FAILED_NO_TEAM                              | The team was found                                      |
| failed_to_fetch_official_guild_from_third_parties | FAILED_TO_FETCH_OFFICIAL_GUILD              | Failed to fetch official guild                          |
| failed_no_official_guild_found                    | FAILED_NO_OFFICIAL_GUILD_FOUND              | Official guild was not found                            |
| failed_multiple_official_guilds_found             | FAILED_MULTIPLE_OFFICIAL_GUILDS_FOUND       | Multiple official guilds were found                     |
| failed_invite_proof_missing                       | FAILED_INVITE_PROOF_MISSING                 | Invite proof is missing                                 |
| failed_invite_proof_invalid                       | FAILED_INVITE_PROOF_INVALID                 | Invite proof is invalid                                 |
| failed_official_guild_owner_not_found             | FAILED_OFFICIAL_GUILD_OWNER_NOT_FOUND       | Owner of official guild owner is not found              |
| failed_official_guild_owner_not_on_team           | FAILED_OFFICIAL_GUILD_OWNER_NOT_ON_TEAM     | Owner of official guild owner is not on team            |
| failed_official_guild_owner_mfa_not_enabled       | FAILED_OFFICIAL_GUILD_OWNER_MFA_NOT_ENABLED | Owner of official guild owner does not have MFA enabled |
| failed_verification_code_sent_too_recently        | FAILED_VERIFICATION_CODE_SENT_TOO_RECENTLY  | Verification code was sent too recently                 |
| failed_verification_code_not_sent                 | FAILED_VERIFICATION_CODE_NOT_SENT           | Verification code was not sent                          |
| failed_verification_code_invalid                  | FAILED_VERIFICATION_CODE_INVALID            | Verification code is invalid                            |
| failed_unknown                                    | FAILED_UNKNOWN                              | Unknown                                                 |
...
<RouteHeader method="GET" url="/applications/detectable" deprecated unauthenticated>
  Get Detectable Applications
</RouteHeader>

Returns a list of [detectable application](#detectable-application-object) objects representing games that can be detected by Discord for rich presence.

<RouteHeader method="GET" url="/applications/non-games/detectable" unauthenticated>
  Get Detectable Non Game Applications
</RouteHeader>

Returns a list of [detectable application](#detectable-application-object) objects representing non-games that can be detected by Discord for rich presence.
...
Returns a list of [game clain](#game-claim-object) objects for the given application ID.

<RouteHeader method="GET" url="/applications/{application.id}/game-claims/{game.id}">
  Get Application Game Claim
</RouteHeader>

Returns a [game claim](#game-claim-object) object for the given application ID.

<RouteHeader method="PUT" url="/applications/{application.id}/game-claims/{game.id}">
  Create Application Game Claim
</RouteHeader>

Creates a game claim for the given application ID. Returns a [game claim](#game-claim-object) object on success. May fire an [Guild Official Game Applications Update](/gateway/gateway-events#guild-official-game-applications-update) Gateway event.
...
| resend_verification_code? | boolean | Whether to resend verification code (default false)        |
| full_name?                | string  | The full legal name (max 100 characters)                   |
| business_email?           | string  | The business email (max 320 characters)                    |
| business_role?            | string  | The business role of the current user (max 100 characters) |
| business_website?         | string  | The business website (max 256 characters)                  |

<RouteHeader method="PATCH" url="/applications/{application.id}/game-claims/{game.id}">
...
<RouteHeader method="DELETE" url="/applications/{application.id}/game-claims/{game.id}">
