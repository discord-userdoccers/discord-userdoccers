...
| monetization_eligibility_flags               | integer                                                                 | The current [application monetization eligibility flags](#application-monetization-eligibility-flags) for the application                                                            |
...
^5^ Only applicable for applications of type `GUILD_ROLE_SUBSCRIPTION`.
