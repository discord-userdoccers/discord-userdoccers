...
containing the full set of flag bits. Existing integrations consuming `flags` are not impacted. `flags_new` is for response serialization only — requests that accept flag values should
