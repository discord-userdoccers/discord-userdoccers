...
<RouteHeader method="GET" url="/applications/{application.id}/managed-links/">
  Get Application Activity Managed Links
</RouteHeader>

Returns a list of [activity link](#activity-link-structure) objects for the given application ID.
...
^1^ The link ID is `1-1385208877569802300` the first part is the type of activity link, 0 - managed link, 1 - quick link, when fetching an activity link the type must be omitted.
...
<RouteHeader method="POST" url="/applications/{application.id}/managed-links/">
  Create Application Activity Managed Link
</RouteHeader>

Creates a new activity managed link. Returns an [activity link](#activity-link-structure) object on success.
...
<RouteHeader method="GET" url="/applications/{application.id}/managed-links/{link_id}">
  Get Application Activity Managed Link
</RouteHeader>

Returns the specified [activity link](#activity-link-structure).

<RouteHeader method="PATCH" url="/applications/{application.id}/managed-links/{link_id}">
  Update Application Activity Managed Link
</RouteHeader>

Updates the specified [activity link](#activity-link-structure) for the given application ID.

<RouteHeader method="DELETE" url="/applications/{application.id}/managed-links/{link_id}">
  Delete Application Activity Managed Link
</RouteHeader>

Deletes the specified [activity link](#activity-link-structure) for the given application ID.

<RouteHeader method="POST" url="/applications/{application.id}/quick-links/">
  Create Application Activity Quick Link
</RouteHeader>

Creates a new activity quick link. Returns an [activity link](#activity-link-structure) object on success.
...
<RouteHeader method="GET" url="/applications/{application.id}/quick-links/{link_id}" unauthenticated>
  Get Application Activity Quick Link
</RouteHeader>
