...
Creates attachment URLs to upload the intended attachments directly to Discord's GCP storage bucket. Returns an array of [cloud attachment](/reference#cloud-attachment-object) objects. See [Uploading to Google Cloud](/reference#uploading-to-google-cloud) for more information.
