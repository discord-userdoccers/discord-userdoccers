...
<RouteHeader method="GET" url="/applications/{application.id}/users/{user.id}/identities/{external_user_id}/profile" supportsBot>
...
<RouteHeader method="PATCH" url="/applications/{application.id}/users/{user.id}/identities/{external_user_id}/profile" supportsBot>
