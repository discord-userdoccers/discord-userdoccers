...
Replaces the proxy config for the given application ID. User must be the owner of the application or developer of the current team. Returns the updated [application proxy config](#application-proxy-config-object) object on success.
...
Creates a new application asset for the given application ID. User must be the owner of the application or developer of the current team. Returns an [application asset](/resources/application#application-asset-object) object on success.
