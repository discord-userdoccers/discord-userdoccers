...
<RouteHeader
  method="GET"
  url="/applications/{application.id}/activity-instances/{activity_instance.composite_instance_id}"
>
...
<RouteHeader method="DELETE" url="/oauth2/applications/{application.id}/assets/{application_asset.id}">
...
<RouteHeader method="GET" url="/applications/{application.id}/managed-links/{activity_link.id}">
  Get Application Managed Link
</RouteHeader>

Returns an [activity link](#activity-link-object) object for the given ID.

<RouteHeader method="PATCH" url="/applications/{application.id}/managed-links/{activity_link.id}">
...
<RouteHeader method="DELETE" url="/applications/{application.id}/managed-links/{activity_link.id}">
...
<RouteHeader method="GET" url="/applications/{application.id}/quick-links/{activity_link.id}" unauthenticated>
...
<RouteHeader method="GET" url="/social-sdk/releases/{sdk_release.version}">
