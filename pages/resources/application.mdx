...
^2^ Only present when fetched from the [Get Guild Applications](#get-guild-applicaitons) endpoint. You must be a member of the team to receive this information.
...
| premium_tier_requirement              | ?integer                                                                                           | The minimum [guild premium tier](/resources/guild#premium-tier) required to use the activity, if any             |
| free_period_starts_at?                | ?ISO8601 timestamp                                                                                 | When the current free period for the activity starts, if any                                                     |
| free_period_ends_at?                  | ?ISO8601 timestamp                                                                                 | When the current free period for the activity ends, if any                                                       |
...
Transfers ownership of an application to a [team](/resources/team). You must be the owner of the application or current team. Returns an [application](#application-object) object on success.
