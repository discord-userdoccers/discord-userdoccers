...
| Field     | Type    | Description                                                |
| --------- | ------- | ---------------------------------------------------------- |
| type      | integer | [Type](#application-directory-carousel-item-type) of media |
...
Returns a list of [categories](#application-directory-category-structure) objects representing the available application categories.
...
Returns a list of the available application directory [collections](#application-directory-collection).
...
###### Application Directory Collection
...
| flags                                  | integer                                                         | The application [flags](#application-directory-/resources/application#application-flags) |
...
| Field              | Type                                                       | Description                                                      |
| ------------------ | ---------------------------------------------------------- | ---------------------------------------------------------------- |
| results            | [results](#application-directory-results-structure) object | The results of the search                                        |
