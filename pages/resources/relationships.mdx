...
Adds multiple relationships from [contact sync](/resources/connected-accounts#sync-contacts). May fire multiple [Relationship Add](/topics/gateway-events#relationship-add) Gateway events.
...
| token    | string           | [Contact sync](/resources/connected-accounts#sync-contacts) bulk add token |
