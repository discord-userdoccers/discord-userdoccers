...
Adds multiple relationships from [contact sync](/resources/connected-accounts#create-contact-sync-connection). May fire multiple [Relationship Add](/topics/gateway-events#relationship-add) Gateway events.
...
| token    | string           | [Contact sync](/resources/connected-accounts#create-contact-sync-connection) bulk add token |

###### Response Body

| Field               | Type             | Description                                       |
| ------------------- | ---------------- | ------------------------------------------------- |
| failed_requests     | array[snowflake] | IDs of users that failed to create a relationship |
| successful_requests | array[snowflake] | IDs of users that created a relationship          |
