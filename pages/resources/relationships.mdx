...
| has_played_game? ^1^   | boolean                                     | Whether the target user have authorized the application the Gateway session is associated with                               |

^1^ Only provided in OAuth2 contexts.
