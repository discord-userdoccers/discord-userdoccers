...
| note                   | ?string                                     | The personalized note the user wrote when sending the friend request                                                         |
...
| note              | ?string | A personalized note to send with the friend request. Will be sent to the user as a DM. |
