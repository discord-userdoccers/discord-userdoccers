...
| platform | string  | The [platform that the suggestion originated from](/resources/connections#connection-type) |
...
For OAuth2 requests, only relationships of type `FRIEND` (and optionally `IMPLICIT`) are returned.
