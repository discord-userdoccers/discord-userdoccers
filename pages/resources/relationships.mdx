...
| note                   | ?string                                     | The personalised note the user wrote when sending the friend request                                                         |
...
| note              | ?string | A personalised note to send with the friend request. Will be sent to the user as a DM. |
