...
| Value | Name    | Description                    |
| ----- | ------- | ------------------------------ |
| 1     | SPAM    | Remove flagged friend requests |
| 2     | IGNORED | Unknown                        |
...
| Field    | Type           | Description                                                                                                       |
| -------- | -------------- | ----------------------------------------------------------------------------------------------------------------- |
| filters? | array[integer] | The [relationship removal criterias](#relationship-removal-filter) to match against relationships using AND logic |
