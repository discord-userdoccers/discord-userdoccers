...
^1^ Only included in lobby objects returned [over the Gateway](/topics/gateway-events#lobbies).
...
| Field                 | Type                 | Description                                                                                |
| --------------------- | -------------------- | ------------------------------------------------------------------------------------------ |
| secret                | string               | The lobby secret (max 250 characters)                                                      |
...
Posts a message to a lobby. Returns a partial lobby [message](/resources/message#partial-message-object) object on success. Fires a [Lobby Message Create](/topics/gateway-events#lobby-message-create) and [Message Create](/topics/gateway-events#message-create) Gateway event.
