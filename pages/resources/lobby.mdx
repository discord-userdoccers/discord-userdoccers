...
Represents a game lobby within Discord.
...
If the user is already a member of the lobby, this will replace the provided fields and fire a [Lobby Member Update](/topics/gateway-events#lobby-member-update) Gateway event instead.
