...
If the user is already a member of the lobby, this will modify the provided fields and fire a [Lobby Member Update](/topics/gateway-events#lobby-member-update) Gateway event instead.
