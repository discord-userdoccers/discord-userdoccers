...
Posts a message to a lobby. Returns a [partial message](/resources/message#partial-message-object) object on success. Fires a [Lobby Message Create](/topics/gateway-events#lobby-message-create) and [Message Create](/topics/gateway-events#message-create) Gateway event.
