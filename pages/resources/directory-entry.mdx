...
<RouteHeader method="GET" url="/channels/{channel.id}/directory-entry/{entity.id}">
  Get Directory Entry
</RouteHeader>
...
<RouteHeader method="POST" url="/channels/{channel.id}/directory-entry/{entity.id}">
...
<RouteHeader method="PATCH" url="/channels/{channel.id}/directory-entry/{entity.id}">
...
<RouteHeader method="DELETE" url="/channels/{channel.id}/directory-entry/{entity.id}">
