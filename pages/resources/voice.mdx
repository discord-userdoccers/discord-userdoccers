...
| vip? **(deprecated)** | boolean | Whether this is a VIP-only server                                    |
...
Returns an array of [voice region](#voice-region-object) objects that can be set for a voice channel.
