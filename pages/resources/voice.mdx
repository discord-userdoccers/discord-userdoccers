...
This structure is a superset of [voice state](#voice-state-object) object above, with the following additional fields.

###### Lobby Voice State Structure Extra Fields
