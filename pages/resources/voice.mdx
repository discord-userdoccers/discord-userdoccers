...
### Lobby Voice State Object

This structure is superset of [voice state](#voice-state-object) object above, with additional fields.

###### Lobby Voice State Structure

| Field      | Type       | Description                                   |
| ---------- | ---------- | --------------------------------------------- |
| channel_id | ?snowflake | The ID of the lobby this user is connected to |
...
###### Example Lobby Voice State

```json
{
  "user_id": "1073325901825187841",
  "suppress": false,
  "session_id": "7299874aa588e30b07c3e73473dcd952",
  "self_video": false,
  "self_mute": false,
  "self_deaf": False,
  "request_to_speak_timestamp": null,
  "mute": false,
  "lobby_id": "1350184413060661332",
  "deaf": false,
  "channel_id": "1350184413060661332"
}
```
...
| Field   | Type                                                                 | Description                                                |
| ------- | -------------------------------------------------------------------- | ---------------------------------------------------------- |
| models? | map[str, [voice filter model](#voice-filter-model-structure) object] | The ONNX machine learning models used by the voice filters |
| voices? | array[voice filter](#voice-filter-structure)                         | The voice filters available to the client                  |
