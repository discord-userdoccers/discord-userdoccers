...
<RouteHeader method="POST" url="/guilds/{guild.id}/emojis" supportsXAuditLogHeader>
  Create Guild Emoji
</RouteHeader>
...
<RouteHeader method="PATCH" url="/guilds/{guild.id}/emojis/{emoji.id}" supportsXAuditLogHeader>
  Modify Guild Emoji
</RouteHeader>
...
<RouteHeader method="DELETE" url="/guilds/{guild.id}/emojis/{emoji.id}" supportsXAuditLogHeader>
  Delete Guild Emoji
</RouteHeader>
