...
<RouteHeader method="GET" url="/guilds/templates/{template.code}">
  Get Guild Template
</RouteHeader>

Returns a [guild template](/resources/guild_template/guild-template-object) object for the given code.
...
Returns an array of [guild template](/resources/guild_template/guild-template-object) objects. Requires the `MANAGE_GUILD` permission.

<RouteHeader method="POST" url="/guilds/{guild.id}/templates">
  Create Guild Template
</RouteHeader>

Creates a template for the guild. Requires the `MANAGE_GUILD` permission. Returns the created [guild template](/resources/guild_template/guild-template-object) object on success.
...
Syncs the template to the guild's current state. Requires the `MANAGE_GUILD` permission. Returns the [guild template](/resources/guild_template/guild-template-object) object on success.

<RouteHeader method="PATCH" url="/guilds/{guild.id}/templates/{template.code}">
  Modify Guild Template
</RouteHeader>

Modifies the template's metadata. Requires the `MANAGE_GUILD` permission. Returns the [guild template](/resources/guild_template/guild-template-object) object on success.
...
Deletes the template. Requires the `MANAGE_GUILD` permission. Returns the deleted [guild template](/resources/guild_template/guild-template-object) object on success.
