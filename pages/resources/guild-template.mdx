...
Create a new guild based on a template. Returns a [guild](/docs/resources/guild/guild-object) object on success. Fires a [Guild Create](/docs/topics/gateway/guild-create) Gateway event.
