...
Used to represent a premium referral.
...
| trial_id              | snowflake                                                   | The billing trial id                                                                                     |
| subscription_trial    | billing subscription trial (todo)                           | The billing subscription for the the referral                                                            |
| expires_at            | ISO8601 timestamp                                           | The expiry date of the referral link                                                                     |
| referrer_id           | snowflake                                                   | The user who created the referral                                                                        |


### Premium Referral Eligibility Object

Used to represent a user's premium referral eligibility.

###### Premium Referral Eligibility Structure
| Field                 | Type                                                        | Description                                                                                              |
| --------------------- | ----------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| referrals_remaining   | number                                                      | Amount of referrals you have remaining                                                                   |
| sent_user_ids         | array of user ids                                           | Users you have sent a referral to                                                                        |
