...
Stickers have a maximum file size of 500 KiB (1.5 MiB for emnployees). Attempting to upload a sticker larger than this limit will fail with 400 Bad Request.
