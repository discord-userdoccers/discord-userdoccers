...
Returns an [expression guild](#DOCS_RESOURCES_GUILD/guild-object) object for the guild that owns the given sticker. This endpoint requires the guild to be discoverable and have emoji/sticker discoverability enabled.
