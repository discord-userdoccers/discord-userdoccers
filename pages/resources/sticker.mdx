...
| type        | integer                                    | [type of sticker](#sticker-object-sticker-types)                                                                                                                     |
| format_type | integer                                    | [type of sticker format](#sticker-object-sticker-format-types)                                                                                                       |
...
<RouteHeader method="POST" url="/guilds/{guild.id}/stickers" supportsXAuditLogHeader>
...
<RouteHeader method="PATCH" url="/guilds/{guild.id}/stickers/{sticker.id}" supportsXAuditLogHeader>
...
<RouteHeader method="DELETE" url="/guilds/{guild.id}/stickers/{sticker.id}" supportsXAuditLogHeader>
