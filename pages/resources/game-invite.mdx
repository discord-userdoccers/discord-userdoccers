...
Game Invites allows users to invite their friends to play from their console.
...
<RouteHeader method="POST" url="/game-invite/@me" supportsOAuth2="activities.read">
  Create Game Invite
</RouteHeader>

Creates a game invite.
...
Deletes a game invite. Returns a 204 empty response on success. Fires a [Game Invite Delete](#game-invite-delete) Gateway event.

<RouteHeader method="DELETE" url="/game-invite/@me">
  Delete Game Invites
</RouteHeader>

Deletes all game invites for the current user. Returns a 204 empty response on success. Fires a [Game Invite Delete Many](#game-invite-delete-many) Gateway event.
