...
| connected_account_id   | snowflake | The ID of the [connection](/resources/connections#connection-object) the console account is linked to |
| connected_account_type | string    | The type of [connection](/resources/connections#connection-object) the console account is linked to   |
