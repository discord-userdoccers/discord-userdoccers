...
Returns a [quest claimed reward](#quest-claimed-reward-object) object on success. Fires a [Quests User Status Update](/topics/gateway-events#quests-user-status-update) Gateway event.
