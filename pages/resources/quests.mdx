...
Represents metadata about a Discord reward, like it's name and an article variant of its name
...
Claims the quest's reward and sets both the `completed_at` and `claimed_at` fields of the [User Status Object](#quest-user-status-object) to the current timestamp.
...
| Field      | Type   | Description                                                                                                                                                   |
| ---------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| stream_key | string | A string that is a combination of the guild id, the voice channel id and the user's id. ex. `guild:169256939211980800:1050497861969793164:222069018507345921` |
