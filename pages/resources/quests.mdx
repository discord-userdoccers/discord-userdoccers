...
| Field             | Type                                                               | Description                                                          |
| ----------------- | ------------------------------------------------------------------ | -------------------------------------------------------------------- |
| assignment_method | integer (todo)                                                     | Unknown integer that controls something related to reward assignment |
| rewards           | array[[quest discord reward object](#quest-discord-reward-object)] | Unknown integer that controls something related to reward assignment |
...
### Quest Discord Reward Object

Represents a quest's Discord item reward, such as avatar decorations.

###### Quest Discord Reward Config Structure

| Field    | Type                                                                          | Description                                                                              |
| -------- | ----------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| sku_id   | snowflake                                                                     | Snowflake that specifies the store item to award upon the quest's completion.            |
| tag      | integer                                                                       | Unknown integer (todo)                                                                   |
| messages | [quest discord reward messages object](#quest-discord-reward-messages-object) | Defines quest metadata like it's human-readable name and an article version of the name. |
...
### Quest Discord Reward Messages Object
...
Sends a heartbeat request to the server, used to keep track of however long the stream was running for. Returns a [quest user status object.](#quest-user-status-object)
