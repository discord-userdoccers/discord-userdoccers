...
| Field             | Type                                                  | Description                                                                                             |
| ----------------- | ----------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| assignment_method | integer                                               | [An enum that determines which method gets used to assign the rewards](#quest-reward-assignment-method) |
...
| Field                 | Type                                                             | Description                                                 |
| --------------------- | ---------------------------------------------------------------- | ----------------------------------------------------------- |
| sku_id                | snowflake                                                        | The reward's ID                                             |
...
^1^ If the amount of users who claimed the wards exceeds this count, then all future claimers will be assigned the tier 1 reward, aka, the reward that is usually located below the reward with a specified `approximate_count`
...
Specifies the areas where the quest can be shown.
