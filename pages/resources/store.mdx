...
<RouteHeader method="GET" url="/applications/{application.id}/skus" supportsOAuth2="applications.store.update">
...
<RouteHeader method="POST" url="/store/skus" supportsOAuth2="applications.store.update">
  Create SKU
</RouteHeader>
...
<RouteHeader method="GET" url="/store/skus/{sku.id}" supportsOAuth2="applications.store.update">
  Get SKU
</RouteHeader>
...
<RouteHeader method="PATCH" url="/store/skus/{sku.id}" supportsOAuth2="applications.store.update">
  Modify SKU
</RouteHeader>
...
<RouteHeader method="GET" url="/store/skus/{sku.id}/listings" supportsOAuth2="applications.store.update">
...
<RouteHeader method="POST" url="/store/listings" supportsOAuth2="applications.store.update">
...
<RouteHeader method="GET" url="/store/listings/{listing.id}" supportsOAuth2="applications.store.update">
  Get Store Listing
</RouteHeader>
...
<RouteHeader method="PATCH" url="/store/listings/{listing.id}" supportsOAuth2="applications.store.update">
...
<RouteHeader method="DELETE" url="/store/listings/{listing.id}" supportsOAuth2="applications.store.update">
...
<RouteHeader method="GET" url="/store/skus/{sku.id}/plans" supportsOAuth2="applications.store.update">
...
<RouteHeader method="GET" url="/store/skus/subscription-plans" supportsOAuth2="applications.store.update">
...
<RouteHeader method="GET" url="/store/applications/{application.id}/assets" supportsOAuth2="applications.store.update">
...
<RouteHeader method="POST" url="/store/applications/{application.id}/assets" supportsOAuth2="applications.store.update">
...
<RouteHeader method="DELETE" url="/store/applications/{application.id}/assets/{asset.id}" supportsOAuth2="applications.store.update">
