...
| Field                | Type    | Description                                                                             |
| -------------------- | ------- | --------------------------------------------------------------------------------------- |
| with_google_sku_ids? | boolean | Whether to include Google Play SKU ID mapping (default false)                           |
| country_code?        | string  | The [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country code |
| payment_gateway?     | integer | The [payment gateway](#payment-gateway) (only `APPLE` is allowed)                       |
...
<RouteHeader method="POST" url="/partner-sdk/guilds/{guild.id}/application-storefront/skus/{sku.id}/eligibility" deprecated>
  Check Social Layer SKU Purchase Eligibility By Application Guild
</RouteHeader>
