...
| storefront_pricing?        | [storefront pricing](#storefront-pricing-object) object                 | The storefront pricing                         |
...
| reward_result_id_map  | map[snowflake, map[integer, [storefront discount](#storefront-discount-structure) object]]             | A mapping of reward result IDs to mapping of [storefront purchase type](#storefront-purchase-type) to discounts                   |
...
###### Storefront Discount Structure

| Field  | Type    | Description                                          |
| ------ | ------- | ---------------------------------------------------- |
| type   | integer | The [type of the discount](#storefront-disount-type) |
| amount | integer | ?                                                    |
...
| Value | Name          | Description                                |
| ----- | ------------- | ------------------------------------------ |
| 0     | SELF_PURCHASE | The user is purchasing item for themselves |
| 1     | GIFT          | The user is purchasing item as gift        |
...
| ----- | --------------------- | --------------------- |
| 0     | BASE                  | Base                  |
| 1     | PREMIUM_TIER_0        | Nitro Classic         |
| 2     | PREMIUM_TIER_1        | Nitro                 |
| 3     | PREMIUM_TIER_2        | Nitro Basic           |
| 4     | MOBILE                | Nitro on mobile       |
| 5     | MOBILE_PREMIUM_TIER_2 | Nitro Basic on mobile |
| 6     | GIFT                  | Gift                  |
...
| Value | Name       | Description                                |
| ----- | ---------- | ------------------------------------------ |
| 0     | NORMAL     | The user is purchasing item for themselves |
| 1     | DISCOUNTED | The user is purchasing item as gift        |

###### Storefront Discount Type
...
<RouteHeader method="POST" url="/partner-sdk/guilds/{guild.id}/application-storefront/skus/{sku.id}/eligibility">
...
| collectibles_shop_navigation_enabled | boolean       | Whether the navigation is disabled in game collectible shop                                                          |
...
| disable_mobile_account_linking       | boolean       | Whether the account linking is disabled on mobile                                                                    |
