...
Creates a new social layer SKU. Returns the created [SKU](#sku-object) object on success. Requires a partner application with access to the social layer SDK and monetization. User must be the owner of the application or member of the owning team.
...
<RouteMethod method="PUT" url="/partner-sdk/applications/{application.id}/storefront">
