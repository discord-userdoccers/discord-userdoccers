...
^2^ Only included when fetched from the [Get Games](/resources/game#get-games) or [Get Guild Role Subscriptions Settings](/resources/guild#get-guild-role-subscriptions-settings) endpoints.
...
Returns the information about subscription group for the given subscription plan ID.
