...
Returns information about guild application's storefront.
...
| sku_ids      | array[snowflake]                                                            | The IDs of the SKUs on the page |
| sections?    | array[[storefront page section](#storefront-page-section-structure) object] | The sections on the page        |
...
| Field   | Type             | Description                             |
| ------- | ---------------- | --------------------------------------- |
| title   | string           | The title of the page section           |
| sku_ids | array[snowflake] | The IDs of the SKUs on the page section |
...
<RouteHeader metohd="GET" url="/partner-sdk/guilds/{guild.id}/application-storefront/skus/{sku.id}">
  Get Guild Application Storefront SKU
</RouteHeader>
