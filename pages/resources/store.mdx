...
^2^ Only included when fetched from the [Get Games](/resources/game#get-games) endpoint.
...
| storefront_pricing?        | [storefront pricing](#storefront-pricing-structure) object              | The storefront pricing                         |
...
| pricing_result_id_map | map[string, map[string, [storefront pricing result](#storefront-pricing-result-structure) object]] | A mapping of ? to mapping of ? to storefront pricing results |
| reward_result_id_map  | map[string, map[string, [storefront pricing reward](#storefront-pricing-reward-structure) object]] | A mapping of ? to mapping of ? to storefront pricing rewards |

###### Storefront SKU Pricing Structure

| Field             | Type          | Description                      |
| ----------------- | ------------- | -------------------------------- |
| pricing_result_id | string        | The ID of the pricing result     |
| reward_result_ids | array[string] | The IDs of the reward result IDs |

###### Storefront Pricing Result Structure

| Field      | Type                                                       | Description                              |
| ---------- | ---------------------------------------------------------- | ---------------------------------------- |
| user_price | array[[price](#price-structure) object]                    | The price for the user                   |
| prices     | map[string, map[string, [price](#price-structure) object]] | A mapping of ? to mapping of ? to prices |

###### Storefront Pricing Reward Structure

| Field  | Type    | Description                                               |
| ------ | ------- | --------------------------------------------------------- |
| type   | integer | The [type of the reward](#storefront-pricing-reward-type) |
| amount | integer | ?                                                         |

###### Storefront Pricing Reward Type
