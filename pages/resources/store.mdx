...
| Field                      | Type                                                                                | Description                                            |
| -------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------ |
| id                         | snowflake                                                                           | The ID of the storefront                               |
| published_at               | ?ISO8601 timestamp                                                                  | When the storefront was published at                   |
...
| promotions?                | map[snowflake, partial [storefront promotion](#storefront-promotion-object) object] | A mapping of storefront promotion IDs to the promotion |
...
### Storefront Promotion Object

###### Storefront Promotion Structure

| Field               | Type                                                                                           | Description                                                                                |
| ------------------- | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| id                  | snowflake                                                                                      | The ID of the storefront promotion                                                         |
| application_id      | snowflake                                                                                      | The ID of the application                                                                  |
| display_name?       | string                                                                                         | The display name of the storefront promotion                                               |
| reward_type         | integer                                                                                        | The [type of storefront promotion reward config](#storefront-promotion-reward-config-type) |
| reward_config       | [storefront promotion reward config](#storefront-promotion-reward-config-structure) object     | The storefront promotion reward config                                                     |
| applies_to_all_skus | boolean                                                                                        | Whether the promotion applies to all SKUs                                                  |
| starts_at?          | ?ISO8601 timestamp                                                                             | When the promotion starts                                                                  |
| ends_at?            | ?ISO8601 timestamp                                                                             | When the promotion ends                                                                    |
| tenant_metadata?    | [storefront promotion tenant metadata](#storefront-promotion-tenant-metadata-structure) object | Tenant metadata for the promotion                                                          |

###### Storefront Promotion Tenant Metadata Structure

| Field         | Type                                                                                   | Description                            |
| ------------- | -------------------------------------------------------------------------------------- | -------------------------------------- |
| social_layer? | [social layer storefront metadata](#social-layer-storefront-metadata-structure) object | Social layer storefront promotion data |

###### Social Layer Storefront Metadata Structure

| Field       | Type                                                                                       | Description                      |
| ----------- | ------------------------------------------------------------------------------------------ | -------------------------------- |
| pdp?        | [storefront promotion label section](#storefront-promotion-label-section-structure) object | The product display page section |
| storefront? | [storefront promotion header](#storefront-promotion-header-structure) object               | The storefront promotion header  |
| checkout?   | [storefront promotion label section](#storefront-promotion-label-section-structure) object | The checkout page section        |
| vc_stream?  | [storefront promotion label section](#storefront-promotion-label-section-structure) object | The voice channel stream section |

###### Storefront Promotion Reward Config Structure

| Field    | Type                                                                                                          | Description         |
| -------- | ------------------------------------------------------------------------------------------------------------- | ------------------- |
| discount | ?[storefront promotion reward config discount](#storefront-promotion-reward-config-discount-structure) object | The discount reward |
| action?  | ?[storefront promotion reward config action](#storefront-promotion-reward-config-action-structure) object     | The action reward   |

###### Storefront Promotion Reward Config Discount Structure
...
###### Storefront Promotion Reward Config Action Structure

| Field       | Type    | Description                                                                                              |
| ----------- | ------- | -------------------------------------------------------------------------------------------------------- |
| action_type | integer | The [type of storefront promotion reward config action](#storefront-promotion-reward-config-action-type) |

###### Storefront Promotion Reward Config Action Type

The values of this enum are currently unknown. Help us by figuring them out and [submitting a pull request](https://github.com/discord-userdoccers/discord-userdoccers/edit/master/pages/resources/store.mdx)!

###### Storefront Promotion Reward Config Type

The values of this enum are currently unknown. Help us by figuring them out and [submitting a pull request](https://github.com/discord-userdoccers/discord-userdoccers/edit/master/pages/resources/store.mdx)!

###### Partial Storefront Promotion Structure

| Field       | Type                                                                                       | Description                        |
| ----------- | ------------------------------------------------------------------------------------------ | ---------------------------------- |
| id          | snowflake                                                                                  | The ID of the storefront promotion |
| ends_at?    | ?ISO8601 timestamp                                                                         | When the promotion ends at         |
| pdp?        | [storefront promotion label section](#storefront-promotion-label-section-structure) object | The product display page section   |
| storefront? | [storefront promotion header](#storefront-promotion-header-structure) object               | The storefront promotion header    |
| checkout?   | [storefront promotion label section](#storefront-promotion-label-section-structure) object | The checkout page section          |
| vc_stream?  | [storefront promotion label section](#storefront-promotion-label-section-structure) object | The voice channel stream section   |

###### Storefront Promotion Header Structure

| Field        | Type   | Description     |
| ------------ | ------ | --------------- |
| header_text? | string | The header text |

###### Storefront Promotion Label Section Structure

| Field    | Type   | Description                                                  |
| -------- | ------ | ------------------------------------------------------------ |
| label?   | string | The label of the section                                     |
| tooltip? | string | The tooltip on the section                                   |
| icon?    | string | The [icon of section](#storefront-promotion-label-icon-type) |

###### Storefront Promotion Label Icon Type
...
###### Example Storefront Promotion

```json
{
  "id": "1521153911619326114",
  "application_id": "1288512934112264234",
  "display_name": "Get Orbs back on Rust in-game item purchases",
  "reward_type": 1,
  "reward_config": {
    "discount": null,
    "action": {
      ...
      "orbs_back": {
        "mode": "FLAT_TIERS",
        "tiers": [
          { "min_amount_cents": 0, "orbs_quantity": 300 },
          { "min_amount_cents": 1000, "orbs_quantity": 600 },
          { "min_amount_cents": 2000, "orbs_quantity": 900 },
          { "min_amount_cents": 3000, "orbs_quantity": 1200 }
        ]
      }
    }
  },
  "sku_ids": null,
  "applies_to_all_skus": true,
  "starts_at": "2026-07-02T18:00:00+00:00",
  "ends_at": "2026-07-16T18:00:00+00:00",
  "tenant_metadata": {
    "social_layer": {
      "pdp": {
        "label": "Get {value} Orbs with purchase",
        "tooltip": "Use Orbs to purchase items from the Discord Shop",
        "icon": "ORBS"
      },
      "storefront": {
        "header_text": "**Get Discord Orbs with all official Rust in-game purchases!** Ends July 16th"
      },
      "checkout": {
        "label": "Get {value} Orbs with purchase",
        "tooltip": "Use Orbs to purchase items from the Discord Shop",
      ...
      "vc_stream": {
        "label": "Get Orbs on Rust in-game purchases",
        "tooltip": "Use Orbs to purchase items from the Discord Shop",
        "icon": "ORBS"
      }
    }
...
| reward_result_id_map  | map[string, map[integer, [storefront promotion reward](#storefront-promotion-reward-structure) object]] | A mapping of reward result IDs to mapping of [storefront purchase type](#storefront-purchase-type) to discounts                   |
...
| reward_result_ids        | array[string]    | The IDs of the reward results |
...
| amount | integer | How much the reward is                                                |
...
<RouteHeader
  method="GET"
  url="/store/listings/{store_listing.id}"
  supportsOAuth2="applications.store.update"
  supportsBot
>
  Get Store Listing
...
<RouteHeader method="GET" url="/subscription-plans/{subscription_plan.id}/subscription-group-listing">
...
<RouteHeader method="GET" url="/applications/{application.id}/store-layout">
...
<RouteHeader method="POST" url="/applications/{application.id}/storefront/publish">
...
<RouteHeader method="GET" url="/storefront/products/{product.id}">
...
<RouteHeader method="GET" url="/storefront/skus/prices">
...
Returns a [storefront prices](#storefront-prices-object) object.
...
| sku_ids? ^1^           | array[snowflake] | The IDs of the SKUs (max 50)                                                            |
| country_code?          | string           | The [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country code |
| promotion_id_override? | snowflake        | The ID of the promotion to override                                                     |

^1^ Only one of `application_id` or `sku_ids` must be provided.

<RouteHeader method="POST" url="/applications/{application.id}/storefront/product">
  Create Storefront Product
</RouteHeader>

Creates a storefront product. Requires an application with access to storefront. User must be the owner of the application or developer of the owning team.
...
| ----------- | ----------------------------------------------- | ---------------------------------------- |
| name        | [localized string](/reference#localized-string) | The name of the SKU (1-256 characters)   |
| sku_type    | integer                                         | The [type of SKU](#sku-type)             |
| group_type? | integer                                         | The [type of SKU group](#sku-group-type) |

###### Response Body

| Field          | Type                                                 | Description                |
| -------------- | ---------------------------------------------------- | -------------------------- |
| skus           | array[[SKU](#sku-object) object]                     | The created SKUs           |
| store_listings | array[[store listing](#store-listing-object) object] | The created store listings |

###### SKU Group Type

| Value | Name  | Description        |
| ----- | ----- | ------------------ |
| 1     | GUILD | SKU is for a guild |
| 2     | USER  | SKU is for a user  |

<RouteHeader method="PATCH" url="/applications/{application.id}/storefront/product/{sku.id}">
  Modify Storefront Product
</RouteHeader>

Modifies the storefront product. User must be the owner of the application or developer of the owning team.
...
| application_id? | snowflake                                               | The ID of the application                            |
| name?           | [localized string](/reference#localized-string)         | The name of the SKU (1-256 characters)               |
| description?    | [localized string](/reference#localized-string)         | The description of the SKU (1-1500 characters)       |
| price_tier?     | integer                                                 | The [base price](#list-store-price-tiers) of the SKU |
| store_benefits? | array[[store benefit](#store-benefit-structure) object] | The store benefits                                   |

###### Store Benefit Structure

| Field       | Type                                                        | Description                                       |
| ----------- | ----------------------------------------------------------- | ------------------------------------------------- |
| name        | string                                                      | The name of the benefit (1-80 characters)         |
| description | string                                                      | The description of the benefit (1-160 characters) |
| icon        | ?[store listing icon](#store-listing-icon-structure) object | The icon for the benefit (max 6)                  |

###### Response Body

| Field              | Type                                                         | Description                     |
| ------------------ | ------------------------------------------------------------ | ------------------------------- |
| skus               | array[[SKU](#sku-object) object]                             | The modified SKUs               |
| store_listings     | array[[store listing](#store-listing-object) object]         | The modified store listings     |
| subscription_plans | array[[subscription plan](#subscription-plan-object) object] | The modified subscription plans |

<RouteHeader method="DELETE" url="/applications/{application.id}/storefront/product/{sku.id}">
  Delete Storefront Product
</RouteHeader>

Deletes the storefront product. Returns a 204 empty response on success. User must be the owner of the application or developer of the owning team.

<RouteHeader method="GET" url="/partner-sdk/guilds/{guild.id}/application-storefront">
  Get Guild Primary Application Storefront
</RouteHeader>
...
| Field                  | Type      | Description                                  |
| ---------------------- | --------- | -------------------------------------------- |
| test_mode?             | boolean   | Whether test mode is enabled (default false) |
| promotion_id_override? | snowflake | The ID of the promotion to override          |

<RouteHeader method="GET" url="/partner-sdk/application/{application.id}/application-storefront">
  Get Public Primary Application Storefront
</RouteHeader>
...
<RouteHeader method="GET" url="/partner-sdk/applications/{application.id}/storefront">
  Get Primary Application Storefront
</RouteHeader>

Returns a primary [storefront](#storefront-object) object for the given application ID. User must be the owner of the application or developer of the owning team.
...
<RouteHeader method="GET" url="/partner-sdk/applications/{application.id}/storefronts/all">
  Get Application Storefronts
</RouteHeader>

Returns a list of [storefront summary](#storefront-summary-structure) objects for the given application ID. Requires a partner application with access to the social layer SDK and monetization. User must be the owner of the application or member of the owning team.

###### Storefront Summary Structure
...
<RouteHeader method="GET" url="/partner-sdk/applications/{application.id}/storefronts/{storefront.id}">
  Get Application Storefront
</RouteHeader>

Returns a [storefront](#storefront-object) object for the given application and storefront ID.
...
<RouteHeader method="GET" url="/partner-sdk/guilds/{guild.id}/application-storefront/skus/{sku.id}" deprecated>
...
| ------------------------- | --------- | -------------------------------------------------------------------- | ------------------------------ |
| type                      | string    | The [type of storefront announcement](#storefront-announcement-type) | All                            |
| id                        | snowflake | The ID of the announcement                                           | All                            |
| application_id            | snowflake | The ID of the application                                            | All                            |
| application_name          | string    | The name of the application                                          | All                            |
| asset_id                  | snowflake | The ID of the announcement store asset                               | `guild-application-storefront` |
| background_image_asset_id | snowflake | The ID of the background image store asset                           | `guild-application-storefront` |
| asset_fully_qualified_url | string    | The URL to fully qualified asset                                     | `guild-discord-storefront`     |
| popover_title             | string    | The title of the popover                                             | `guild-discord-storefront`     |
| popover_body              | string    | The body of the popover                                              | `guild-discord-storefront`     |
| popover_cta               | string    | The CTA of the popover                                               | `guild-discord-storefront`     |

###### Storefront Announcement Type

| Value                        | Description |
| ---------------------------- | ----------- |
| guild-application-storefront | Unknown     |
| guild-discord-storefront     | Unknown     |
...
<RouteHeader
  method="POST"
  url="/partner-sdk/guilds/{guild.id}/application-storefront/skus/{sku.id}/eligibility"
  deprecated
>
...
<RouteHeader method="GET" url="/partner-sdk/storefront-config">
...
| promotion_end_datetime               | ?ISO8601 timestamp | When the promotion ends                                                                                              |
| allow_orbs_spending                  | boolean            | Whether purchasing the storefront SKUs gives Orbs                                                                    |
...
<RouteHeader method="GET" url="/partner-sdk/storefront-eligibility">
