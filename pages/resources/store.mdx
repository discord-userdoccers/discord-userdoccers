...
A SKU (Stock Keeping Unit) represents a purchasable item or group of items in Discord.
...
| ----- | ---- | ----------------------------------- | ----------------------------------- | --------------------------------------------------- |
| 1     | ESRB | Entertainment Software Rating Board | [ESRB Content Rating](#esrb-rating) | [ESRB Content Descriptor](#esrb-content-descriptor) |
| 2     | PEGI | Pan European Game Information       | [PEGI Content Rating](#pegi-rating) | [PEGI Content Descriptor](#pegi-content-descriptor) |
...
| premium?          | map[integer, [premium price](#premium-price-structure) object] | The price for premium users per [premium tier](/resources/user#premium-tier)     |
...
Store listings represent a purchasable item on Discord. A listing is associated with a single SKU.
