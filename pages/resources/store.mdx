...
| created_at      | ISO8601 timestamp | When the storefront collection was created at  |
| updated_at      | ISO8601 timestamp | When the storefront collection was updated at  |
...
| updated_at      | ISO8601 timestamp                                                    | When the product was created              |
...
| Field                             | Type                                                                                                                        | Description                                                                    |
| --------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| instructions                      | [game server powerup product metadata instructions](#game-server-powerup-product-metadata-instructions-structure) structure | The instructions for joining the game server                                   |
| deactivation_cooldown_period_days | integer                                                                                                                     | Duration in days after which the game server can be disabled                   |
...
###### Game Server Powerup Product Metadata Instructions Structure
...
| ----------------------------------- | --------- | --------------------------------------------------------------------------------------- |
| country_code?                       | string    | The [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country code |
| guild_id?                           | snowflake | The guild ID to fetch storefront collection for                                         |
| include_unpublished_products? ^1^   | boolean   | Whether to include unpublished products (default false)                                 |
| include_unpublished_collection? ^1^ | boolean   | Whether to include unpublished collection (default false)                               |
...
<RouteHeader method="GET" url="/storefront/products/skus">
  Get Storefront Products By SKU IDs
</RouteHeader>
...
Returns prices for the storefront SKUs.
...
| Field      | Type                   | Description                          |
| ---------- | ---------------------- | ------------------------------------ |
| sku_prices | map[snowflake, object] | A mapping of SKU IDs to empty object |
...
Returns the storefront config for Marvel Rivals.

###### Response Body

| Field                  | Type               | Description                     |
| ---------------------- | ------------------ | ------------------------------- |
| promotional_sku_ids    | array[snowflake]   | The IDs of the promotional SKUs |
