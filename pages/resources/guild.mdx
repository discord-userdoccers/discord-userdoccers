...
| inventory_settings? **(deprecated)** | [inventory settings](#inventory-settings-object) object                                    | Settings for emoji packs                                                                                                   |
...
| ENHANCED_ROLE_COLORS                                   | Ability to set enhanced role colors                                                                                                                                                                                                                                                                |
...
| VIDEO_BITRATE_ENHANCED                                 | Access to HD Streaming                                                                                                                                                                                                                                                                             |
...
Holds settings for server emoji packs.

###### Inventory Settings Structure

| Field                      | Type    | Description                                  |
| -------------------------- | ------- | -------------------------------------------- |
| is_emoji_pack_collectible? | boolean | Allows everyone to use the guild's emoji across all guilds |
...
Holds public information about a guild such as name, icon, description, online/member count, traits, community features, and associated games.

| Field                      | Type                                             | Description                                               |
| -------------------------- | ------------------------------------------------ | --------------------------------------------------------- |
| id                         | snowflake                                        | The guild's ID                                            |
| name                       | string                                           | The guild's name                                          |
| member_count               | integer                                          | How many members are in the guild                         |
| online_count               | integer                                          | How many guild members are currently online               |
| description                | string                                           | The guild's description                                   |
| brand_color_primary        | string                                           | The guild's accent color                                  |
| banner_hash?               | string                                           | The guild's banner, if available                          |
| game_application_ids       | array[string]                                    | List of game application ids associated with the guild    |
| game_activity              | map[snowflake, [game activity](/resources/clan#game-activity-structure) object] | The activity of the guild in each game                                                                 |
| tag                        | ?string                                          | The guild's clan tag                                      |
| badge                      | ?integer                                          | The [badge shown on the clan's tag](/resources/clan#clan-badge-type)                                    |
| badge_color_primary        | ?string                                          | The guild's primary clan badge color                      |
| badge_color_secondary      | ?string                                          | The guild's secondary clan badge color                    |
| badge_hash                 | string                                           | Hash of the server's clan badge on the CDN                |
| traits                     | array[[guild trait object](#guild-trait-object)] | The guild's traits                                        |
| features ^1^               | array[string]                                    | The guild's features                                      |
| visibility                 | [guild visiblity enum](#guild-visibility)        | The guild's visibiltiy level                              |
| custom_banner_hash         | ?string                                          | The guild's custom banner                                 |
| premium_subscription_count | integer                                          | Amount of members boosting the server                     |
| premium_tier               | integer                                          | The guild's boost level                                   |

^1^ This is not a complete list of all the features the guild has, and is limited to community features (`MEMBER_VERIFICATION_GATE_ENABLED`, `COMMUNITY`, `MEMBER_VERIFICATION_MANUAL_APPROVAL`, `DISCOVERABLE`)

###### Guild Visibility

| Value | Name                    | Description                                                                                       |
| ----- | ----------------------- | ------------------------------------------------------------------------------------------------- |
| 1     | PUBLIC                  | This guild is considered public and can be viewed and joined by anyone                            |
| 2     | RESTRICTED              | This guild is considered private but cannot be viewed and joining requires an invite              |
| 3     | PUBLIC_WITH_RECRUITMENT | This guild is considered public and can be viewed, but joining requires submitting an application |

### Guild Trait Object

Holds a trait about a guild (e.g "friendly" or "17+")
...
Returns the [Guild Profile Object](#guild-profile-object).
