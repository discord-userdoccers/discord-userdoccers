...
| inventory_settings **(deprecated)** | ?[inventory settings](#inventory-settings-structure) object                                | Settings for emoji packs                                                                                                   |
...
| profile ^3^                         | ?partial [guild profile](/resources/discovery#guild-profile-object) object                 | The guild's identity                                                                                                       |
...
| Field | Type   | Description                                              |
| ----- | ------ | -------------------------------------------------------- |
| tag   | string | The clan tag of the guild (2-4 characters)               |
| badge | string | The guild's [clan badge hash](/reference#cdn-formatting) |
...
| ~~RAPIDASH_TEST~~                                      | ~~Access to clan conversion and clan discovery for Genshin Impact~~                                                                                                                                                                                                                                |
...
| color          | integer                                      | The color of the role represented as an integer representation of a hexadecimal color code                  |
| colors         | [role colors](#role-colors-structure) object | A 2- or 3-point gradient color for the role encoded as an integer representation of hexadecimal color codes |
...
| Field              | Type     | Description                                         |
| ------------------ | -------- | --------------------------------------------------- |
| primary_color      | integer  | The primary color of the gradient (matches `color`) |
| secondary_color    | ?integer | The secondary color of the gradient                 |
| tertiary_color ^1^ | ?integer | The tertiary color of the gradient                  |

^1^ The only valid 3-point gradient is (`11127295`, `16759788`, `16761760`). Attempting to set `tertiary_color` with any other values will fail.
...
| Field                          | Type                                                                                    | Description                                                               |
| ------------------------------ | --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| connection_type ^1^            | string                                                                                  | The [type of connection](/resources/connections#connection-type) required |
...
^2^ In the case of regular connections, this is checked against the provider's [connection metadata](/resources/connections#connection-object). For application connections, this is checked against the user's [application metadata](/resources/application#application-role-connection-object).
...
| description?    | ?string                                       | The description for the role (max 90 characters)                                                            |
| color? ^1^      | ?integer                                      | Integer representation of a hexadecimal color code for the role                                             |
| colors? ^1^ ^2^ | ?[role colors](#role-colors-structure) object | A 2- or 3-point gradient color for the role encoded as an integer representation of hexadecimal color codes |
