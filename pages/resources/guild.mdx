...
### Role Subscriptions Settings Object

###### Role Subscriptions Settings Structure

| Field                                   | Type                                                      | Description                                                                                               |
| --------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| guild_id                                | snowflake                                                 | The ID of the guild                                                                                       |
| full_server_gate                        | boolean                                                   | Whether the guild is fully gated behind a role subscription                                               |
| description?                            | ?string                                                   | The description of the guild's role shop                                                                  |
...
| store_page_trailer_url?                 | ?string                                                   | The URL to the promo trailer                                                                              |
...
| store_page_slug                         | string                                                    | The guild shop's slug                                                                                     |
...
```json
{
    ...
    "store_page_primary_color": 1,
    "store_page_trailer_url": "asdasdsa",
    ...
    "store_page_slug": "{guild.slug}-{guild.id}"
}
```
...
Returns a [role subscriptions settings](#role-subscriptions-settings-object) object for the given guild ID.

<RouteHeader method="PATCH" url="/guilds/{guild.id}/role-subscriptions/settings">
  Modify Guild Role Subscriptions Settings
</RouteHeader>

Modifies the guild's role subscription settings. Returns a [role subscriptions settings](#role-subscriptions-settings-object) object on success.
...
| active_trial?              | [subscription trial](/resources/subscription#subscription-trial-object) object | The subscription trial associated with the role subscription trial |
...
| Field                       | Type                                                                                              | Description                                                   |
| --------------------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| trial?                      | partial [subscription trial](/resources/subscription#partial-subscription-trial-structure) object | The subscription trial's interval information                 |
...
<RouteHeader method="GET" url="/guilds/{guild.id}/role-subscriptions/subscription-listings/{subscription_listing.id}/trial/{subscription_trial.id}/eligibility">
...
Accepts guild monetization request's terms of use. Returns a 204 empty response on success.

<Alert type="warn">

This endpoint is deprecated. It is replaced by [Accept Guild Creator Monetization Terms](#accept-guild-creator-monetization-terms).
...
Accepts guild monetization's terms of use. Returns a 204 empty response on success.
...
| SUBSCRIPTIONS_ENDED_FULL_REFUND     | Creator requested a full refund     |
| SUBSCRIPTIONS_ENDED_PRORATED_REFUND | Creator requested a prorated refund |
...
| application | ?partial [application](/resources/application#application-object) object | The application that got transferred |
                ...
                CREATOR_MONETIZATION_ACCEPT_NEW_TERMS_DEMONETIZED: e => `/guilds/${e}/creator-monetization/accept-new-terms-demonetized`,
...
Removes guild's access to monetization features. Accepts an empty object. Returns a 204 empty response on succses.
