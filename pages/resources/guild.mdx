...
Returns a [guild profile](#guild-profile-object) object for the given guild ID. User must be a member of the guild or the guild must have a [`PUBLIC` or `PUBLIC_WITH_RECRUITMENT` visibility](#guild-visibility).
