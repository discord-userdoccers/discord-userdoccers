...
Holds public information about a guild such as name, icon, description, online/member count, traits, community features, and assosciated games.
...
| game_application_ids       | array[string]                        | List of game application ids assosciated with the guild   |
...
| traits                     | array[Guild Trait Object]            | The guild's traits                                        |
| features ^1^               | array[string]                        | The guild's features                                      |
| visibility                 | [Guild Visiblity](#guild-visibility) | The guild's visibiltiy level                              |
