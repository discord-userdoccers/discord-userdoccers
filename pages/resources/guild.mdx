...
| max_video_channel_users?        | integer                                                          | The maximum amount of users that can watch a video stream in a voice channel at once                                       |
| max_stage_video_channel_users?  | integer                                                          | The maximum amount of users that can watch a video stream in a stage channel at once                                       |
...
| incidents_data                  | ?[automod incidents data](#automod-incidents-data-object) object | Information on the guild's AutoMod incidents                                                                               |
...
| clan? ^2^                       | partial [clan](/resources/clan#clan-object) object               | The guild's clan information                                                                                               |

^1^ Only included when fetched from the [Get Guild](#get-guild) endpoint with `with_counts` set to `true`.

^2^ Only included in guild objects returned [over the Gateway](/topics/gateway#guilds).
...
| MEMBER_VERIFICATION_MANUAL_APPROVAL                    | Membership verification v2 enabled                                                                                                                                                                                                                                                                 |
...
| COMMUNITY ^1^                                   | Whether community features are available                                                                                             | `ADMINISTRATOR`      |
| DISCOVERABLE ^2^                                | Whether the guild is public and discoverable in the directory                                                                        | `ADMINISTRATOR`      |
...
| MEMBER_VERIFICATION_GATE_ENABLED ^3^            | Whether the member verification gate is enabled                                                                                      | `MANAGE_GUILD`       |
...
| SUMMARIES_ENABLED_BY_USER ^4^                   | Whether [conversation summaries](https://support.discord.com/hc/en-us/articles/12926016807575-Conversation-Summaries-AI) are enabled |
...
A partial guild object returned from the [Get Guild Preview](#get-guild-preview) endpoint.
...
| Value  | Name                      | Description                                                                                                                                                                                                                                                                     |
| ------ | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1 << 0 | DID_REJOIN                | This guild member has left and rejoined the guild                                                                                                                                                                                                                               |
| 1 << 1 | COMPLETED_ONBOARDING      | This guild member has completed onboarding                                                                                                                                                                                                                                      |
| 1 << 2 | BYPASSES_VERIFICATION ^1^ | This guild member bypasses guild verification requirements and [member verification](#member-verification-object)                                                                                                                                                               |
| 1 << 3 | STARTED_ONBOARDING        | This guild member has started onboarding                                                                                                                                                                                                                                        |
| 1 << 4 | GUEST                     | This guild member is a [guest](/resources/invite#guest-invites) and not a true member                                                                                                                                                                                           |
| 1 << 7 | AUTOMOD_QUARANTINED_NAME  | This guild member has been indefinitely quarantined by [an AutoMod Rule](/resources/auto-moderation#automod-rule-object) for their username, display name, or nickname; quarantined users, similar to timed out users, are prevented from interacting with the guild in any way |
| 1 << 8 | AUTOMOD_QUARANTINED_BIO   | This guild member has been indefinitely quarantined by [an AutoMod Rule](/resources/auto-moderation#automod-rule-object) for their bio; quarantined users, similar to timed out users, are prevented from interacting with the guild in any way                                 |
...
| Field            | Type                                                                      | Description                                      |
| ---------------- | ------------------------------------------------------------------------- | ------------------------------------------------ |
| description      | ?string                                                                   | The welcome message shown in the welcome screen  |
...
In guilds with [member verification](https://support.discord.com/hc/en-us/articles/1500000466882) enabled, when a member joins, a [Guild Member Add](/topics/gateway-events#guild-member-add) Gateway event will be emitted but they will initially be restricted from doing any actions in the guild, and `pending` will be true in the [member object](#guild-member-object).
When the member completes the verification, a [Guild Member Update](/topics/gateway-events#guild-member-update) Gateway event will be emitted and `pending` will be false.

When joining a guild with member verification enabled, a [Guild Join Request Create](/topics/gateway-events#guild-join-request-create) Gateway event will be emitted, and the member will be restricted from doing any actions in the guild until they pass the verification gate.

Assigning a member the [`BYPASSES_VERIFICATION` flag](#guild-member-flags) will force their `pending` status to be false.

#### Guild Previewing

Discoverable guilds and guilds with member verification enabled have the [`PREVIEW_ENABLED`](#guild-features) feature by default.
This allows the guild to be lurkable by users who are not members, if discoverable, and allows members who have not passed the verification gate to view the guild without interacting with it as described above.

If a guild has member verification enabled and is not previewable, new joiners will not be able to view the guild until they pass the verification gate, and are therefore not considered members until they do.
This means that a [Guild Member Add](/topics/gateway-events#guild-member-add) Gateway event will not be emitted until the member has passed the verification gate, and `pending` will immediately be true in the [member object](#guild-member-object) once it is.

From the joiner's perspective, they will also not receive a [Guild Create](/topics/gateway-events#guild-create) Gateway event or any other events emitted from the guild until they pass member verification.
Non-previewable pending guilds can be retrieved with the [Get Join Request Guilds](#get-join-request-guilds) endpoint. Their join requests are also sent in the [`guild_join_requests` field of the Ready event](/topics/gateway-events#ready).
...
When using these form field types, join requests must be manually approved before the user can complete member verification.

When only using a `TERMS` [form field type](#member-verification-form-field-type), the join request will be automatically approved when the user [submits the request](#create-guild-join-request).
...
| form_fields | array[[member verification form field](#verification-form-field) object]  | Questions for applicants to answer (max 5)                                                                        |
...
^1^ Only included when fetched from the [Get Membership Verification](#get-membership-verification) endpoint with `with_guild` set to `true`.
...
^1^ Not present when fetched from the [Get Guild Member Verification](#get-guild-member-verification) endpoint. For `TERMS` questions, the response should be `true`. For `MULTIPLE_CHOICE` questions, the response is the index of the selected choice.
...
Most join request features require the [`MEMBER_VERIFICATION_MANUAL_APPROVAL` guild feature](#guild-features), as join request are automatically actioned when only using the `TERMS` [form field type](#member-verification-form-field-type).
...
| form_responses?      | array[[member verification form field](#verification-form-field) object] | The responses to the guild's member verification questions                          |
| last_seen            | ?ISO8601 timestamp                                                       | When the request was last seen by a moderator                                       |
| actioned_at?         | ?ISO8601 timestamp                                                       | When the join request was actioned                                                  |
| actioned_by_user?    | partial [user](/resources/user#user-object) object                       | The moderator who actioned the join request                                         |
...
| user?                | partial [user](/resources/user#user-object) object                       | The user who created this join request                                              |
...
Returns a list of partial [guild](#guild-object) objects representing guilds without the [`PREVIEW_ENABLED` guild feature](#guild-features) the current user has pending join requests for.
...
| default_message_notifications? | integer                                                            | Default [message notification level](/resources/guild#message-notification-level) for the guild                            |
| explicit_content_filter?       | integer                                                            | [Whose messages](/resources/guild#explicit-content-filter-level) are scanned and deleted for explicit content in the guild |
| roles? ^1^                     | array[partial [role](/topics/permissions#role-object) object]      | Roles in the new guild                                                                                                     |
...
Returns a [guild](#guild-object) object for the given guild ID.
...
Returns a [guild preview](#guild-preview-object) object for the given guild ID. If the user is not in the guild, the guild must be discoverable.
...
| owner_id?                      | snowflake                          | The user ID of the guild's owner (must be the current owner)                                                                                                         |
| description?                   | ?string                            | The description for the guild                                                                                                                                        |
| region? **(deprecated)**       | ?string                            | The main [voice region](/resources/voice#voice-region-object) ID of the guild                                                                                        |
| afk_channel_id?                | ?snowflake                         | The ID of the guild's AFK channel; this is where members in voice idle for longer than `afk_timeout` are moved                                                       |
| afk_timeout?                   | integer                            | The AFK timeout of the guild (one of 60, 300, 900, 1800, 3600, in seconds)                                                                                           |
...
Modifies the guild's [MFA requirement](/resources/guild#mfa-level) for administrative actions within the guild. Requires the `MANAGE_GUILD` permission. Fires a [Guild Update](/topics/gateway-events#guild-update) Gateway event.
...
| after? | snowflake | Return members after this member ID                 |

<RouteHeader method="GET" url="/guilds/{guild.id}/members/search">
  Search Guild Members
</RouteHeader>

Returns a list of [guild member](#guild-member-object) objects whose username or nickname contains a provided string.
...
^1^ Lurking a guild allows the user to receive Gateway events for the guild without being a full member. This is useful for previewing the guild before joining. Lurking requires the [`PREVIEW_ENABLED` guild feature](#guild-features).
...
For guilds with [member verification](#member-verification-object) and enabled, this endpoint will default to adding new members as `pending` in the [guild member](#guild-member-object) object. Members that are `pending` will have to complete member verification before they become full members that can talk.
...
Modifies attributes of a guild member. Returns the updated [guild member](#guild-member-object) object on success. Fires a [Guild Member Update](/topics/gateway-events#guild-member-update) Gateway event.
...
Modifies the current user's profile in the guild. Returns a [profile metadata](/resources/user#profile-metadata-object) object on success. Fires a [Guild Member Update](/topics/gateway-events#user-update) Gateway event.
...
Returns a list of [ban](#ban-object) objects whose username or display name contains a provided string.
...
Returns a list of member IDs that have the specified [role](/topics/permissions#role-object), up to a maximum of 100.
...
Adds multiple [guild members](#guild-member-object) to a [role](/topics/permissions#role-object). Requires the `MANAGE_ROLES` permission. Returns a mapping of member IDs to [guild member](#guild-member-object) objects. Fires multiple [Guild Member Update](/topics/gateway-events#guild-member-update) Gateway events.
...
Creates a new role for the guild. Requires the `MANAGE_ROLES` permission. Returns the new [role](/topics/permissions#role-object) object on success. Fires a [Guild Role Create](/topics/gateway-events#guild-role-create) Gateway event.
...
Begins a prune operation. Requires both the `MANAGE_GUILD` and `KICK_MEMBERS` permission. For large guilds, it's recommended to set the `compute_prune_count` option to `false`, allowing the request to return before all members are pruned. Fires multiple [Guild Member Remove](/topics/gateway-events#guild-member-remove) Gateway events.
...
<RouteHeader method="PATCH" url="/guilds/{guild.id}/vanity-url">
  Modify Guild Vanity Invite
</RouteHeader>

Modifies the vanity invite for the guild. The guild must have the `VANITY_URL` or `GUILD_WEB_PAGE_VANITY_URL` feature. Guilds without the `VANITY_URL` feature can only clear their vanity invite. Requires the `MANAGE_GUILD` permission. Fires a [Guild Update](/topics/gateway-events#guild-update) Gateway event.
...
Returns the [member verification](#member-verification-object) object for the guild if one is set.
...
^1^ Requires that the user is not a member of the guild.
...
Returns a list of join requests for the guild. Requires the `MANAGE_GUILD` permission.
...
Submits a request to join a guild. Returns a [guild join request](#guild-join-request-object) object on success. Fires a [Guild Join Request Create](/topics/gateway-events#guild-join-request-create) or [Guild Join Request Update](/topics/gateway-events#guild-join-request-update) Gateway event.
...
Resets the current user's join request for the guild. Returns a [guild join request](#guild-join-request-object) object on success. Fires a [Guild Join Request Delete](/topics/gateway-events#guild-join-request-delete) and [Guild Join Request Create](/topics/gateway-events#guild-join-request-create) Gateway event.

<RouteHeader method="DELETE" url="/guilds/{guild.id}/requests/@me">
  Delete Guild Join Request
</RouteHeader>

Deletes the current user's join request for the guild. Returns a 204 empty response on success. Fires a [Guild Join Request Delete](/topics/gateway-events#guild-join-request-delete) Gateway event.

<RouteHeader method="PATCH" url="/guilds/{guild.id}/requests/{user.id}">
  Action Guild Join Request
</RouteHeader>

Accepts or denies a join request for the guild. Requires the `MANAGE_GUILD` permission. Returns a [guild join request](#guild-join-request-object) object on success. Fires a [Guild Join Request Update](/topics/gateway-events#guild-join-request-update) Gateway event.
...
| rejection_reason? | ?string | The reason for rejecting the join request (max 4000 characters)                                                    |

<RouteHeader method="PATCH" url="/guil#ds/{guild.id}/requests">
  Bulk Action Guild Join Requests
</RouteHeader>

Accepts or denies all pending join requests for the guild. Requires the `MANAGE_GUILD` permission. Returns a 204 empty response on success. May fire multiple [Guild Join Request Update](/topics/gateway-events#guild-join-request-update), [Guild Member Add](/topics/gateway-events#guild-member-add), and [Guild Member Remove](/topics/gateway-events#guild-member-remove) Gateway events.
...
Returns the [onboarding](#onboarding-object) object for the guild.
...
Joins the Discord Admin Community through the guild. Requires the `MANAGE_GUILD` permission. Returns the joined [guild](#guild-object) object on success. Fires a [Guild Create](/topics/gateway-events#guild-create) Gateway event.

<RouteHeader method="POST" url="/guilds/{guild.id}/join-wfs-server">
  Join Wumpus Feedback Squad
</RouteHeader>

Joins Wumpus Feedback Sqaud through the guild. Requires the `MANAGE_GUILD` permission and the [`CLAN` guild feature](#guild-features). Returns the joined [guild](#guild-object) object on success. Fires a [Guild Create](/topics/gateway-events#guild-create) Gateway event.

<RouteHeader method="GET" url="/guilds/{guild.id}/discovery-requirements">
  Get Guild Discovery Requirements
</RouteHeader>

Returns the [discovery requirements](/resources/discovery#discovery-requirements-object) object for the guild. Requires the `MANAGE_GUILD` permission.

<RouteHeader method="GET" url="/guilds/{guild.id}/discovery-metadata">
  Get Guild Discovery Metadata
</RouteHeader>

Returns the [discovery metadata](/resources/discovery#discovery-metadata-object) object for the guild. Requires the `MANAGE_GUILD` permission.

<RouteHeader method="PATCH" url="/guilds/{guild.id}/discovery-metadata">
  Modify Guild Discovery Metadata
</RouteHeader>

Replaces the [discovery metadata](/resources/discovery#discovery-metadata-object) for the guild. Requires the `MANAGE_GUILD` permission. Returns the updated [discovery metadata](/resources/discovery#discovery-metadata-object) object on success.
...
| Field                          | Type                                                                               | Description                                                                                                              |
| ------------------------------ | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| primary_category_id?           | ?integer                                                                           | The ID of the primary [discovery category](/resources/discovery#discovery-category-object) set for the guild (default 0) |
...
| social_links?                  | ?array[string]                                                                     | The guild's social media links shown in the discovery web page (max 9)                                                   |
| about?                         | ?string                                                                            | The guild's long description shown in the discovery web page (max 120 characters)                                        |

<RouteHeader method="PUT" url="/guilds/{guild.id}/discovery-categories/{category.id}">
  Add Guild Discovery Subcategory
</RouteHeader>

Adds a [discovery subcategory](/resources/discovery#discovery-category-object) to the guild. Requires the `MANAGE_GUILD` permission. Returns a 204 empty response on success.

<RouteHeader method="DELETE" url="/guilds/{guild.id}/discovery-categories/{category.id}">
  Remove Guild Discovery Subcategory
</RouteHeader>

Removes a [discovery subcategory](/resources/discovery#discovery-category-object) from the guild. Requires the `MANAGE_GUILD` permission. Returns a 204 empty response on success.
