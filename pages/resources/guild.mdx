...
| PRUNE_REQUIRES_ADMIN ^6^                        | Whether the ability to [prune guild members](#prune-guild) should be restricted to administrators                                                             |
...
^6^ Modification requires the user to be the owner of the guild.
