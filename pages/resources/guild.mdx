...
Returns a list of [role](/topics/permissions#role-object) objects for the guild. User must be a member of the guild.

<RouteHeader method="GET" url="/guilds/{guild.id}/roles/{role.id}">
  Get Guild Role
</RouteHeader>

Returns a [role](/topics/permissions#role-object) object for the given role. User must be a member of the guild.
...
Returns a list of member IDs that have the specified [role](/topics/permissions#role-object), up to a maximum of 100. User must be a member of the guild.
