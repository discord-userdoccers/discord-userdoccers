...
| member? ^1^        | [guild member](#guild-member-object) object | The associated guild member                                             |
...
^1^ `user_id` is only included when fetched from the [Get Guild Members Supplemental](#get-guild-members-supplemental) endpoint. `member` is only included when fetched from the [Search Guild Members](#search-guild-members) endpoint.
...
| safety_signals?     | [safety signals](#safety-signals-structure) object | Safety signals to match members against                                                                           | N/A                     |
...
| Field      | Type                                  | Description                                 |
| ---------- | ------------------------------------- | ------------------------------------------- |
| or_query?  | array[snowflake \| string \| integer] | The values to match against using OR logic  |
| and_query? | array[snowflake \| string \| integer] | The values to match against using AND logic |
| range?     | [range query](#range-query-structure) | The range of values to match against        |
