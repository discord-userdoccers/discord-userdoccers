...
** \*\* These fields are only sent when using the [List Current User Guilds](/resources/user#get-current-user-guilds) endpoint and are relative to the requested user **
