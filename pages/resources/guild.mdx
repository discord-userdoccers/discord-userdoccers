...
| VIP_REGIONS                      | guild has access to set `384 Kbps` bitrate in voice (previously VIP voice servers)                                  |
...
A partial [guild](#guild-object) object return from the [Get Guild Preview](#get-guild-preview) endpoint.

###### Guild Preview Structure

| Field                      | Type                                                       | Description                                                      |
| -------------------------- | ---------------------------------------------------------- | ---------------------------------------------------------------- |
| id                         | snowflake                                                  | The ID of this guild                                             |
| name                       | string                                                     | The guild name (2-100 characters)                                |
| icon                       | ?string                                                    | The guild's [icon hash](/reference#image-formatting)             |
| description                | ?string                                                    | The description for the guild                                    |
| banner                     | ?string                                                    | The guild's [banner hash](/reference#image-formatting)           |
| splash                     | ?string                                                    | The guild's [splash hash](/reference#image-formatting)           |
| discovery_splash           | ?string                                                    | The guild's [discovery splash hash](/reference#image-formatting) |
| home_header                | ?string                                                    | The guild's [home header hash](/reference#image-formatting)      |
...
A partial guild object returned from the [Get Emoji Guild](/resources/emoji#get-emoji-guild) and [Get Sticker Guild](/resources/sticker#get-sticker-guild) endpoints.

###### Expression Guild Structure
...
| discovery_splash           | ?string                                                    | The guild's [discovery splash hash](/reference#image-formatting)                                 |
| features                   | array[string]                                              | Enabled [guild features](#guild-features)                                                        |
| vanity_url_code            | ?string                                                    | The guild's vanity code                                                                          |
...
\* The presence of these fields is dependent on the endpoint used to retrieve the guild. [Get Emoji Guild](/resources/emoji#get-emoji-guild) will not return sticker-related fields, and [Get Sticker Guild](/resources/sticker#get-guild-sticker) will not return emoji-related fields.

###### Example Expression Guild
