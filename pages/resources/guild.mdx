...
^2^ Not included when fetched from the [Get Guild Basic](#get-guild-basic), [Get Join Request Guilds](#get-join-request-guilds) or [Create Checkpoint](/resources/checkpoint#create-checkpoint) endpoints.
