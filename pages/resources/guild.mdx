...
| collectibles_sku_ids?           | array[snowflake]                   | The SKU IDs of the member's guild profile collectibles to equip; omitted equipped profile collectibles are removed                              |
