...
| CHANNEL_EMOJIS_GENERATED                               | Guild has channel icon emojis populated                                                                                                                                                                                                                                                            |
...
^1^ Won't be included in certain member objects served alongside user objects. These cases are always called out in the relevant structures.
...
| collectibles?             | ?[collectibles](#collectibles-structure) object | The member's equipped collectibles                                       |
...
<RouteHeader method="GET" url="/guilds/{guild.id}/new-member-welcome">
...
Adds premium guild subscriptions to the given guild. User must be a member of the guild. Fires [Guild Update](/topics/gateway-events#guild-update), optionally [Message Create](/topics/gateway-events#message-create), [Guild Applied Boosts Update](/topics/gateway-events#guild-applied-boosts-update), multiple [User Premium Guild Subscription Slot Update](/topics/gateway-events#user-premium-guild-subscription-slot-update), and optionally [Guild Member Update](/topics/gateway-events#guild-member-update) and [Guild Powerup Entitlements Create](/topics/gateway-events#guild-powerup-entitlements-create) Gateway events.
...
<RouteHeader method="POST" url="/guilds/{guild.id}/migrate-pin-permission">
