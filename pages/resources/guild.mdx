...
^1^ Only included when fetched from the [Get Guild Members Supplemental](#get-guild-members-supplemental) endpoint.
...
Non-previewable pending guilds can only be retrieved with the [Get Join Request Guilds](#get-join-request-guilds) endpoint. Their join requests are also sent in the [`guild_join_requests` field of the Ready event](/gateway/gateway-events#ready).
...
^1^ Only included when fetched from the [Get Guild Join Request](#get-guild-join-request) or [Get Guild Join Requests](#get-guild-join-requests) endpoints, or when receiving a [related Gateway event](/gateway/gateway-events#guild-join-request-create) as a moderator.
...
| price_tier        | integer                                                          | The [base price](/resources/store#get-store-price-tiers) of the SKU |
...
<RouteHeader method="GET" url="/guilds/{guild.id}/onboarding/allowed-applications">
  Get Guild Onboarding Allowed Applications
</RouteHeader>
...
Returns an array of [guild role subscription group listing](#guild-role-subscription-group-listing-object) objects for the given guild and subscription group listing ID.
...
Modifies the guild role subscription group listing. Returns an updated [guild role subscription group listing](#guild-role-subscription-group-listing-object) object on success.
...
Deletes the guild role subscription group listing. Returns a 204 empty response on success.
...
Creates the guild role subscription listing. Returns a [guild role subscription listing](#guild-role-subscription-listing-object) object on success.
...
| Field    | Type                   | Description |
| -------- | ---------------------- | ----------- |
| listings | array[listing unknown] | Unknown     |
| category | unknown                | Unknown     |

###### Listing Unknown Structure

| Field            | Type                                   | Description |
| ---------------- | -------------------------------------- | ----------- |
| name             | unknown                                | Unknown     |
| description      | unknown                                | Unknown     |
| price_tier       | unknown                                | Unknown     |
| image            | unknown                                | Unknown     |
| role_color       | unknown                                | Unknown     |
| channels         | array[listing channel unknown]         | Unknown     |
| additional_perks | array[listing additional perk unknown] | Unknown     |

###### Listing Channel Unknown Structure

| Field       | Type    | Description |
| ----------- | ------- | ----------- |
| name        | unknown | Unknown     |
| description | unknown | Unknown     |
| emoji_name  | unknown | Unknown     |

###### Listing Additional Perk Unknown Structure
