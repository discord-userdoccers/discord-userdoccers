...
| 3 ^1^ | INHERIT       | Inherit value from parent settings if in [channel override](/resources/user-settings#channel-override-object) object, or `ONLY_MENTIONS` otherwise |
