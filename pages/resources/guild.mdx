...
Modifies the guild role subscription listing. Returns an updated [guild role subscription listing](#guild-role-subscription-listing-object) object on success.
...
Deletes the guild role subscription listing. Returns a 204 empty response on success.
...
<RouteHeader method="POST" url="/guilds/${e}/creator-monetization/remove-monetization">
...
Removes the guild's access to monetization features. Accepts an empty object. Returns a 204 empty response on succses. Fires a [Guild Update](/gateway/gateway-events#guild-update) Gateway event.
                ...
                SUBSCRIPTION_PLAN_GUILD_ROLE_GROUP_LISTING: e => `/subscription-plans/${e}/guild-role-subscription-group-listing`,
