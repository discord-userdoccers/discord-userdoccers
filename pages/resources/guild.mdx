...
| COMMUNITY                                              | Access to [welcome screen](#welcome-screen-object), [membership screening](#membership-screening-object), [stage channels](/resources/channel#channel-type), discovery, [community updates reception](https://support.discord.com/hc/en-us/articles/360035969312-Public-Server-Guidelines), and more |
...
| form_fields | array[[verification form fields](#verification-form-field)] | Questions for applicants to answer (max 5)                                                                        |
| version     | ?ISO8601 timestamp                                          | When the membership screening was last modified                                                                   |
| guild ^1^   | ?partial [guild](#guild-object) object                      | The guild this membership screening is for                                                                        |
...
| Field        | Type               | Description                                                 |
| ------------ | ------------------ | ----------------------------------------------------------- |
| field_type   | string             | The [type of question](#form-field-type)                    |
...
^1^ For `MULTIPLE_CHOICE` questions, the response is the index of the selected choice.
