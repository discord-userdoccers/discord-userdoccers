...
Returns a [role subscription settings](#role-subscription-settings-object) object for the given guild ID. Requires the `MANAGE_GUILD` permission.
...
| store_page_guild_products_default_sort? | integer  | The default [sort order](#guild-product-sort-order-type) of guild's products                              |
                ...
                GUILD_ROLE_SUBSCRIPTION_GROUP_LISTINGS: (e, t) => `/guilds/${e}/role-subscriptions/group-listings${null != t ? `/${t}` : ""}`,
                GUILD_ROLE_SUBSCRIPTION_LISTINGS: (e, t, n) => `/guilds/${e}/role-subscriptions/group-listings/${t}/subscription-listings${null != n ? `/${n}` : ""}`,
                GUILD_ROLE_SUBSCRIPTION_GROUP_LISTING_ARCHIVE: (e, t, n) => `/guilds/${e}/role-subscriptions/group-listings/${t}/subscription-listings/${n}/archive`,
...
<RouteHeader method="POST" url="/guilds/${e}/creator-monetization/remove-monetization">
  Remove Guild Creator Monetization
</RouteHeader>
