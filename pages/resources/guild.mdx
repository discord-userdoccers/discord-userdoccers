...
<RouteHeader method="POST" url="/users/@me/guilds/premium/subscription-slots/{premium_guild_subscription_slot.id}/cancel">
...
<RouteHeader method="POST" url="/users/@me/guilds/premium/subscription-slots/{premium_guild_subscription_slot.id}/uncancel">
