...
| user? ^1^             | partial [user](/resources/user#user-object) object                        | The user who created this join request                                              |
| interview_channel_id  | ?snowflake                                                                | The ID of a channel where an interview regarding this join request may be conducted |

^1^ Only included when fetched from the [Get Guild Join Request](#get-guild-join-request) or [Get Guild Join Requests](#get-guild-join-requests) endpoints, or when receiving a [Guild Join Request Create](/topics/gateway-events#guild-join-request-create)/[Guild Join Request Update](/topics/gateway-events#guild-join-request-update) Gateway event as a moderator.
