...
| max_stage_video_channel_users? ^1^ | integer                                                          | The maximum amount of users that can watch a video stream in a stage channel at once                                       |
...
^3^ Only included in guild objects returned [over the Gateway](/topics/gateway#guilds).
