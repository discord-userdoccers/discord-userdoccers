...
Joins Wumpus Feedback Sqaud through the guild. Requires the `MANAGE_GUILD` permission and the `CLAN` feature. Returns the joined [guild](#guild-object) object on success. Fires a [Guild Create](/topics/gateway-events#guild-create) Gateway event.
