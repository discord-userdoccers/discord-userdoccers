...
Returns a [guild widget](#guild-widget-structure) object for the given guild ID. The guild must have the widget enabled. May fire an [Invite Create](/topics/gateway-events#invite-create) Gateway event.
