...
| connections?                   | array[[onboarding connection](#onboarding-connection-structure) object] | The offering connections                                                                                           |
| responses? ^1^                 | array[snowflake]                                                        | The onboarding prompt option IDs the current user choosed                                                          |
| onboarding_prompts_seen? ^1^   | map[snowflake, integer]                                                 | A mapping of prompt IDs to Unix timestamp (in milliseconds) when the current user have last seen the prompt        |
| onboarding_responses_seen? ^1^ | map[snowflake, integer]                                                 | A mapping of prompt option IDs to Unix timestamp (in milliseconds) when the current user have last seen the option |
...
| provider_id ^2^    | ?string    | The [type of connect](/resources/connected#connection-type)      |
| description        | string     | The connection description                                       |

^1^ Only not null if `connection_type` is `APPLICATION`.

^2^ Only not null if `connection_type` is `PROVIDER_CONNECTED_ACCOUNT`.

###### Onboarding Connection Type

| Value | Name                       | Description                                                                                                    |
| ----- | -------------------------- | -------------------------------------------------------------------------------------------------------------- |
| 0     | APPLICATION                | Onboarding connection is suggesting the user to link the external account that belongs to relevant application |
| 1     | PROVIDER_CONNECTED_ACCOUNT | Onboarding connection is suggesting the user to connect an external account                                    |
...
| onboarding_responses      | array[snowflake]        | The onboarding prompt option IDs the current user choosed                                                          |
| onboarding_prompts_seen   | map[snowflake, integer] | A mapping of prompt IDs to Unix timestamp (in milliseconds) when the current user have last seen the prompt        |
| onboarding_responses_seen | map[snowflake, integer] | A mapping of prompt option IDs to Unix timestamp (in milliseconds) when the current user have last seen the option |
...
Returns the applications that are allowed to be used as onboarding connection.
...
Creates onboarding responses for the current user in the guild. If responses are not empty, returns an [onboarding responses](#onboarding-responses-object) object on success. Otherwise, returns a 204 empty response. May fire a [Guild Member Update](/topics/gateway-events#guild-member-update) Gateway event.

###### JSON Params

| Field                      | Type                    | Description                                                                                                        |
| -------------------------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------ |
| onboarding_responses?      | array[snowflake]        | The onboarding prompt option IDs the current user choosed (max 750)                                                |
| onboarding_prompts_seen?   | map[snowflake, integer] | A mapping of prompt IDs to Unix timestamp (in milliseconds) when the current user have last seen the prompt        |
| onboarding_responses_seen? | map[snowflake, integer] | A mapping of prompt option IDs to Unix timestamp (in milliseconds) when the current user have last seen the option |

<RouteHeader method="PUT" url="/guilds/{guild.id}/onboarding-responses">
  Update Guild Onboarding Responses
</RouteHeader>

Updates onboarding responses for the current user in the guild. If responses are not empty, returns an [onboarding responses](#onboarding-responses-object) object on success. Otherwise, returns a 204 empty response. May fire a [Guild Member Update](/topics/gateway-events#guild-member-update) Gateway event.
