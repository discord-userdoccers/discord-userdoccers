...
| 1 << 4     | IS_GUEST                         | This guild member is a [guest](/resources/invite#guest-invites) and not a true member                                                                                  |
...
| description?                   | ?string                                                             | The description for the guild (max 1000 characters)                                                                        |
| region? **(deprecated)**       | ?string                                                             | The main [voice region](/resources/voice#voice-region-object) ID of the guild                                              |
