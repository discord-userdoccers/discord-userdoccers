...
Modifies the guild's [Welcome Screen](#welcome-screen-object). Requires the `MANAGE_GUILD` permission. Returns the updated [Welcome Screen](#welcome-screen-object) object. May fire a [Guild Update](/topics/gateway-events#guild-update) Gateway event.
