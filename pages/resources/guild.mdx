...
| GUILD_ONLY | 2     | The cheduled event or stage instance is only visible to guild members |
...
| Feature                                          | Description                                                                                                                                                                                                                                                                                    |
| ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ACTIVITIES_ALPHA                                 | Access to alpha embedded activities (`in_development` release phase)                                                                                                                                                                                                                           |
...
| BFG                                              | Big what now 🤨                                                                                                                                                                                                                                                                                |
| ~~BOOSTING_TIERS_EXPERIMENT_MEDIUM_GUILD~~       | ~~Guild requires a reduced amount of premium subscriptions to go up a premium tier~~                                                                                                                                                                                                           |
| ~~BOOSTING_TIERS_EXPERIMENT_SMALL_GUILD~~        | ~~Guild requires a reduced amount of premium subscriptions to go up a premium tier~~                                                                                                                                                                                                           |
...
| ~~SHARD~~                                        | ~~Shards connections to the guild to different nodes~~ (see `RELAY_ENABLED`)                                                                                                                                                                                                                   |
