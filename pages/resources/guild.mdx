...
<RouteHeader method="PUT" url="/guilds/{guild.id}/members/{user.id}/roles/{role.id}" supportsXAuditLogHeader>
...
<RouteHeader method="DELETE" url="/guilds/{guild.id}/members/{user.id}/roles/{role.id}" supportsXAuditLogHeader>
...
<RouteHeader method="DELETE" url="/guilds/{guild.id}/integrations/{integration.id}" supportsXAuditLogHeader>
...
<RouteHeader method="GET" url="/guilds/{guild.id}/widget.json" requestDoesNotRequireAuthorizationHeader>
  Get Guild Widget
</RouteHeader>
...
<RouteHeader method="GET" url="/guilds/{guild.id}/widget.png" requestDoesNotRequireAuthorizationHeader>
