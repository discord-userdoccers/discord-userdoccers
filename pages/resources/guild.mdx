...
| 1 << 10 | AUTOMOD_QUARANTINED_CLAN_TAG    | This guild member has been indefinitely quarantined by [an AutoMod Rule](/resources/auto-moderation#automod-rule-object) for their clan tag; quarantined users, similar to timed out users, are prevented from interacting with the guild in any way                            |
