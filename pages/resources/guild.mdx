...
| 1 << 2 | BYPASSES_VERIFICATION\* | This guild member bypasses guild verification requirements                            |
...
\* Allows a member who does not meet verification requirements to participate in the guild.
