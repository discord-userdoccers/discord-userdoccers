...
\* The presence of these fields is dependent on the endpoint used to retrieve the guild. [Get Guild Emoji] will not return sticker-related fields, and [Get Guild Sticker] will not return emoji-related fields.
