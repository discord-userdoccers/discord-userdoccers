...
\*\* These fields are only sent when using the [Get User Guilds](/resources/user#get-user-guilds) endpoint and are relative to the requested user.
...
| approximate_member_count   | integer                                                    | Approximate number of members in this guild                                                      |
| approximate_presence_count | integer                                                    | Approximate number of online members in this guild                                               |
| emojis?\*                  | array[[emoji](/resources/emoji#emoji-object) object]       | Custom guild emojis; limited to 30 entries                                                       |
| emoji_count?\*             | integer                                                    | Total number of custom guild emojis                                                              |
| stickers?\*                | array[[sticker](/resources/sticker#sticker-object) object] | Custom guild stickers; limited to 30 entries                                                     |
...
\* The presence of these fields is dependent on the endpoint used to retrieve the guild. [Get Emoji Guild](/resources/emoji#get-emoji-guild) will return emoji-related fields, and [Get Sticker Guild](/resources/sticker#get-guild-sticker) will return sticker-related fields.
...
| AUTO_MODERATION                                  | Enables the AutoMod feature                                                                                                                                                                                                                                                                    |
| AUTOMOD_TRIGGER_KEYWORD_FILTER                   | Access to the keyword filter trigger for AutoMod                                                                                                                                                                                                                                               |
| AUTOMOD_TRIGGER_ML_SPAM_FILTER                   | Access to the machine learning-based spam filter trigger for AutoMod                                                                                                                                                                                                                           |
| AUTOMOD_TRIGGER_SPAM_LINK_FILTER                 | Access to the spam link filter trigger for AutoMod                                                                                                                                                                                                                                             |
...
| CHANNEL_HIGHLIGHTS                               | Access to channel highligts                                                                                                                                                                                                                                                                    |
...
| CREATOR_MONETIZABLE_DISABLED                     | Monetization is permanently disabled by Discord                                                                                                                                                                                                                                                |
...
| DISCOVERABLE_DISABLED                            | Discovery is permanently disabled by Discord                                                                                                                                                                                                                                                   |
...
| GUILD_COMMUNICATION_DISABLED_GUILDS              | Access to member timeouts                                                                                                                                                                                                                                                                      |
| GUILD_HOME_DEPRECATION_OVERRIDE                  | Hides the Home tab deprecation notice                                                                                                                                                                                                                                                          |
...
| GUILD_MEMBER_VERIFICATION_EXPERIMENT             | Access to member manual verification                                                                                                                                                                                                                                                           |
...
| GUILD_ROLE_SUBSCRIPTION_PURCHASE_FEEDBACK_LOOP   | Access to [SUPPRESS_ROLE_SUBSCRIPTION_PURCHASE_NOTIFICATIONS, SUPPRESS_ROLE_SUBSCRIPTION_PURCHASE_NOTIFICATIONS_REPLIES system channel flags](#system-channel-flags)                                                                                                                           |
| ~~GUILD_ROLE_SUBSCRIPTION_TRIALS~~\*             | ~~Access to role subscriptions trials~~                                                                                                                                                                                                                                                        |
...
| MARKETPLACES_CONNECTION_ROLES                    | Access to guild linked roles                                                                                                                                                                                                                                                                   |
...
| MEMBER_VERIFICATION_MANUAL_APPROVAL              | Access to membership screening v2                                                                                                                                                                                                                                                              |
| MOBILE_WEB_ROLE_SUBSCRIPTION_PURCHASE_PAGE       | Allows purchasing role subscriptions tiers via web version of Discord on mobile                                                                                                                                                                                                                |
...
| ~~NEW_THREAD_PERMISSIONS~~\*                     | ~~[New thread permissions](https://support.discord.com/hc/en-us/articles/4403205878423-Threads-FAQ#h_01FDGC4JW2D665Y230KPKWQZPN) enabled~~                                                                                                                                                     |
...
| ~~SEVEN_DAY_THREAD_ARCHIVE~~\*                   | ~~Ability to have threads that archive after seven days~~                                                                                                                                                                                                                                      |
| SHARD                                            | Changes [student hub's](https://dis.gd/studenthubs) UI                                                                                                                                                                                                                                         |
...
| SUMMARIES_ENABLED                                | [Conversation summaries](https://support.discord.com/hc/en-us/articles/12926016807575-Conversation-Summaries-AI) enabled                                                                                                                                                                       |
| SUMMARIES_ENABLED_GA                             | [Conversation summaries](https://support.discord.com/hc/en-us/articles/12926016807575-Conversation-Summaries-AI) general access enabled                                                                                                                                                        |
...
| ~~TEXT_IN_STAGE_ENABLED~~\*                      | ~~Access to text in stage (messageable stage channels)~~                                                                                                                                                                                                                                       |
| ~~TEXT_IN_VOICE_ENABLED~~\*                      | ~~Access to text in voice (messageable voice channels)~~                                                                                                                                                                                                                                       |
...
| ~~THREADS_ENABLED~~\*                            | ~~Access to [threads](/topics/threads)~~                                                                                                                                                                                                                                                       |
| THREAD_DEFAULT_AUTO_ARCHIVE_DURATION             |
| ~~THREADS_ONLY_CHANNEL~~\*                       | ~~Access to [forum channels](/topics/threads#forums)~~                                                                                                                                                                                                                                         |
...
| ~~TICKETING_ENABLED~~                            | ~~Access to ticketed scheduled events~~ (see `TICKETED_EVENTS_ENABLED`)                                                                                                                                                                                                                        |
...
| VOICE_CHANNEL_EFFECTS                            | Access to voice channel effects                                                                                                                                                                                                                                                                |
| VOICE_IN_THREADS                                 | Access to voice in threads (calls within threads)                                                                                                                                                                                                                                              |
| WELCOME_SCREEN_ENABLED                           | Welcome screen enabled                                                                                                                                                                                                                                                                         |

\* This is now a base feature, and the guild feature has no effect if still present.
...
| DISCOVERABLE\*                       | Whether the guild is public and discoverable in the directory | `ADMINISTRATOR`      |
| INVITES_DISABLED                     | Whether joining the guild is disabled                         | `MANAGE_GUILD`       |
| MEMBER_VERIFICATION_GATE_ENABLED\*\* | Whether the member verification gate is enabled               | `MANAGE_GUILD`       |
| RAID_ALERTS_DISABLED                 | Whether raid alerts are opted out                             | `MANAGE_GUILD`       |

\* Guild must also pass all discovery requirements in order to set.

\*\* Feature is only removable, not settable.
...
| user?\*                | partial [user](/resources/user#user-object) object           | User for this integration                                                       |
...
Creates a new guild. Returns a [guild](#guild-object) object on success. Fires a [Guild Create](/topics/gateway#guild-create) Gateway event.
...
Modifies a guild's settings. Requires the `MANAGE_GUILD` permission. Returns the updated [guild](#guild-object) object on success. Fires a [Guild Update](/topics/gateway#guild-update) Gateway event.
...
Deletes a guild permanently. User must be owner. Returns `204 No Content` on success. Fires a [Guild Delete](/topics/gateway#guild-delete) Gateway event.
...
Modifies the positions of a set of [channel](/resources/channel#channel-object) objects for the guild. Requires `MANAGE_CHANNELS` permission. Returns a 204 empty response on success. Fires multiple [Channel Update](/topics/gateway#channel-update) Gateway events.
...
Modifies attributes of a [guild member](#guild-member-object). Returns a 200 OK with the [guild member](#guild-member-object) as the body. Fires a [Guild Member Update](/topics/gateway#guild-member-update) Gateway event. If the `channel_id` is set to null, this will force the target user to be disconnected from voice.
...
Removes a member from a guild. Requires `KICK_MEMBERS` permission. Returns a 204 empty response on success. Fires a [Guild Member Remove](/topics/gateway#guild-member-remove) Gateway event.
...
Creates a guild ban, and optionally deletes previous messages sent by the banned user. Requires the `BAN_MEMBERS` permission. Returns a 204 empty response on success. Fires a [Guild Ban Add](/topics/gateway#guild-ban-add) Gateway event.
...
Removes the ban for a user. Requires the `BAN_MEMBERS` permissions. Returns a 204 empty response on success. Fires a [Guild Ban Remove](/topics/gateway#guild-ban-remove) Gateway event.
...
Creates a new [role](/topics/permissions#role-object) for the guild. Requires the `MANAGE_ROLES` permission. Returns the new [role](/topics/permissions#role-object) object on success. Fires a [Guild Role Create](/topics/gateway#guild-role-create) Gateway event. All JSON params are optional.
...
Modifies a guild role. Requires the `MANAGE_ROLES` permission. Returns the updated [role](/topics/permissions#role-object) on success. Fires a [Guild Role Update](/topics/gateway#guild-role-update) Gateway event.
...
Deletes a guild role. Requires the `MANAGE_ROLES` permission. Returns a 204 empty response on success. Fires a [Guild Role Delete](/topics/gateway#guild-role-delete) Gateway event.
