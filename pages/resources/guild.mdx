...
| 1 << 11 | FAVORITED             | TODO        |
| 1 << 12 | OPT_IN_ENABLED        | TODO        |
| 1 << 13 | NEW_FORUM_THREADS_OFF | TODO        |
| 1 << 14 | NEW_FORUM_THREADS_ON  | TODO        |
...
<RouteHeader method="PATCH" url="/users/@me/guilds/@me/settings">
  Modify User Guild Settings
</RouteHeader>

Modifies user guild's settings. Accepts [partial user guild settings](#partial-user-guild-settings) object. Returns [user guild settings](#user-guild-settings-object) object on success. Fires [User Guild Settings Update](/topics/gateway-events#user-guild-settings-update) Gateway event.
