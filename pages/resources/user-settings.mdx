...
<RouteHeader
  method="POST"
  url="/users/@me/notification-settings/snapshots/{notification_settings_snapshot.id}/restore-guilds"
>
...
<RouteHeader method="GET" url="/users/@me/notification-settings/snapshots/{notification_settings_snapshot.id}">
