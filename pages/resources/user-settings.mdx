...
| Value   | Name                  | Description                                             |
| ------- | --------------------- | ------------------------------------------------------- |
| 1 << 9  | UNREADS_ONLY_MENTIONS | Whether the channel should be unread on mentions        |
| 1 << 10 | UNREADS_ALL_MESSAGES  | Whether the channel should be unread on new messages    |
...
^1^ May be integer in very rare cases.
...
| Value   | Name                  | Description                                        |
| ------- | --------------------- | -------------------------------------------------- |
| 1 << 11 | UNREADS_ALL_MESSAGES  | Whether the guild should be unread on new messages |
| 1 << 12 | UNREADS_ONLY_MENTIONS | Whether the guild should be unread on mentions     |
