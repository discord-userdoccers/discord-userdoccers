...
Modifies a guild's settings. Accepts a [partial user guild settings](#partial-user-guild-settings-object) object. Returns [user guild settings](#user-guild-settings-object) object on success. Fires a [User Guild Settings Update](/topics/gateway-events#user-guild-settings-update) Gateway event.
...
| Field  | Type                                                                                      | Description                       |
| ------ | ----------------------------------------------------------------------------------------- | --------------------------------- |
| guilds | map[snowflake, [partial user guild settings](#partial-user-guild-settings-object) object] | The user guild settings to modify |
