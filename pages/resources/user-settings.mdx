...
<Alert type="info">
  Protobuf user settings are not yet documented here. Refer to [this
  repository](https://github.com/dolfies/discord-protos) for the data structures.
</Alert>
...
| custom_status                                  | ?[custom status](#legacy-custom-status-object) object     | The custom status of the user, used to sync presence across clients                                            |
