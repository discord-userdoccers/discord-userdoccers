...
^2^ Not available in the [Ready](/resources/gateway-events#ready) event in OAuth2 contexts.

^3^ Only available in the [Ready](/resources/gateway-events#ready) event in OAuth2 contexts.
