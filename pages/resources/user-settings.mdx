...
Returns the requester's [user settings](#legacy-user-settings-object) object.
...
| revoke | array[string] | The [consent types](#consent-types) to revoke |
...
| Field    | Type                                             | Description                  |
| -------- | ------------------------------------------------ | ---------------------------- |
| settings | partial [email settings](#email-settings-object) | The email settings to modify |
