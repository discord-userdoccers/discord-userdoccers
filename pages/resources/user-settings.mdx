...
If id is missing, guild_ids will be single element array, and this should be considered position of guild instead.
...
<RouteHeader method="PATCH" url="/users/@me/settings">
