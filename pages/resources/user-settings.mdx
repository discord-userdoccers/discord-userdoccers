...
| slayer_sdk_receive_dms_in_game ^2^             | integer                                                      | Setting for [receiving in-game DMs](/resources/user-settings-proto#slayer-sdk-receive-in-game-dms) via the social layer SDK | `activities.read` or `presences.read` |
...
^2^ Not available in [OAuth2 Ready](/resources/gateway-events#oauth2-ready-structure).

^3^ Only available in [OAuth2 Ready](/resources/gateway-events#oauth2-ready-structure).
