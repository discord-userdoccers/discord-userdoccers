...
Modifies the requester's user settings. Returns a [user settings](#legacy-user-settings-object) object on success. Fires a [User Settings Update](/topics/gateway-events#user-settings-update) Gateway event.
