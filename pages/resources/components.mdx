...
| ------ | --------------------------------------------------- | ---------------------------------------------------------- | ----------- | -------------- |
| 1      | [Action Row](#action-row)                           | A container for other components                           | Layout      | Message, Modal |
...
| 5      | [User Select](#user-select)                         | Select menu for users                                      | Interactive | Message        |
| 6      | [Role Select](#role-select)                         | Select menu for roles                                      | Interactive | Message        |
| 7      | [Mentionable Select](#mentionable-select)           | Select menu for mentionables (users *and* roles)           | Interactive | Message        |
| 8      | [Channel Select](#channel-select)                   | Select menu for channels                                   | Interactive | Message        |
