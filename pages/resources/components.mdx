...
| members?  | map[snowflake, partial [guild member](/resources/guild#guild-member-object) object] | Selected members, without the [`user`](/resources/user#user-object) key |
