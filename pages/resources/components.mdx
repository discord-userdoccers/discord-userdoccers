...
| 20    | [CHECKPOINT_CARD](#checkpoint-card) ^2^                 | Displays a checkpoint                                          | Content     | Message                         |
...
A Checkpoint Card is a top-level component that displays statistics collected in a year.
...
| num_messages_sent      | integer                                                          | Count of messages that the user sent for year                                 |
| total_voice_minutes    | float                                                            | Duration in seconds how much time the user spent in voice channels for year   |
| num_emojis_sent        | integer                                                          | Count of emojis that the user sent for year (includes messages and reactions) |
