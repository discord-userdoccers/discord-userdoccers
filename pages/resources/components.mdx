...
| file_types? | array[string] ^1^ | The dotted file extensions permitted to be uploaded (max 10)        |

^1^ Supported values are the file group keywords `image`, `audio`, and `video`, or any dot-prefixed file extension such as `.pdf`.
