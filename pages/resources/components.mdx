...
| 21    | [RADIO_GROUP](#radio-group)                             | Component to select single option from developer-defined set    | Interactive | Modal                           |
| 22    | [CHECKBOX_GROUP](#checkbox-group)                       | Component to select multiple options from developer-defined set | Interactive | Modal                           |
| 23    | [CHECKBOX](#checkbox)                                   | Component to answer "Yes" or "No"                               | Interactive | Modal                           |
...
Radio Group is an interactive component that allows users to select single option from developer-defined set.
...
| options         | array[[radio group option](#radio-group-option-structure) object] | Specified choices in a radio group (min 2, max 10)                  |
| required?       | boolean                                                           | Whether the user must select an option (default false)              |
...
Checkbox Group is an interactive component that allows users to select multiple options from developer-defined set.
...
| options         | array[[checkbox group option](#checkbox-group-option-structure) object] | Specified choices in a checkbox group (min 2, max 10)                  |
| min_values?     | integer                                                                 | Minimum number of boxes that must be checked (max 10, default 1)       |
| max_values?     | integer                                                                 | Minimum number of boxes that can be checked (1-10)                     |
| required?       | boolean                                                                 | Whether the user must select an option (default false)                 |
...
Checkbox is an interactive component that allows to simply answer "Yes" or "No".
