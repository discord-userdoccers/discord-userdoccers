...
| required? ^1^ | boolean                                                 | Whether this component is required to be filled (default true)        |
...
| label ^1^    | string  | Label for this component (max 45 characters)                       |
...
^1^ Ignored and not required within [`LABEL`](#label) components.
...
| component    | [component](#component-object) object | Inner component of the type [text input](#text-input), [user select](#user-select), [role select](#role-select), [mentionable select](#mentionable-select), or [channel select](#channel-select) |
