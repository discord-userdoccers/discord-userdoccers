...
Additionally, if the current user is a member of any student hubs, any guilds that are part of the student hub are also considered discoverable relative to the user.
