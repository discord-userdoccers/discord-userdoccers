...
| badge                        | integer                                                          | The [clan badge shown on the guild's tag](#guild-badge-type)                |
...
| badge_hash                   | string                                                           | The guild's [clan badge hash](/reference#cdn-formatting)                    |
...
| brand_color_primary?      | string                                              | The guild's accent color as a hexadecimal color string                                         |
| game_application_ids?     | array[snowflake]                                    | The IDs of the applications representing the games the guild plays (max 20)                    |
| tag? ^1^                  | ?string                                             | The clan tag of the guild (2-4 characters)                                                     |
| badge ^1^                 | integer                                             | The [clan badge shown on the guild's tag](#guild-badge-type)                                   |
