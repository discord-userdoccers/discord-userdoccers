...
| Field          | Type       | Description                                     |
| -------------- | ---------- | ----------------------------------------------- |
| emoji_id       | ?snowflake | The ID of the emoji associated with the trait   |
...
^1^ Only standard Unicode emoji names are accepted; custom guild emoji are not supported and will result in a `GUILD_PROFILE_NO_CUSTOM_EMOJI` error
