...
Returns information about a guild's landing web page or monetization store page for the given guild ID. This endpoint requires the guild to be indexable (be discoverable and [published](#discovery-metadata-object) OR have the `CREATOR_STORE_PAGE` [guild feature](/resources/guild#guild-features)).
