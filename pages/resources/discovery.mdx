...
<RouteHeader method="GET" url="/discovery/{guild.id}/clan">
  Guild Clan Discovery Info
</RouteHeader>

Returns a [clan](/resources/clan#clan-object) object associated with a guild if it has one. This does not require the guild to be discoverable.
