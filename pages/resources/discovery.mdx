...
| keywords                   | ?array[string]                                                | The discovery search keywords for the guild (max 10, max 30 characters)                          |
...
| social_links? ^2^          | ?array[string]                                                | The guild's social media links shown in the discovery web page (max 9, max 256 characters)       |
...
| social_links                  | ?array[string]                                                | The guild's social media links shown in the discovery web page (max 9, max 256 characters) |
