...
| 5     | ERROR_VERIFICATION_DOCUMENT_INVALID            | The submitted document is invalid or does not meet verification criteria            |
| 6     | ERROR_VERIFICATION_UNEXPECTED_DOCUMENT_COUNTRY | The submitted document issuing country does not match expected or allowed countries |
| 7     | ERROR_VERIFICATION_UNEXPECTED_DOCUMENT_TYPE    | The submitted document type is not supported                                        |
...
| 10    | ERROR_VERIFICATION_SCAN_ID_TYPE_NOT_SUPPORTED  | The ID type scanned is not supported by the verification system                     |
| 11    | ERROR_VERIFICATION_SCAN_CORRUPT                | The scan is incomplete or corrupted                                                 |
| 12    | ERROR_VERIFICATION_SCAN_FAILED_COPY            | The verification system failed to copy or process the scanned document              |
| 13    | ERROR_VERIFICATION_SCAN_MANIPULATED_DOCUMENT   | The verification system determined the document was manipulated or tampered with    |
| 14    | ERROR_VERIFICATION_SCAN_FAILED_GRAYSCALE       | The scan failed the grayscale check needed for verification                         |
