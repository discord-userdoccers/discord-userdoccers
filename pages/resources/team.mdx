...
Modifies a team member. User must be the owner of the team. Returns the updated [team member](#team-member-object) object on success.
...
Removes a team member. User must be the owner of the team unless removing yourself. Returns a 204 empty response on success.
