...
| members? **(deprecated)** ^1^ | array[[partial rpc guild member](#partial-rpc-guild-member-object) object] | The non-offline guild members (max 100)  |
...
| Field    | Type                                                     | Description                                                 |
| -------- | -------------------------------------------------------- | ----------------------------------------------------------- |
| status   | string                                                   | The [status](/resources/presences#status-type) of the user  |
| activity | ?[activity](/resources/presences#activity-object) object | The user's activity associated with the current application |
...
| SET_USER_VOICE_SETTINGS_2                                                                         | Same as `SET_USER_VOICE_SETTINGS`, but without authentication                                   |                                                                                     | HTTP, or IPC                       |
| PUSH_TO_TALK                                                                                      | Used to enable or disable push-to-talk functionality                                            | `rpc`, and `rpc.voice.write`                                                        |                                    |
| SELECT_VOICE_CHANNEL                                                                              | Used to join or leave a voice channel, group DM, or DM                                          | `rpc`                                                                               |                                    |
| GET_SELECTED_VOICE_CHANNEL                                                                        | Used to get the current voice channel the client is in                                          | `rpc`, or `rpc.voice.read`                                                          |                                    |
| SELECT_TEXT_CHANNEL                                                                               | Used to join or leave a text channel, group DM, or DM                                           | `rpc`                                                                               |                                    |
...
| SET_VOICE_SETTINGS_2                                                                              | Same as `SET_VOICE_SETTINGS`, but without authentication                                        |                                                                                     | HTTP, or IPC                       |
...
| USER_SETTINGS_GET_LOCALE                                                                          | Retrieves the client’s locale, i.e. `en-US`                                                     |                                                                                     | HTTP, or IPC                       |
...
[GET_CHANNEL](#get-channel)                                                                       | Used to retrieve channel information from the client
[GET_CHANNELS](#get-channels)                                                                     | Used to retrieve a list of channels for a guild from the client
...
Used to create an invite link for a given channel. Responds with a [invite](/resources/invite#invite-object) object (with [invite metadata](/resources/invite#invite-metadata-object) object).
