...
For connections to the RPC server, a [list of approved testers](/topics/rpc/authorize) is used to restrict access while you're still developing. You can invite up to 50 people.
...
| ----- | ------ | ---------------------------------------------------------------- | -------------------------------------------------------- |
| cmd   | enum   | [payload command](/topics/rpc/commands-and-events-rpc-commands)  | Always                                                   |
| nonce | string | unique string used once for replies from the server              | In responses to commands (not subscribed events)         |
| evt   | enum   | [subscription event](/topics/rpc/commands-and-events-rpc-events) | In subscribed events, errors, and (un)subscribing events |
...
In order to call any commands over RPC, you must be authenticated or you will receive a code `4006` error response. Thankfully, we've removed the oppressive nature of a couple commands that will let you `AUTHORIZE` and `AUTHENTICATE` new users. First, call [AUTHORIZE](/topics/rpc/authorize):
...
| Name                                                              | Description                                                     |
| ----------------------------------------------------------------- | --------------------------------------------------------------- |
| [DISPATCH](/topics/rpc/events)                                    | event dispatch                                                  |
| [AUTHORIZE](/topics/rpc/authorize)                                | used to authorize a new client with your app                    |
| [AUTHENTICATE](/topics/rpc/authenticate)                          | used to authenticate an existing client with your app           |
| [GET_GUILD](/topics/rpc/getguild)                                 | used to retrieve guild information from the client              |
| [GET_GUILDS](/topics/rpc/getguilds)                               | used to retrieve a list of guilds from the client               |
| [GET_CHANNEL](/topics/rpc/getchannel)                             | used to retrieve channel information from the client            |
| [GET_CHANNELS](/topics/rpc/getchannels)                           | used to retrieve a list of channels for a guild from the client |
| [SUBSCRIBE](/topics/rpc/subscribe)                                | used to subscribe to an RPC event                               |
| [UNSUBSCRIBE](/topics/rpc/unsubscribe)                            | used to unsubscribe from an RPC event                           |
| [SET_USER_VOICE_SETTINGS](/topics/rpc/setuservoicesettings)       | used to change voice settings of users in voice channels        |
| [SELECT_VOICE_CHANNEL](/topics/rpc/selectvoicechannel)            | used to join or leave a voice channel, group dm, or dm          |
| [GET_SELECTED_VOICE_CHANNEL](/topics/rpc/getselectedvoicechannel) | used to get the current voice channel the client is in          |
| [SELECT_TEXT_CHANNEL](/topics/rpc/selecttextchannel)              | used to join or leave a text channel, group dm, or dm           |
| [GET_VOICE_SETTINGS](/topics/rpc/getvoicesettings)                | used to retrieve the client's voice settings                    |
| [SET_VOICE_SETTINGS](/topics/rpc/setvoicesettings)                | used to set the client's voice settings                         |
| [SET_CERTIFIED_DEVICES](/topics/rpc/setcertifieddevices)          | used to send info about certified hardware devices              |
| [SET_ACTIVITY](/topics/rpc/setactivity)                           | used to update a user's Rich Presence                           |
| [SEND_ACTIVITY_JOIN_INVITE](/topics/rpc/sendactivityjoininvite)   | used to consent to a Rich Presence Ask to Join request          |
| [CLOSE_ACTIVITY_REQUEST](/topics/rpc/closeactivityrequest)        | used to reject a Rich Presence Ask to Join request              |
...
| Name                                                                               | Description                                                                                |
| ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| [READY](/topics/rpc/ready)                                                         | non-subscription event sent immediately after connecting, contains server information      |
| [ERROR](/topics/rpc/error)                                                         | non-subscription event sent when there is an error, including command responses            |
| [GUILD_STATUS](/topics/rpc/guildstatus)                                            | sent when a subscribed server's state changes                                              |
| [GUILD_CREATE](/topics/rpc/guildcreate)                                            | sent when a guild is created/joined on the client                                          |
| [CHANNEL_CREATE](/topics/rpc/channelcreate)                                        | sent when a channel is created/joined on the client                                        |
| [VOICE_CHANNEL_SELECT](/topics/rpc/voicechannelselect)                             | sent when the client joins a voice channel                                                 |
| [VOICE_STATE_CREATE](/topics/rpc/voicestatecreatevoicestateupdatevoicestatedelete) | sent when a user joins a subscribed voice channel                                          |
| [VOICE_STATE_UPDATE](/topics/rpc/voicestatecreatevoicestateupdatevoicestatedelete) | sent when a user's voice state changes in a subscribed voice channel (mute, volume, etc.)  |
| [VOICE_STATE_DELETE](/topics/rpc/voicestatecreatevoicestateupdatevoicestatedelete) | sent when a user parts a subscribed voice channel                                          |
| [VOICE_SETTINGS_UPDATE](/topics/rpc/voicesettingsupdate)                           | sent when the client's voice settings update                                               |
| [VOICE_CONNECTION_STATUS](/topics/rpc/voiceconnectionstatus)                       | sent when the client's voice connection status changes                                     |
| [SPEAKING_START](/topics/rpc/speakingstartspeakingstop)                            | sent when a user in a subscribed voice channel speaks                                      |
| [SPEAKING_STOP](/topics/rpc/speakingstartspeakingstop)                             | sent when a user in a subscribed voice channel stops speaking                              |
| [MESSAGE_CREATE](/topics/rpc/messagecreatemessageupdatemessagedelete)              | sent when a message is created in a subscribed text channel                                |
| [MESSAGE_UPDATE](/topics/rpc/messagecreatemessageupdatemessagedelete)              | sent when a message is updated in a subscribed text channel                                |
| [MESSAGE_DELETE](/topics/rpc/messagecreatemessageupdatemessagedelete)              | sent when a message is deleted in a subscribed text channel                                |
| [NOTIFICATION_CREATE](/topics/rpc/notificationcreate)                              | sent when the client receives a notification (mention or new message in eligible channels) |
| [ACTIVITY_JOIN](/topics/rpc/activityjoin)                                          | sent when the user clicks a Rich Presence join invite in chat to join a game               |
| [ACTIVITY_SPECTATE](/topics/rpc/activityspectate)                                  | sent when the user clicks a Rich Presence spectate invite in chat to spectate a game       |
| [ACTIVITY_JOIN_REQUEST](/topics/rpc/activityjoinrequest)                           | sent when the user receives a Rich Presence Ask to Join request                            |
...
| --------- | ----------------------------------------------- | ------------------------------------------------------------------------- |
| scopes    | array of [OAuth2 scopes](/topics/oauth2/scopes) | scopes to authorize                                                       |
...
| Field       | Type                                                                               | Description                     |
| ----------- | ---------------------------------------------------------------------------------- | ------------------------------- |
| user        | partial [user](/resources/user/user-object) object                                 | the authed user                 |
| scopes      | array of [OAuth2 scopes](/topics/oauth2/scopes)                                    | authorized scopes               |
| expires     | date                                                                               | expiration date of OAuth2 token |
| application | [OAuth2 application](/topics/rpc/authenticate-oauth2-application-structure) object | application the user authorized |
...
| Field  | Type                                                            | Description               |
| ------ | --------------------------------------------------------------- | ------------------------- |
| guilds | array of partial [guild](/resources/guild/guild-object) objects | the guilds the user is in |
...
| members  | array of [guild member](/resources/guild/guild-member-object) objects | members of the guild (deprecated; always empty array) |
...
| voice_states | array of [voice state](/resources/voice/voice-state-object) objects | (voice) channel's voice states                                   |
| messages     | array of [message](/resources/channel/message-object) objects       | (text) channel's messages                                        |
...
| Field    | Type                                                                  | Description                   |
| -------- | --------------------------------------------------------------------- | ----------------------------- |
| channels | array of partial [channel](/resources/channel/channel-object) objects | guild channels the user is in |
...
| pan?    | [pan](/topics/rpc/set-user-voice-settings-pan-object) object | set the pan of the user                                  |
...
Used to join and leave voice channels, group dms, or dms. Returns the [Get Channel](/topics/rpc/get-channel) response, `null` if none.
...
Used to get the client's current voice channel. There are no arguments for this command. Returns the [Get Channel](/topics/rpc/get-channel) response, or `null` if none.

#### SELECT_TEXT_CHANNEL

Used to join and leave text channels, group dms, or dms. Returns the [Get Channel](/topics/rpc/get-channel) response, or `null` if none.
...
| Field                  | Type                                                                                        | Description                       |
| ---------------------- | ------------------------------------------------------------------------------------------- | --------------------------------- |
| input                  | [voice settings input](/topics/rpc/get-voice-settings-voice-settings-input-object) object   | input settings                    |
| output                 | [voice settings output](/topics/rpc/get-voice-settings-voice-settings-output-object) object | output settings                   |
| mode                   | [voice settings mode](/topics/rpc/get-voice-settings-voice-settings-mode-object) object     | voice mode settings               |
...
| shortcut       | [shortcut key combo](/topics/rpc/shortcut-key-combo-object) object | shortcut key combos for PTT                                         |
...
| Field | Type    | Description                                                      |
| ----- | ------- | ---------------------------------------------------------------- |
| type  | integer | see [key types](/topics/rpc/shortcut-key-combo-object-key-types) |
...
| Field   | Type                                                                                 | Description                                                   |
| ------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------- |
| devices | array of [certified device](/topics/rpc/set-certified-devices-device-object) objects | a list of devices for your manufacturer, in order of priority |

###### Device Object

| Field                     | Type                                                             | Description                                              |
| ------------------------- | ---------------------------------------------------------------- | -------------------------------------------------------- |
| type                      | [device type](/topics/rpc/set-certified-devices-device-type)     | the type of device                                       |
| id                        | string                                                           | the device's Windows UUID                                |
| vendor                    | [vendor](/topics/rpc/set-certified-devices-vendor-object) object | the hardware vendor                                      |
| model                     | [model](/topics/rpc/set-certified-devices-model-object) object   | the model of the product                                 |
...
| activity | [activity](/topics/gateway/activity-object) object | the rich presence to assign to the user |
...
| config | [rpc server configuration](/topics/rpc/ready-rpc-server-configuration-object) object | server configuration               |
| user   | partial [user](/resources/user/user-object) object                                   | the user to whom you are connected |
...
| Field  | Type                                                  | Description                                            |
| ------ | ----------------------------------------------------- | ------------------------------------------------------ |
| guild  | partial [guild](/resources/guild/guild-object) object | guild with requested id                                |
...
No arguments. Dispatches the [Get Voice Settings](/topics/rpc/get-voice-settings) response.
...
No arguments. This event requires the `rpc.notifications.read` [OAuth2 scope](/topics/oauth2/shared-resources-oauth2-scopes).
...
| message    | [message](/resources/channel/message-object) object | message that generated this notification  |
...
| Field  | Type   | Description                                                                                                      |
| ------ | ------ | ---------------------------------------------------------------------------------------------------------------- |
| secret | string | the [`join_secret`](/rich-presence/how-to/updating-presence-update-presence-payload-fields) for the given invite |
...
| Field  | Type   | Description                                                                                                          |
| ------ | ------ | -------------------------------------------------------------------------------------------------------------------- |
| secret | string | the [`spectate_secret`](/rich-presence/how-to/updating-presence-update-presence-payload-fields) for the given invite |
...
| Field | Type                                               | Description                                   |
| ----- | -------------------------------------------------- | --------------------------------------------- |
| user  | partial [user](/resources/user/user-object) object | information about the user requesting to join |
