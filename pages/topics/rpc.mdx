...
| messages     | array of [message](/resources/message#message-object) objects       | (text) channel's messages                                        |
...
| message    | [message](/resources/message#message-object) object | message that generated this notification  |
