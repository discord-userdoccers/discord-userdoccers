...
| Opcode                                                                         | Rate Limit                                     |
| ------------------------------------------------------------------------------ | ---------------------------------------------- |
| [Opcode 8 Request Guild Members](/topics/gateway-events#request-guild-members) | 1 request per guild per session per 30 seconds |

If a client exceeds an Opcode-specific rate limit, the Gateway will respond with a [Rate Limited](/topics/gateway-events#rate-limited) event.
