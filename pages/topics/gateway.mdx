...
| 1 << 16 | AUTO_LOBBY_CONNECT                    | Adds `lobbies` field to [Ready](/topics/gateway-events#ready) event containing pre-existing lobbies, and stops sending [Lobby Create](/topics/gateway-events#lobby-create) upon connecting to the Gateway                                                                                                                                      |
