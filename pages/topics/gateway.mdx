...
Additionally, every 30 minutes and on gateway connect an [Opcode 41 Update Time Spent Session ID](/topics/gateway-events#update-time-spent-session-id) event should be sent.
