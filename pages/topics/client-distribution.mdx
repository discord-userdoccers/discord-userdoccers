...
^1^ This field is only provided via the above rehosted updates endpoint. If this field is `null`, clients are expected to generate it themselves.
{/* TODO: How is it generated? */}
