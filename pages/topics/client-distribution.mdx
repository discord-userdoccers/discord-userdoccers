...
This minimum version check is available at `https://dl.discordapp.net/apps/android/versions.json`. The response contains a single `discord_android_min_version` field, which is a string containing the minimum version.
