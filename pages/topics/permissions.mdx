...
| KICK_MEMBERS ^1^                        | `0x0000000000000002` `(1 << 1)`  | Allows kicking members                                                                                                                              |              |
| BAN_MEMBERS ^1^                         | `0x0000000000000004` `(1 << 2)`  | Allows banning members                                                                                                                              |              |
| ADMINISTRATOR ^1^                       | `0x0000000000000008` `(1 << 3)`  | Allows all permissions and bypasses channel permission overwrites                                                                                   |              |
| MANAGE_CHANNELS ^1^                     | `0x0000000000000010` `(1 << 4)`  | Allows management and editing of channels                                                                                                           | T, V, S      |
| MANAGE_GUILD ^1^                        | `0x0000000000000020` `(1 << 5)`  | Allows management and editing of the guild                                                                                                          |              |
...
| MANAGE_MESSAGES ^1^                     | `0x0000000000002000` `(1 << 13)` | Allows for deletion of other users messages                                                                                                         | T, V         |
...
| MANAGE_ROLES ^1^                        | `0x0000000010000000` `(1 << 28)` | Allows management and editing of roles                                                                                                              | T, V, S      |
| MANAGE_WEBHOOKS ^1^                     | `0x0000000020000000` `(1 << 29)` | Allows management and editing of webhooks                                                                                                           | T, V         |
| MANAGE_EXPRESSIONS ^1^ ^3^              | `0x0000000040000000` `(1 << 30)` | Allows editing and deleting emojis, stickers, and soundboard sounds                                                                                 |              |
...
| MANAGE_EVENTS ^3^                       | `0x0000000200000000` `(1 << 33)` | Allows for editing and deleting scheduled events                                                                                                    | V, S         |
| MANAGE_THREADS ^1^                      | `0x0000000400000000` `(1 << 34)` | Allows for deleting and archiving threads, and viewing all private threads                                                                          | T            |
...
| MODERATE_MEMBERS ^2^                    | `0x0000010000000000` `(1 << 40)` | Allows for timing out users to prevent them from sending or reacting to messages in chat and threads, and from speaking in voice and stage channels |              |
| VIEW_CREATOR_MONETIZATION_ANALYTICS ^1^ | `0x0000020000000000` `(1 << 41)` | Allows for viewing guild role subscriptions insights                                                                                                |              |
| USE_SOUNDBOARD                          | `0x0000040000000000` `(1 << 42)` | Allows the usage of the soundboard in a voice channel                                                                                               | V            |
| CREATE_EXPRESSIONS ^3^                  | `0x0000080000000000` `(1 << 43)` | Allows for creating emojis, stickers, and soundboard sounds, and editing/deleting ones created by the current user                                  |              |
| CREATE_EVENTS ^3^                       | `0x0000100000000000` `(1 << 44)` | Allows for creating scheduled events, and editing/deleting ones created by the current user                                                         |
| USE_EXTERNAL_SOUNDS                     | `0x0000040000000000` `(1 << 45)` | Allows the usage of custom soundboard sounds from other servers                                                                                     | V            |
| SEND_VOICE_MESSAGES                     | `0x0000400000000000` `(1 << 46)` | Allows for sending voice messages in a channel                                                                                                      | T, V, S      |
| USE_CLYDE_AI                            | `0x0000800000000000` `(1 << 47)` | Allows members to interact with the Clyde AI integration                                                                                            | T, V, S      |
...
^1^ These permissions require the owner account to use [multi-factor authentication](/topics/oauth2#multi-factor-authentication-requirement) when used on a guild that has guild-wide MFA enabled.
