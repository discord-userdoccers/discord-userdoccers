...
| MANAGE_EXPRESSIONS ^1^                  | `0x0000000040000000` `(1 << 30)` | Allows management and editing of emojis, stickers and soundboard sounds                                                                             |              |
...
| VIEW_CREATOR_MONETIZATION_ANALYTICS ^1^ | `0x0000020000000000` `(1 << 41)` | Allows for viewing guild creator monetization insights                                                                                              |              |
| USE_SOUNDBOARD                          | `0x0000040000000000` `(1 << 42)` | Allows for using soundboard in a voice channel                                                                                                      | V            |
| CREATE_EXPRESSIONS                      | `0x0000080000000000` `(1 << 43)` | Allows for creating new guild emojis, stickers, soundboard sounds                                                                                   |              |
| CREATE_EVENTS                           | `0x0000100000000000` `(1 << 44)` | Allows for creating new guild events                                                                                                                |              |
| USE_EXTERNAL_SOUNDS                     | `0x0000200000000000` `(1 << 45)` | Allows for using external soundboard sounds in a guild                                                                                              | V            |
| SEND_VOICE_MESSAGES                     | `0x0000400000000000` `(1 << 46)` | the usage of custom soundboard sounds from other servers                                                                                            | T, V, S      |

^1^ These permissions require the owner account to use [two-factor authentication](/topics/oauth2#twofactor-authentication-requirement) when used on a guild that has server-wide 2FA enabled.

^2^ See [Permissions for Timed Out Members](/topics/permissions#permissions-for-timed-out-members) to understand how permissions are temporarily modified for timed out users.
...
| icon?          | ?string                                                                 | The role's [icon hash](/reference#image-formatting)             |
...
| tags?          | [role tags](/topics/permissions#role-object-role-tags-structure) object | The tags this role has                                          |

###### Role Flags

| Value  | Name      | Description                                                                                              |
| ------ | --------- | -------------------------------------------------------------------------------------------------------- |
| 1 << 0 | IN_PROMPT | This role is part of an [onboarding prompt option](/resources/guilds#onboarding-prompt-option-structure) |
