...
^1^ These permissions require the owner account to use [two-factor authentication](/topics/oauth2#twofactor-authentication-requirement) when used on a guild that has guild-wide MFA enabled.
