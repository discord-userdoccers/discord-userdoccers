...
Timed out members will temporarily lose all permissions except `VIEW_CHANNEL` and `READ_MESSAGE_HISTORY`. This also applies to quarantined members. Owners and users with the `ADMINISTRATOR` permission are exempt.
