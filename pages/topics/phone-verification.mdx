...
After the user receives the code, clients must then use the [Verify Phone](#verify-phone-number) endpoint with the phone number and the code to receive a phone verification token.
