...
| ------------------------- | -------------------------------------- | -------------------------------------------------------- |
| type                      | [device type](#models-device-type)     | the type of device                                       |
| id                        | string                                 | the device's Windows UUID                                |
| vendor                    | [vendor](#models-vendor-object) object | the hardware vendor                                      |
| model                     | [model](#models-model-object) object   | the model of the product                                 |
