...
| [Voice Backend Version](#voice-backend-version) | Request the current voice backend version |
...
| [Resumed](#resumed)                                   | Acknowledges a successful connection resume                                                              |
...
| [Voice Backend Version](#voice-backend-version)       | Current voice backend version information, as requested by the client                                    |
