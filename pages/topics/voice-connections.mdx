...
Audio and video from a stream require a separate connection to another voice server, using the same process described below. Only microphone and camera data are sent over the first connection.
