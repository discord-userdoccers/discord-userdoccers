...
^2^ For backwards compatibility, the payload type of the opus codec defaults to `120` when codecs are not specified. No payload type should be set to `96`, as it is reserved for probe packets.
