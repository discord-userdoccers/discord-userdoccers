...
^1^ Currently, this field is ignored and the only type supported is `video`.
...
This is only available on [Gateway version 5 and above](#gateway-versions).
...
This is only available on [Gateway version 6 and above](#gateway-versions).
