...
However, having the `MANAGE_CHANNELS` permission allows an additional __one__ user to join the channel (i.e. moderators have a limit of `max_video_channel_users + 1`).
