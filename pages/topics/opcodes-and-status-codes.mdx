...
| 4001 | Unknown opcode        | You sent an invalid [Gateway opcode](/topics/opcodes_and_status_codes/gateway-opcodes) or an invalid payload for an opcode. Don't do that!                                                                             |
...
| Code | Description              | Explanation                                                                                                                                 |
| ---- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------- |
| 4001 | Unknown opcode           | You sent an invalid [opcode](/topics/opcodes_and_status_codes/voice-opcodes).                                                               |
...
| 4012 | Unknown protocol         | We didn't recognize the [protocol](/topics/voice_connections/establishing-a-voice-udp-connection-example-select-protocol-payload) you sent. |
...
| 4015 | Voice server crashed     | The server crashed. Our bad! Try [resuming](/topics/voice_connections/resuming-voice-connection).                                           |
| 4016 | Unknown encryption mode  | We didn't recognize your [encryption](/topics/voice_connections/encrypting-and-sending-voice).                                              |
...
RPC is the [local Discord server](/topics/rpc/) running on localhost. Access to the RPC server requires approval from Discord.
