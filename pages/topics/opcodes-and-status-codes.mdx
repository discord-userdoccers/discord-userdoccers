...
| 4012 | Unknown protocol         | We didn't recognize the [protocol](/topics/voice-connections#establishing-a-voice-udp-connection-example-select-protocol-payload) you sent. |
