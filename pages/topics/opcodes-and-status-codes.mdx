...
| 24     | Request Guild Application Commands **(deprecated)** | Send         | Request guild application commands.                                                     |
...
| 35     | Search Recent Members                               | Send         | Similar to OP 8, used for Member Safety.                                                |
...
| 4002     | Decode error                | You sent an invalid [payload](/topics/gateway#sending-events) to us. Don't do that!                                                                                                                                    |
