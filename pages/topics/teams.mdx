...
| members       | array of [team member](/docs/topics/teams/data-models-team-member-object) objects | the members of the team                |
...
| field            | type                                                    | description                                                                                     |
| ---------------- | ------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| membership_state | integer                                                 | the user's [membership state](/docs/topics/teams/data-models-membership-state-enum) on the team |
| permissions      | array of strings                                        | will always be `["*"]`                                                                          |
| team_id          | snowflake                                               | the id of the parent team of which they are a member                                            |
| user             | partial [user](/docs/resources/user/user-object) object | the avatar, discriminator, id, and username of the user                                         |
