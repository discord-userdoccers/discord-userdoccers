...
Sent when a client encounters a Gateway rate limit for an operation. See the [rate limiting documentation](/topics/gateway#rate-limiting) for more information on rate limits.

###### Rate Limited Structure

| Field       | Type                                                         | Description                                                                                       |
| ----------- | ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------- |
| opcode      | integer                                                      | [Opcode](/topics/opcodes-and-status-codes#gateway-opcodes) of the operation that was rate limited |
