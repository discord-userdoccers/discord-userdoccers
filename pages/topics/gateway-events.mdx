...
| [User Payment Client Add](#user-payment-client-add)                                         | User had a payment client added                                                                |
...
Sent when the current user finished checking out puchase in browser.

###### User Payment Browser Checkout Done Structure

| Field                    | Type       | Description                                          |
| ------------------------ | ---------- | ---------------------------------------------------- |
| load_id                  | ?string    | The ID of the load                                   |
...
Sent when a user had a payment client added.

###### User Payment Client Add Structure

| Field               | Type              | Description                     |
| ------------------- | ----------------- | ------------------------------- |
| purchase_token_hash | string            | The purchase token hash         |
| expires_at          | ISO8601 timestamp | When the payment client expires |

#### User Payment Sources Update

Sent when user's payment sources were updated. Inner payload is `null`.
...
Sent when user's subscriptions were updated. Inner payload is `null`.
