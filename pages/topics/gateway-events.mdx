...
Sent when an application responds to social layer SKU purchase eligibility interaction.
...
| eligible       | snowflake | Whether the recipient is eligible for social layer SKU purchase |
