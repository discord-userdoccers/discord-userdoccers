...
| user_guild_settings ^9^                | [versioned](#versioned-object) object ([user guild settings](/resources/guild#user-guild-settings-object) object) | The guild settings for the user                                                                                                                                                                                                                               |
...
| read_state ^10^                        | [versioned](#versioned-object) object ([read state](/resources/channel#read-state-object) object)                 | The read states of the channels                                                                                                                                                                                                                               |
...
^9^ The field will be an array of [user guild settings](/resources/guild#user-guild-settings-object) objects when using `VERSIONED_USER_GUILD_SETTINGS` [Gateway capability](/topics/gateway#gateway-capabilities).
...
Sent when the user guild settings are updated. Inner payload is [user guild settings](/resources/guild#user-guild-settings-object) object.
