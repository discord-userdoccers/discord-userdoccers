...
Sent when a lobby message is created. The inner payload is [message](/resources/message#message-object) object with the [extra structure](#message-object-extra-fields) above.

<Alert type="warn">

The message can be a partial [message](/resources/message#partial-message-object) object.
