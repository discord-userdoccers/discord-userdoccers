...
| user_application_profiles? ^10^        | map[snowflake, array[[user application profile](#user-application-profile-structure) object]]                              | A mapping of user IDs to provisional user accounts application profiles encountered across all objects in the event |
...
| external_id | [user application profile external id](#user-application-profile-external-id-structure) | The external ID of the provisional account          |
...
| provider_issued_user_id | string  | The ID of the external user ID                                                                             |
...
^1^ Not applicable for [`DISCORD_BOT`](/resources/application#application-identity-provider-type) provider type.
...
| nonce       | ?string                                                                         | The interaction's nonce, used for interaction deduplication |
| resolved?   | [resolved data](/interactions/receiving-and-responding#resolved-data-structure) | The resolved entities                                       |
