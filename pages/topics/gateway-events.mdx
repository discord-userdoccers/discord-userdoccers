...
| is_stranger_request?   | boolean    | Whether the friend request was sent by a user without a mutual friend or small mutual guild (default false) |
| origin_application_id? | ?snowflake | The ID of the application that this relationship originated from                                            |
