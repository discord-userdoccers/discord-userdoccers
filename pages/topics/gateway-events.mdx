...
| guild_join_requests ^1^      | array[partial [guild join request](/resources/guild#guild-join-request-object)] | Active join requests the user has to [non-previewable guilds](/resources/guild#guild-previewing)                                                                                                                                                              |
