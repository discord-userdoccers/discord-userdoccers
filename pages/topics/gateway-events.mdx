...
| id          | snowflake | The ID of the interaction                                                                                   |
| nonce?      | string    | The interaction's nonce, used for interaction deduplication                                                 |
| reason_code | integer   | The [reason why interaction failed](/interactions/receiving-and-responding#interaction-failure-reason-code) |
...
| application | partial [application](/resources/application#partial-application-structure) object | The application associated with the interaction             |
