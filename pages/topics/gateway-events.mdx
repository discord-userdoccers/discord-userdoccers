...
| user_guild_settings ^1^ ^9^            | [versioned](#versioned-object) object ([user guild settings](/resources/user-settings#user-guild-settings-object) object) | The guild settings for the user                                                                                                                                                                                                                               |
...
| read_state ^10^                        | [versioned](#versioned-object) object ([read state](/resources/channel#read-state-object) object)                         | The read states for the channels and guilds                                                                                                                                                                                                                   |
...
| mentions ^1^    | array[[user](/resources/user#user-object) object]                   | Users specifically mentioned in the message, with an extra [`member`](/resources/guild#guild-member-object) key representing guild member data |
