...
| guild_id?                 | snowflake | The ID of the guild that the entry is for                 |
| guild_scheduled_event_id? | snowflake | The ID of the guild scheduled event that the entry is for |
