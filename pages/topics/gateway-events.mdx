...
| user_guild_settings ^9^                | [versioned](#versioned-object) object ([user guild settings](/resources/user-settings#user-guild-settings-object) object) | The guild settings for the user                                                                                                                                                                                                                               |
...
^10^ The field will be an array of [read state](/resources/channel#read-state-object) objects when using `VERSIONED_READ_STATES` [Gateway capability](/topics/gateway#gateway-capabilities).
