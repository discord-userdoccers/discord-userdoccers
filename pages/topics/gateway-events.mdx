...
| connected_accounts                     | array[[connection](/resources/connections#connection-object)]                                                              | The third-party accounts the user has linked                                                                                                                                                                                                                           |
...
| error      | ?[partial JSON error response](/topics/opcodes-and-status-codes#example-json-error-response) | The error                 |
...
Sent when the current user has their connections updated. Inner payload is either a [connection](/resources/connections#connection-object) object, or the following object:
