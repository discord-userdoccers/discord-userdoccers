...
| metadata     | ?string \| map[string, string]                                         | The metadata of the lobby, might be serialized as a JSON string                      |
...
Sent when a lobby message is created. The inner payload is a [lobby message](/resources/message#message-object) object with the [extra structure](#message-object-extra-fields) above.

#### Lobby Message Update

Sent when a lobby message is updated. The inner payload is a [lobby message](/resources/message#message-object) object with the [extra structure](#message-object-extra-fields) above.
