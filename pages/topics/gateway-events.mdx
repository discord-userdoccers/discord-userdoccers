...
| [QoS Heartbeat](#qos-heartbeat)                               | Sends a QOS (Quality of Service) Heartbeat                        |
...
This event is sent along with the normal [Heartbeat](#heartbeat) to track [Quality of Service (QoS)](https://en.wikipedia.org/wiki/Quality_of_service) statistics.
...
| Field   | Type          | Description                                                    |
| ------- | ------------- | -------------------------------------------------------------- |
| ver     | integer       | The client heartbeat version, as of writing, this is `25`      |
