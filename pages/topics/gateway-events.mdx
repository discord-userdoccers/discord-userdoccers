...
| continuation_token ^1^  | ?snowflake | The calculated token to continue pagination from |

^1^ The `continuation_token` is a member id calculated by the following Python pseudocode:
