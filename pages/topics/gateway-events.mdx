...
| --- | --- | --- |
| guild_id | snowflake | The ID of the guild |
| channel_unread_updates | array[[partial channel update](#partial-channel-update-structure) object] | The partial channel updates |

###### Partial Channel Update Structure
