...
Sent when a user uses an [Application Command](/interactions/application-commands/) or [Message Component](/interactions/message-components/).
...
| id          | snowflake | The ID of the interaction                                                                   |
| nonce?      | string    | The interaction's nonce, used for interaction deduplication                                 |
| reason_code | integer   | The [reason why interaction failed](/resources/interaction#interaction-failure-reason-code) |
...
| Field       | Type                                                                                                                  | Description                                                 |
| ----------- | --------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------- |
| choices     | array[[application command option choice](/resources/interaction#application-command-option-choice-structure) object] | The choices the application is autocompleting option with   |
| nonce       | ?string                                                                                                               | The interaction's nonce, used for interaction deduplication |
...
| application | snowflake                                                                            | The application associated with the interaction              |
| title       | snowflake                                                                            | The title of the modal                                       |
| components  | array[[message component](/interactions/message-components#component-object) object] | The modal components                                         |
| nonce       | ?string                                                                              | The interaction's nonce, used for interaction deduplication  |
