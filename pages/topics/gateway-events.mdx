...
| user_application_profiles? ^10^        | map[snowflake, array[[user application profile](#user-application-profile-structure) object]]                              | The mapping of IDs of provisional user accounts encountered in the payload to their user application profiles                                                                                                                                                          |
