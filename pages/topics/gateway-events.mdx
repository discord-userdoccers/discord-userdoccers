...
Sent every 30 minutes and on connect to track the time the user has spent in the current session.
...
| session_id               | string  | A client-generated UUID, regenerates after 30 minutes.                                               |
