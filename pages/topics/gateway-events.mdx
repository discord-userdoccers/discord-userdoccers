...
| [Update Time Spent Session ID](#update-time-spent-session-id) | Send the time spent in the current session                        |
...
Sent every minute and on connect to track the time the user has spent in the current session.

Whenever this is sent, an acompanying [QoS Heartbeat](#qos-heartbeat) should be sent.
...
| session_id               | string  | A client-generated UUID, see [client properties](/reference#client-properties) for more information. |
| client_launch_id         | string  | A client-generated UUID, see [client properties](/reference#client-properties) for more information. |
