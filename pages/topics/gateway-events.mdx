...
| scopes? ^10^                           | array[string]                                                                                                              | The [OAuth2 scopes](/topics/oauth2#oauth2-scopes) the user has authorized for the application                                                                                                                                                                          |
...
| av_sf_protocol_floor? ^10^             | integer                                                                                                                    | The minimum supported version of the DAVE protocol in eligible voice connection                                                                                                                                                                                        |
| feature_flags? ^10^                    | [gateway feature flags](#gateway-feature-flags-structure) object                                                           | Social layer SDK feature flags                                                                                                                                                                                                                                         |
...
^10^ Only available in [OAuth2 contexts](/topics/gateway#oauth2-and-the-gateway).
...
Sent when application command index is updated for a guild.
...
| -------- | --------- | -------------------------------------------- |
| guild_id | snowflake | The ID of the guild                          |
| version? | ?integer  | The version of the application command index |
...
For bots, inner payload is an [interaction](/interactions/receiving-and-responding#interaction-object) object.
...
| 7     | ACTIVITY_LAUNCH_NOT_IN_EXPERIMENT                            | The guild/user is not eligible for an experiment          |
...
| 10    | ACTIVITY_LAUNCH_INVALID_DEV_PREVIEW_GUILD_SIZE               | Unknown                                                   |
| 11    | ACTIVITY_LAUNCH_INVALID_USER_AGE_GATE                        | Unknown                                                   |
| 12    | ACTIVITY_LAUNCH_INVALID_USER_VERIFICATION_LEVEL              | Unknown                                                   |
| 13    | ACTIVITY_LAUNCH_INVALID_USER_PERMISSIONS                     | Unknown                                                   |
| 14    | ACTIVITY_LAUNCH_INVALID_CONFIGURATION_NOT_EMBEDDED           | The application is not an embedded activity               |
| 15    | ACTIVITY_LAUNCH_INVALID_CONFIGURATION_PLATFORM_NOT_SUPPORTED | The embedded activity does not support current platform   |
| 16    | ACTIVITY_LAUNCH_INVALID_CONFIGURATION_PLATFORM_NOT_RELEASED  | The embedded activity does not support current platform   |
...
| 20    | ACTIVITY_LAUNCH_INVALID_USER_REGION_FOR_APPLICATION          | The embedded activity is not supported in current region  |

#### Interaction Success

Sent when interaction succeeds.
...
Sent when application responds to autocomplete interaction.

###### Application Command Autocomplete Response Structure

| Field   | Type                                                                                                                              | Description                                                 |
| ------- | --------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------- |
| choices | array[[application command option choice](/interactions/application-commands#application-command-option-choice-structure) object] | The choices the application is autocompleting option with   |
| nonce   | ?string                                                                                                                           | The interaction's nonce, used for interaction deduplication |

#### Interaction Modal Create

Sent when application responds to interaction with a modal.
...
| custom_id   | snowflake                                                               | The developer-defined identifier for the modal              |
...
Sent when application responds to interaction with an iframe modal.
...
| id          | snowflake                                                               | The ID of the interaction                                                         |
| channel_id  | snowflake                                                               | The ID of the channel the interaction was created in                              |
| custom_id   | snowflake                                                               | The developer-defined identifier for the iframe modal                             |
| application | partial [application](/resources/application#application-object) object | The application associated with the interaction                                   |
| title       | string                                                                  | The title of the modal                                                            |
