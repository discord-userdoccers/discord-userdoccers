...
| user_settings_proto? ^1^               | string                                                                                                                     | The base 64-encoded serialized [preloaded user settings](/resources/user-setting-proto#preloaded-user-settings-object) protobuf for the user, (if missing, defaults should be used)                                                                                    |
