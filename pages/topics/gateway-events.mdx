...
Sent when the audio context settings are modified.

###### Audio Settings Update Structure

| Field  | Type                                                                                                  | Description                             |
| ------ | ----------------------------------------------------------------------------------------------------- | --------------------------------------- |
| user   | map[snowflake, [audio context setting](/resources/user-settings#audio-context-setting-object) object] | Audio context settings for users        |
| stream | map[snowflake, [audio context setting](/resources/user-settings#audio-context-setting-object) object] | Audio context settings for user streams |
