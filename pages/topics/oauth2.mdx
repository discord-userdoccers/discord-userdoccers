...
<RouteHeader method="GET" url="/oauth2/applications/@me">
  Get Current OAuth2 Application
</RouteHeader>

Returns OAuth2 application information associated with the requestor.
...
| team                   | ?[team](/resources/teams#team-object) object                            | The team that owns the application                                                                                                      |
...
| bot_public             | boolean                                                                 | Whether only the application owner can add the bot                                                                                      |
| bot_require_code_grant | boolean                                                                 | Whether the application's bot will only be added upon completion of a full OAuth2 token exchange                                        |
...
This endpoint is not usable by user or bot accounts.
