...
Authorizes the user for the given OAuth2 application. May fire a [Guild Integrations Update](/topics/gateway-events#guild-integrations-update), [Integration Create](/topics/gateway-events#integration-create), [User Application Add](/topics/gateway-events#user-application-add), and/or [User Connections Update](/topics/gateway-events#user-connections-update) Gateway event.
