...
| https://discord.com/oauth2/authorize/device     | Device Code Authorization URL                               |
...
Users can also unmerge their account by [unauthorizing the OAuth2 application](#revoke-oauth2-token).

</Alert>

<Alert type="warn">

Unmerging invalidates all access and refresh tokens for the user.
