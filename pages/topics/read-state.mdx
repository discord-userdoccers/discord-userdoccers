...
Updates all read states in a guild to acknowledge all features messages. Fires multiple [Message Ack](/topics/gateway-events#message-ack) and [Guild Feature Ack](/topics/gateway-events#guild-feature-ack) Gateway events.

<Alert type="warn">

This endpoint is deprecated. It is replaced by [Bulk Update Read States](/topics/read-state#bulk-update-read-states).
