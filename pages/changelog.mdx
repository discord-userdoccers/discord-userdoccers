...
Intentionally breaking [links](/resource/channel/)!
...
- An optional `components` field has been added to the [message object](/resources/message#message-object)
...
- A new field `referenced_message` has been added to the [Message Object](/resources/message#message-object)
- A new field `replied_user` has been added to the [Allowed Mentions Object](/resources/message#allowed-mentions-object)
...
Stickers are now documented as part of the [message](/resources/message#message-object) object.
...
The legacy mention behavior for bots is now removed, and granular control of mentions should use the [Allowed Mentions](/resources/message#allowed-mentions-object) API moving forwards.
...
- [Allowed mentions object](/resources/message#allowed-mentions-object)
...
- [Delete All Reactions for Emoji](/resources/message#delete-all-reactions-for-emoji)
...
- [Message](/resources/message#message-object) Object
  - [`type`](/resources/message#message-types) added to support system messages
