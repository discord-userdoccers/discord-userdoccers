...
- [`GET Application Command Permissions`](/interactions/application-commands#get-application-command-ermissions)
- [`PUT Application Command Permissions`](/interactions/application-commands#put-application-command-permissions)
...
You can now get more precise rate limit reset times, via a new request header. Check out the [rate limits](/topics/rate-limits#more-precise-rate-limit-resets) documentation for more information.
