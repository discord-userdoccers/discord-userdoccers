...
| --platform     | [platform](/dispatch/field-values#platform-values) | the build platform to download |
| --locale       | [locale](/dispatch/field-values#accepted-locales)  | the build locale to download   |
...
| config_file      | filename                                           | the [JSON config file](/dispatch/branches-and-builds#setting-up-our-first-build) for the build        |
| application_root | file path                                          | the directory that dispatch will treat as the local root for operations—`.` for the current directory |
| --locale         | [locale](/dispatch/field-values#accepted-locales)  | the build locale to preview                                                                           |
| --platform       | [platform](/dispatch/field-values#platform-values) | the build platform to preview                                                                         |
...
| application_root | file path                                          | the directory that dispatch will treat as the local root for operations—`.` for the current directory |
| --platform       | [platform](/dispatch/field-values#platform-values) | the build platform to repair                                                                          |
...
| ---------------- | -------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| application_root | file path                                          | the directory that dispatch will treat as the local root for operations—`.` for the current directory |
| --platform       | [platform](/dispatch/field-values#platform-values) | the build platform to do the launch setup                                                             |
