...
| [Guild Prune Update](#guild-prune-update)                                                         | Guild was pruned or the server computed estimated amount of pruned members                     |
...
Sent when a guild was pruned or the server computed estimated amount of pruned members.

###### Guild Prune Update Structure

| Field    | Type                                         | Description                             |
| -------- | -------------------------------------------- | --------------------------------------- |
| guild_id | snowflake                                    | The ID of the guild                     |
| prune    | [guild prune](#guild-prune-structure) object | The information about the prune process |

###### Guild Prune Structure

| Field         | Type             | Description                        |
| ------------- | ---------------- | ---------------------------------- |
| prune_count   | integer          | Number of pruned members           |
| is_preview    | boolean          | Whether the event is a preview     |
| is_finished   | boolean          | Whether the event finished         |
| include_roles | array[snowflake] | Additional roles included          |
| days          | integer          | Number of inactive days pruned for |
