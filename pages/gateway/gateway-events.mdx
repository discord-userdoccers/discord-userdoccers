...
| flags          | integer   | The [application's flags](/resources/application#application-flags), limited to `1 << 53`               |
| flags_new      | string    | The [application's flags](/resources/application#application-flags), including those surpassing `1 << 53` |
