...
| flags ^2^      | integer   | The [application's flags](#application-flags)                                     |
| flags_new ^2^  | string    | The [application's flags](#application-flags) serialized as a stringified integer |
