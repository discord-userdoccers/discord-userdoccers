...
| [Wishlist Item Purchased](#wishlist-item-purchased)                                               | User got gifted a wishlist item                                                                |
...
Sent when the current user got gifted a wishlist item.

###### Wishlist Item Purchased Structure

| Field        | Type      | Description                               |
| ------------ | --------- | ----------------------------------------- |
| recipient_id | snowflake | The ID of the user who purchased the gift |
| sku_id       | snowflake | The ID of the wishlist item SKU           |
