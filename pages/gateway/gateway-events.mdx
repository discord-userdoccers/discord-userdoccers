...
| user_settings_version?       | integer                 | The version of the user settings                                        |
...
| initial_guild_id?            | snowflake               | The ID of the initial guild                                             |
...
| emoji_ids_hash ^1^   | string    | The hash of all guild emoji IDs   |
| sticker_ids_hash ^1^ | string    | The hash of all guild sticker IDs |
...
| Name                                                                                              | Description                                                                                       |
| ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [Initial Guild](#initial-guild)                                                                   | Information for initial guild                                                                     |
