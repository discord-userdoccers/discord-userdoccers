...
Like the [List Guild Channels](/resources/channel#list-guild-channels) only channels the account has `VIEW_CHANNEL` permissions for will be returned. Fires a [Channel Sync](#channel-sync) Gateway event with the requested channels.
