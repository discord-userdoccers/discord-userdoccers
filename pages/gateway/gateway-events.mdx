...
Likely used to request channels that were previously obfuscated when the user gains `VIEW_CHANNEL` permission.

Like the [List Guild Channels](/resources/channel#list-guild-channels) only channels the account has `VIEW_CHANNEL` permissions for will be returned. endpoint Fires a [Channel Sync](#channel-sync) Gateway event with the requested channels.
...
Sent in response to [Resync Guild Channels](#resync-guild-channels). Contains channels requested.
...
| Field           | Type                                                       | Description            |
| --------------- | ---------------------------------------------------------- | ---------------------- |
| integrity_check | boolean                                                    | Unknown use            |
| guild_id        | snowflake                                                  | The ID of the guild    |
| channels        | array[[channel](/resources/channel#channel-object) object] | The requested channels |
