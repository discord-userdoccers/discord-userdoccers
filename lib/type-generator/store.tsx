...
const successOptions: ToastOptions = {
    ...defaultOptions,
    className: 'bg-green-100 dark:bg-green-800 text-green-700 dark:text-green-100 border border-green-400 dark:border-green-600 rounded-md shadow-lg',
    // icon: <CheckCircle className="h-5 w-5 text-green-500 dark:text-green-300 mr-2" />,
};

const errorOptions: ToastOptions = {
    ...defaultOptions,
    className: 'bg-red-100 dark:bg-red-800 text-red-700 dark:text-red-100 border border-red-400 dark:border-red-600 rounded-md shadow-lg',
...
export const CodegenLanguageProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    const [selectedLanguage, setSelectedLanguage] = useLocalStorage<SupportedLanguages>("selected-codegen-language", "Python");
