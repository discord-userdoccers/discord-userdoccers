export default function Snowflake(props: unknown) {
  return (
    ...
    >
      ...
      <text
        className="snowflake-dec-text snowflake-dec-sz-small"
        transform="translate(233.5 39.22)"
      >
        to binary
      </text>
      <text
        className="snowflake-dec-text snowflake-dec-sz-small snowflake-dec-ms"
        transform="translate(29.68 81.54)"
      >
      ...
      >
        <tspan className="snowflake-dec-ms">
      ...
      <text
        className="snowflake-dec-number snowflake-dec-sz-normal"
        transform="translate(51.34 129.68)"
      >
        41944705796
      </text>
      <text
        className="snowflake-dec-number snowflake-dec-sz-normal"
        transform="translate(44.51 179.5)"
      >
        1462015105796
      </text>
      <text
        className="snowflake-dec-number snowflake-dec-sz-small"
        transform="translate(445.78 56.28)"
      >
        0
      </text>
      <text
        className="snowflake-dec-number snowflake-dec-sz-small"
        transform="translate(363.84 56.28)"
      >
        12
      </text>
      <text
        className="snowflake-dec-number snowflake-dec-sz-small"
        transform="translate(323.71 56.28)"
      >
        17
      </text>
      <text
        className="snowflake-dec-number snowflake-dec-sz-small"
        transform="translate(290.96 56.28)"
      >
        22
      </text>
      <text
        className="snowflake-dec-number snowflake-dec-sz-small"
        transform="translate(0 56.37)"
      >
        64
      </text>
      <text
        className="snowflake-dec-text snowflake-dec-sz-small"
        transform="translate(132.54 147.05)"
      >
        + 1420070400000
        <tspan x="-34.99" y="9.6">
      ...
      <text
        className="snowflake-dec-text snowflake-dec-sz-small"
        transform="translate(96.64 200.66)"
      >
        Parse unix timstamp (ms)
      </text>
      <text
        className="snowflake-dec-text snowflake-dec-sz-normal"
        transform="translate(8.05 229.66)"
      >
        2016-04-30 11:18:25.796 UTC
      </text>
      <text
        className="snowflake-dec-text snowflake-dec-sz-small"
        transform="translate(93.2 96.22)"
      >
        to decimal
      </text>
    </svg>
