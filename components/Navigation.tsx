	...
	return (
		<nav className="flex-1 self-stretch mt-5 px-6">
			...
			<NavigationSection title="Documentation">
				...
				<NavigationLink href="/store-distribution-agreement">Store Distribution Agreement</NavigationLink>
			</NavigationSection>
			...
			<NavigationSection title="Resources">
				<NavigationLink href="/resources/application">Application</NavigationLink>
				<NavigationLink
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							...
							<NavigationSubLink href="/resources/user#get-current-user">Get Current User</NavigationSubLink>
							<NavigationSubLink href="/resources/user#get-user">Get User</NavigationSubLink>
							<NavigationSubLink href="/resources/user#modify-current-user">Modify Current User</NavigationSubLink>
							<NavigationSubLink href="/resources/user#get-current-user-guilds">
								Get Current User Guilds
							</NavigationSubLink>
							<NavigationSubLink href="/resources/user#leave-guild">Leave Guild</NavigationSubLink>
							<NavigationSubLink href="/resources/user#create-dm">Create DM</NavigationSubLink>
							<NavigationSubLink href="/resources/user#create-group-dm">Create Group DM</NavigationSubLink>
							<NavigationSubLink href="/resources/user#get-user-connections">Get User Connections</NavigationSubLink>
						</Fragment>
					}
				>
					User
			...
			<NavigationSection title="Topics">
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/topics/certified-devices#how's-it-work?">How&apos;s it work?</NavigationSubLink>
							<NavigationSubLink href="/topics/certified-devices#connecting">Connecting</NavigationSubLink>
							<NavigationSubLink href="/topics/certified-devices#getting-device-uuid">
								Getting Device UUID
							</NavigationSubLink>
							<NavigationSubLink href="/topics/certified-devices#http-example">HTTP Example</NavigationSubLink>
							<NavigationSubLink href="/topics/certified-devices#websocket-example">
								WebSocket Example
							</NavigationSubLink>
							<NavigationSubLink href="/topics/certified-devices#models">Models</NavigationSubLink>
						</Fragment>
					}
				>
					Certified Devices
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							...
							<NavigationSubLink href="/topics/community-resources#libraries">Libraries</NavigationSubLink>
							<NavigationSubLink href="/topics/community-resources#interactions">Interactions</NavigationSubLink>
							<NavigationSubLink href="/topics/community-resources#game-sdk-tools">Game SDK Tools</NavigationSubLink>
							<NavigationSubLink href="/topics/community-resources#dispatch-tools">Dispatch Tools</NavigationSubLink>
							...
							<NavigationSubLink href="/topics/community-resources#api-types">API Types</NavigationSubLink>
						</Fragment>
					}
				>
					Community Resources
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/topics/rpc#restrictions">Restrictions</NavigationSubLink>
							<NavigationSubLink href="/topics/rpc#payloads">Payloads</NavigationSubLink>
							<NavigationSubLink href="/topics/rpc#connecting">Connecting</NavigationSubLink>
							<NavigationSubLink href="/topics/rpc#authenticating">Authenticating</NavigationSubLink>
							<NavigationSubLink href="/topics/rpc#commands-and-events">Commands and Events</NavigationSubLink>
						</Fragment>
					}
				>
					RPC
			...
			<NavigationSection title="Rich Presence">
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/rich-presence/how-to#so,-what-is-it?">So, what is it?</NavigationSubLink>
							...
							<NavigationSubLink href="/rich-presence/how-to#initialization">Initilization</NavigationSubLink>
							<NavigationSubLink href="/rich-presence/how-to#shutting-down">Shutting Down</NavigationSubLink>
							<NavigationSubLink href="/rich-presence/how-to#updating-presence">Updating Presence</NavigationSubLink>
							<NavigationSubLink href="/rich-presence/how-to#joining">Joining</NavigationSubLink>
							<NavigationSubLink href="/rich-presence/how-to#spectating">Spectating</NavigationSubLink>
							<NavigationSubLink href="/rich-presence/how-to#secrets">Secrets</NavigationSubLink>
							...
							<NavigationSubLink href="/rich-presence/how-to#so,-what-now?">So, what now?</NavigationSubLink>
						</Fragment>
					}
				>
					How To
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							...
							<NavigationSubLink href="/rich-presence/best-practices#tips">Tips</NavigationSubLink>
						</Fragment>
					}
				>
					Best Practices
				</NavigationLink>
				<NavigationLink href="/rich-presence/launch-checklist">Launch Checklist</NavigationLink>
			...
			<NavigationSection title="Game SDK">
				<NavigationLink
					...
					subLinks={
						<Fragment>
							...
							<NavigationSubLink href="/game-sdk/sdk-starter-guide#get-set-up">Get Set Up</NavigationSubLink>
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/game-sdk/discord#general-structure">General Structure</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#functions-in-the-sdk">Functions in the SDK</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#environment-variables">
								Environment Variables
							</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#error-handling">Error Handling</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#data-models">Data Models</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#create">Create</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#destroy">Destroy</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#setloghook">SetLogHook</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#runcallbacks">RunCallbacks</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#getactivitymanager">GetActivityManager</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#getrelationshipmanager">
								GetRelationshipManager
							</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#getimagemanager">GetImageManager</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#getusermanager">GetUserManager</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#getlobbymanager">GetLobbyManager</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#getnetworkmanager">GetNetworkManager</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#getoverlaymanager">GetOverlayManager</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#getapplicationmanager">
								GetApplicationManager
							</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#getstoragemanager">GetStorageManager</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#getstoremanager">GetStoreManager</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord#getvoicemanager">GetVoiceManager</NavigationSubLink>
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/game-sdk/achievements#data-models">Data Models</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/achievements#setuserachievement">SetUserAchievement</NavigationSubLink>
							...
							<NavigationSubLink href="/game-sdk/achievements#getuserachievement">GetUserAchievement</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/achievements#onuserachievementupdate">
								OnUserAchievementUpdate
							</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/achievements#the-api-way">The API Way</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/achievements#get-achievements">Get Achievements</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/achievements#get-achievement">Get Achievements</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/achievements#create-achievement">Create Achievement</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/achievements#update-achievement">Update Achievement</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/achievements#delete-achievement">Delete Achievement</NavigationSubLink>
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/game-sdk/activities#data-models">Data Models</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/activities#activity-action-field-requirements">
								Activity Action Field Requirements
							</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/activities#registercommand">RegisterCommand</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/activities#registersteam">RegisterSteam</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/activities#updateactivity">UpdateActivity</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/activities#clearactivity">ClearActivity</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/activities#sendrequestreply">SendRequestReply</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/activities#sendinvite">SendInvite</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/activities#acceptinvite">AcceptInvite</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/activities#onactivityjoin">OnActivityJoin</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/activities#onactivityspectate">OnActivitySpectate</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/activities#onactivityjoinrequest">
								OnActivityJoinRequest
							</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/activities#onactivityinvite">OnActivityInvite</NavigationSubLink>
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/game-sdk/applications#data-models">Data Models</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/applications#getcurrentlocale">GetCurrentLocale</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/applications#getcurrentbranch">GetCurrentBranch</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/applications#getoauth2token">GetOAuth2Token</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/applications#validateorexit">ValidateOrExit</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/applications#getticket">GetTicket</NavigationSubLink>
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/game-sdk/discord-voice#data-models">Data Models</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord-voice#getinputmode">GetInputMode</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord-voice#setinputmode">SetInputMode</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord-voice#isselfmute">IsSelfMute</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord-voice#setselfmute">SetSelfMute</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord-voice#isselfdeaf">IsSelfDeaf</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord-voice#setselfdeaf">SetSelfDeaf</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord-voice#islocalmute">IsLocalMute</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord-voice#setlocalmute">SetLocalMute</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord-voice#getlocalvolume">GetLocalVolume</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/discord-voice#setlocalvolume">SetLocalVolume</NavigationSubLink>
						</Fragment>
					}
				>
					Discord Voice
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/game-sdk/images#data-models">Data Models</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/images#fetch">Fetch</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/images#getdimensions">GetDimensions</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/images#getdata">GetData</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/images#gettexture">GetTexture</NavigationSubLink>
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/game-sdk/lobbies#the-sdk-way">The SDK Way</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#data-models">Data Models</NavigationSubLink>
							...
							<NavigationSubLink href="/game-sdk/lobbies#createlobby">CreateLobby</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#updatelobby">UpdateLobby</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#deletelobby">DeleteLobby</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#connectlobby">ConnectLobby</NavigationSubLink>
							...
							<NavigationSubLink href="/game-sdk/lobbies#disconnectlobby">DisconnectLobby</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#getlobby">GetLobby</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#lobbymetadatacount">LobbyMetadataCount</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#getlobbymetadatakey">GetLobbyMetadataKey</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#getlobbymetadatavalue">
								GetLobbyMetadataValue
							</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#membercount">MemberCount</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#getmemberuserid">GetMemberUserId</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#getmemberuser">GetMemberUser</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#membermetadatacount">MemberMetadataCount</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#getmembermetadatakey">GetMemberMetadataKey</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#getmembermetadatavalue">
								GetMemberMetadataValue
							</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#updatemember">UpdateMember</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#sendlobbymessage">SendLobbyMessage</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#getsearchquery">GetSearchQuery</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#search">Search</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#lobbycount">LobbyCount</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#getlobbyid">GetLobbyId</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#connectvoice">ConnectVoice</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#disconnectvoice">DisconnectVoice</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#onlobbyupdate">OnLobbyUpdate</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#onlobbydelete">OnLobbyDelete</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#onmemberconnect">OnMemberConnect</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#onmemberupdate">OnMemberUpdate</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#onmemberdisconnect">OnMemberDisconnect</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#onlobbymessage">OnLobbyMessage</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#onspeaking">OnSpeaking</NavigationSubLink>
							...
							<NavigationSubLink href="/game-sdk/lobbies#the-api-way">The API Way</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#integrated-networking">
								Integrated Networking
							</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#connectnetwork">ConnectNetwork</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#disconnectnetwork">DisconnectNetwork</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#flushnetwork">FlushNetwork</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#opennetworkchannel">OpenNetworkChannel</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#sendnetworkmessage">SendNetworkMessage</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/lobbies#onnetworkmessage">OnNetworkMessage</NavigationSubLink>
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/game-sdk/networking#">GetPeerId</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/networking#">Flush</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/networking#">OpenChannel</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/networking#">OpenPeer</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/networking#">UpdatePeer</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/networking#">SendMessage</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/networking#">CloseChannel</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/networking#">ClosePeer</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/networking#">OnMessage</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/networking#">OnRouteUpdate</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/networking#">Flush vs RunCallbacks</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/networking#">Connecting to Each Other</NavigationSubLink>
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/game-sdk/overlay#data-models">Data Models</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/overlay#isenabled">IsEnabled</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/overlay#islocked">IsLocked</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/overlay#setlocked">SetLocked</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/overlay#openactivityinvite">OpenActivityInvite</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/overlay#openguildinvite">OpenGuildInvite</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/overlay#openvoicesettings">OpenVoiceSettings</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/overlay#ontoggle">OnToggle</NavigationSubLink>
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/game-sdk/relationships#first-notes">First Notes</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/relationships#data-models">Data Models</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/relationships#filter">Filter</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/relationships#get">Get</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/relationships#getat">GetAt</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/relationships#count">Count</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/relationships#onrefresh">OnRefresh</NavigationSubLink>
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/game-sdk/storage#cloud-saves">Cloud Saves</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/storage#data-models">Data Models</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/storage#getpath">GetPath</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/storage#read">Read</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/storage#readasync">ReadAsync</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/storage#readasyncpartial">ReadAsyncPartial</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/storage#write">Write</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/storage#writeasync">WriteAsync</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/storage#delete">Delete</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/storage#exists">Exists</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/storage#stat">Stat</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/storage#count">Count</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/storage#statat">StatAt</NavigationSubLink>
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/game-sdk/store#application-test-mode">Application Test Mode</NavigationSubLink>
							...
							<NavigationSubLink href="/game-sdk/store#data-models">Data Models</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#fetchskus">FetchSkus</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#countskus">CountSkus</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#getsku">GetSku</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#getskuat">GetSkuAt</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#fetchentitlements">FetchEntitlements</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#countentitlements">CountEntitlements</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#getentitlement">GetEntitlement</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#getentitlementat">GetEntitlementAt</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#hasskuentitlement">HasSkuEntitlement</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#startpurchase">StartPurchase</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#onentitlementcreate">OnEntitlementCreate</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#onentitlementdelete">OnEntitlementDelete</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#http-apis">HTTP APIs</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#http-specific-data-models">
								HTTP-Specific Data Models
							</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#get-entitlements">Get Entitlements</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#get-entitlement">Get Entitlement</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#get-skus">Get SKUs</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/store#consume-sku">Consume SKU</NavigationSubLink>
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/game-sdk/users#data-models">Data Models</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/users#getcurrentuser">GetCurrentUser</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/users#getuser">GetUser</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/users#getcurrentuserpremiumtype">
								GetCurrentUserPremiumType
							</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/users#currentuserhasflag">CurrentUserHasFlag</NavigationSubLink>
							<NavigationSubLink href="/game-sdk/users#oncurrentuserupdate">OnCurrentUserUpdate</NavigationSubLink>
			...
			<NavigationSection title="Dispatch">
				<NavigationLink href="/dispatch/dispatch-and-you">Dispatch &amp; You</NavigationLink>
				<NavigationLink
					href="/dispatch/branches-and-builds"
					subLinks={
						<Fragment>
							<NavigationSubLink href="/dispatch/branches-and-builds#getting-set-up">Getting Set Up</NavigationSubLink>
							...
							<NavigationSubLink href="/dispatch/branches-and-builds#file-rules">File Rules</NavigationSubLink>
							<NavigationSubLink href="/dispatch/branches-and-builds#cloud-storage">Cloud Storage</NavigationSubLink>
							<NavigationSubLink href="/dispatch/branches-and-builds#registry-keys-and-install-scripts">
								Registry Keys and Install Scripts
							</NavigationSubLink>
							<NavigationSubLink href="/dispatch/branches-and-builds#launch-options">Launch Options</NavigationSubLink>
							...
							<NavigationSubLink href="/dispatch/branches-and-builds#drm">DRM</NavigationSubLink>
							...
							<NavigationSubLink href="/dispatch/branches-and-builds#patching">Patching</NavigationSubLink>
						</Fragment>
					}
				>
					Branches &amp; Builds
				...
				<NavigationLink
					...
					subLinks={
						<Fragment>
							<NavigationSubLink href="/dispatch/list-of-commands#branch-create">branch create</NavigationSubLink>
							<NavigationSubLink href="/dispatch/list-of-commands#branch-delete">branch delete</NavigationSubLink>
							<NavigationSubLink href="/dispatch/list-of-commands#branch-list">branch list</NavigationSubLink>
							<NavigationSubLink href="/dispatch/list-of-commands#branch-promote">branch promote</NavigationSubLink>
							<NavigationSubLink href="/dispatch/list-of-commands#build-delete">build delete</NavigationSubLink>
							<NavigationSubLink href="/dispatch/list-of-commands#build-drm-wrap">build drm-wrap</NavigationSubLink>
							<NavigationSubLink href="/dispatch/list-of-commands#build-list">build list</NavigationSubLink>
							<NavigationSubLink href="/dispatch/list-of-commands#build-publish">build publish</NavigationSubLink>
							<NavigationSubLink href="/dispatch/list-of-commands#build-push">build push</NavigationSubLink>
							<NavigationSubLink href="/dispatch/list-of-commands#build-update">build update</NavigationSubLink>
							<NavigationSubLink href="/dispatch/list-of-commands#build-corrupt">build corrupt</NavigationSubLink>
							<NavigationSubLink href="/dispatch/list-of-commands#build-preview-files">
								build preview-files
							</NavigationSubLink>
							<NavigationSubLink href="/dispatch/list-of-commands#build-repair">build repair</NavigationSubLink>
							...
							<NavigationSubLink href="/dispatch/list-of-commands#login">login</NavigationSubLink>
						</Fragment>
					}
				>
					List of Commands
				</NavigationLink>
				<NavigationLink href="/dispatch/error-codes">Error Codes</NavigationLink>
				<NavigationLink href="/dispatch/field-values">Field Values</NavigationLink>
			</NavigationSection>
		</nav>
	);
}
