    ...
    return (
        <nav className="flex-1 self-stretch mt-5 px-6">
            <div className="hidden items-center -mt-4 mb-10 md:flex">
                <a href="/docs/intro" className="hidden md:block">
            ...
            <NavigationSection title="Resources">
                <NavigationLink
                    ...
                    subLinks={
                        <Fragment>
                            ...
                            <NavigationSubLink href="/resources/application#install-params-object">Install Params Object</NavigationSubLink>
                            <NavigationSubLink href="/resources/application#application-role-connection-metadata-object">Application Role Connection Metadata Object</NavigationSubLink>
                        </Fragment>  
                    }
                >
                    Application
                ...
                <NavigationLink
                    ...
                    subLinks={
                        <Fragment>
                            <NavigationSubLink href="/resources/user#usernames-and-nicknames">Usernames and Nicknames</NavigationSubLink>
                            <NavigationSubLink href="/resources/user#user-object">User Object</NavigationSubLink>
                            <NavigationSubLink href="/resources/user#profile-metadata-object">Profile Metadata Object</NavigationSubLink>
                            ...
                            <NavigationSubLink href="/resources/user#application-role-connection-object">Application Role Connection Object</NavigationSubLink>
