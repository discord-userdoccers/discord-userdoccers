...
| name  | string    | TThe name of the guild (2-100 characters)          |
...
```json
{
  "81384788765712384": ["157858575924985856", "157889000391180288", "157873248346832897", "157947794294833152", "173805066229252096"],
  "1046920999469330512": []
}
```
