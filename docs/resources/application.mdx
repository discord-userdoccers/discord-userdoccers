...
| ----------- | -------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| ~~1 << 1~~  | ~~EMBEDDED_RELEASED~~                  | ~~This embedded application is released to the public~~ (see [release phases](#embedded-activity-release-phase))                                           | ~~Yes~~ |
...
| assets       | map[snowflake, [application asset](#application-asset-object)] | The assets for each application |
...
<RouteHeader method="GET" url="/users/@me/applications/{application.id}/role-connection" supportsOAuth2="role_connections.write">
...
<RouteHeader method="PUT" url="/users/@me/applications/{application.id}/role-connection" supportsOAuth2="role_connections.write">
