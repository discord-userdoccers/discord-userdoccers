...
| recipients?                         | array[[user](/resources/user#user-object) object]                  | The recipients of the private channel, excluding the requesting user                                                                                                                         |
...
| Value  | Name                          | Description                                                                                                     |
| ------ | ----------------------------- | --------------------------------------------------------------------------------------------------------------- |
| 1 << 0 | DISMISSED_IN_GAME_MESSAGE_NUX | The user has dismissed the [`IN_GAME_MESSAGE_NUX` message](/resources/message#message-type) for this DM channel |
...
| nicks? ^3^                     | object           | A mapping of user IDs to their respective nicknames                        |
